(()=>{var Bs=Object.defineProperty;var Ts=(i,t,e)=>t in i?Bs(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var h=(i,t,e)=>Ts(i,typeof t!="symbol"?t+"":t,e);function _(i,t,e=customElements){let s=e.get(i);return s||(e.define(i,t),t)}var At=globalThis,It=At.ShadowRoot&&(At.ShadyCSS===void 0||At.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ft=Symbol(),Ee=new WeakMap,q=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Ft)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(It&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=Ee.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Ee.set(e,t))}return t}toString(){return this.cssText}},Se=i=>new q(typeof i=="string"?i:i+"",void 0,Ft),g=(i,...t)=>{let e=i.length===1?i[0]:t.reduce((s,r,o)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new q(e,i,Ft)},Re=(i,t)=>{if(It)i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),r=At.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},qt=It?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return Se(e)})(i):i;var{is:Ls,defineProperty:Os,getOwnPropertyDescriptor:Ms,getOwnPropertyNames:Us,getOwnPropertySymbols:Fs,getPrototypeOf:qs}=Object,Et=globalThis,Ce=Et.trustedTypes,js=Ce?Ce.emptyScript:"",Ks=Et.reactiveElementPolyfillSupport,j=(i,t)=>i,jt={toAttribute(i,t){switch(t){case Boolean:i=i?js:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let e=i;switch(t){case Boolean:e=i!==null;break;case Number:e=i===null?null:Number(i);break;case Object:case Array:try{e=JSON.parse(i)}catch{e=null}}return e}},De=(i,t)=>!Ls(i,t),Pe={attribute:!0,type:String,converter:jt,reflect:!1,useDefault:!1,hasChanged:De};Symbol.metadata??=Symbol("metadata"),Et.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Pe){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),r=this.getPropertyDescriptor(t,s,e);r!==void 0&&Os(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){let{get:r,set:o}=Ms(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:r,set(n){let d=r?.call(this);o?.call(this,n),this.requestUpdate(t,d,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Pe}static _$Ei(){if(this.hasOwnProperty(j("elementProperties")))return;let t=qs(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(j("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(j("properties"))){let e=this.properties,s=[...Us(e),...Fs(e)];for(let r of s)this.createProperty(r,e[r])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,r]of e)this.elementProperties.set(s,r)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let r=this._$Eu(e,s);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let r of s)e.unshift(qt(r))}else t!==void 0&&e.push(qt(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Re(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,s);if(r!==void 0&&s.reflect===!0){let o=(s.converter?.toAttribute!==void 0?s.converter:jt).toAttribute(e,s.type);this._$Em=t,o==null?this.removeAttribute(r):this.setAttribute(r,o),this._$Em=null}}_$AK(t,e){let s=this.constructor,r=s._$Eh.get(t);if(r!==void 0&&this._$Em!==r){let o=s.getPropertyOptions(r),n=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:jt;this._$Em=r;let d=n.fromAttribute(e,o.type);this[r]=d??this._$Ej?.get(r)??d,this._$Em=null}}requestUpdate(t,e,s,r=!1,o){if(t!==void 0){let n=this.constructor;if(r===!1&&(o=this[t]),s??=n.getPropertyOptions(t),!((s.hasChanged??De)(o,e)||s.useDefault&&s.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:r,wrapped:o},n){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),o!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),r===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,o]of this._$Ep)this[r]=o;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[r,o]of s){let{wrapped:n}=o,d=this[r];n!==!0||this._$AL.has(r)||d===void 0||this.C(r,void 0,o,d)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[j("elementProperties")]=new Map,S[j("finalized")]=new Map,Ks?.({ReactiveElement:S}),(Et.reactiveElementVersions??=[]).push("2.1.2");var Yt=globalThis,ze=i=>i,St=Yt.trustedTypes,Ne=St?St.createPolicy("lit-html",{createHTML:i=>i}):void 0,Ue="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,Fe="?"+C,Ws=`<${Fe}>`,B=document,W=()=>B.createComment(""),G=i=>i===null||typeof i!="object"&&typeof i!="function",Jt=Array.isArray,Gs=i=>Jt(i)||typeof i?.[Symbol.iterator]=="function",Kt=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Be=/-->/g,Te=/>/g,z=RegExp(`>|${Kt}(?:([^\\s"'>=/]+)(${Kt}*=${Kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Le=/'/g,Oe=/"/g,qe=/^(?:script|style|textarea|title)$/i,Xt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),a=Xt(1),Ii=Xt(2),Ei=Xt(3),T=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),Me=new WeakMap,N=B.createTreeWalker(B,129);function je(i,t){if(!Jt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ne!==void 0?Ne.createHTML(t):t}var Hs=(i,t)=>{let e=i.length-1,s=[],r,o=t===2?"<svg>":t===3?"<math>":"",n=K;for(let d=0;d<e;d++){let l=i[d],u,b,p=-1,y=0;for(;y<l.length&&(n.lastIndex=y,b=n.exec(l),b!==null);)y=n.lastIndex,n===K?b[1]==="!--"?n=Be:b[1]!==void 0?n=Te:b[2]!==void 0?(qe.test(b[2])&&(r=RegExp("</"+b[2],"g")),n=z):b[3]!==void 0&&(n=z):n===z?b[0]===">"?(n=r??K,p=-1):b[1]===void 0?p=-2:(p=n.lastIndex-b[2].length,u=b[1],n=b[3]===void 0?z:b[3]==='"'?Oe:Le):n===Oe||n===Le?n=z:n===Be||n===Te?n=K:(n=z,r=void 0);let x=n===z&&i[d+1].startsWith("/>")?" ":"";o+=n===K?l+Ws:p>=0?(s.push(u),l.slice(0,p)+Ue+l.slice(p)+C+x):l+C+(p===-2?d:x)}return[je(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},H=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,n=0,d=t.length-1,l=this.parts,[u,b]=Hs(t,e);if(this.el=i.createElement(u,s),N.currentNode=this.el.content,e===2||e===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=N.nextNode())!==null&&l.length<d;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(Ue)){let y=b[n++],x=r.getAttribute(p).split(C),w=/([.?@])?(.*)/.exec(y);l.push({type:1,index:o,name:w[2],strings:x,ctor:w[1]==="."?Gt:w[1]==="?"?Ht:w[1]==="@"?Vt:O}),r.removeAttribute(p)}else p.startsWith(C)&&(l.push({type:6,index:o}),r.removeAttribute(p));if(qe.test(r.tagName)){let p=r.textContent.split(C),y=p.length-1;if(y>0){r.textContent=St?St.emptyScript:"";for(let x=0;x<y;x++)r.append(p[x],W()),N.nextNode(),l.push({type:2,index:++o});r.append(p[y],W())}}}else if(r.nodeType===8)if(r.data===Fe)l.push({type:2,index:o});else{let p=-1;for(;(p=r.data.indexOf(C,p+1))!==-1;)l.push({type:7,index:o}),p+=C.length-1}o++}}static createElement(t,e){let s=B.createElement("template");return s.innerHTML=t,s}};function L(i,t,e=i,s){if(t===T)return t;let r=s!==void 0?e._$Co?.[s]:e._$Cl,o=G(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,e,s)),s!==void 0?(e._$Co??=[])[s]=r:e._$Cl=r),r!==void 0&&(t=L(i,r._$AS(i,t.values),r,s)),t}var Wt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??B).importNode(e,!0);N.currentNode=r;let o=N.nextNode(),n=0,d=0,l=s[0];for(;l!==void 0;){if(n===l.index){let u;l.type===2?u=new V(o,o.nextSibling,this,t):l.type===1?u=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(u=new Qt(o,this,t)),this._$AV.push(u),l=s[++d]}n!==l?.index&&(o=N.nextNode(),n++)}return N.currentNode=B,r}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},V=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=L(this,t,e),G(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==T&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Gs(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&G(this._$AH)?this._$AA.nextSibling.data=t:this.T(B.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=H.createElement(je(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(e);else{let o=new Wt(r,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Me.get(t.strings);return e===void 0&&Me.set(t.strings,e=new H(t)),e}k(t){Jt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let o of t)r===e.length?e.push(s=new i(this.O(W()),this.O(W()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=ze(t).nextSibling;ze(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},O=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=c}_$AI(t,e=this,s,r){let o=this.strings,n=!1;if(o===void 0)t=L(this,t,e,0),n=!G(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else{let d=t,l,u;for(t=o[0],l=0;l<o.length-1;l++)u=L(this,d[s+l],e,l),u===T&&(u=this._$AH[l]),n||=!G(u)||u!==this._$AH[l],u===c?t=c:t!==c&&(t+=(u??"")+o[l+1]),this._$AH[l]=u}n&&!r&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Gt=class extends O{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}},Ht=class extends O{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}},Vt=class extends O{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=L(this,t,e,0)??c)===T)return;let s=this._$AH,r=t===c&&s!==c||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==c&&(s===c||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Qt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){L(this,t)}};var Vs=Yt.litHtmlPolyfillSupport;Vs?.(H,V),(Yt.litHtmlVersions??=[]).push("3.3.3");var Ke=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let o=e?.renderBefore??null;s._$litPart$=r=new V(t.insertBefore(W(),o),o,void 0,e??{})}return r._$AI(i),r};var Zt=globalThis,m=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ke(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return T}};m._$litElement$=!0,m.finalized=!0,Zt.litElementHydrateSupport?.({LitElement:m});var Qs=Zt.litElementPolyfillSupport;Qs?.({LitElement:m});(Zt.litElementVersions??=[]).push("4.2.2");var We=new WeakMap;function Ge(i){let t=i?.connection??i;if(typeof t!="object"&&typeof t!="function"||t===null)throw new TypeError("BindHome API requires a Home Assistant connection");let e=We.get(t);return e||(e={revision:null,conflictListeners:new Set},We.set(t,e)),e}function D(i,t){Number.isInteger(t)&&t>=0&&(i.revision=t)}function Ys(i){return i?.code??i?.body?.code??i?.data?.code??null}function He(i,t){if(Ys(t)==="conflict")for(let e of i.conflictListeners)e(t)}async function P(i,t,e){let s={...e};t.revision!==null&&(s.based_on_revision=t.revision);try{let r=await i.callWS(s);return D(t,r?.revision),r}catch(r){throw He(t,r),r}}async function Rt(i,t,e,s){try{let r=await i.callWS({...e,based_on_revision:s});return D(t,r?.revision),r}catch(r){throw He(t,r),r}}function Ve(i,t){let e=Ge(i);return e.conflictListeners.add(t),()=>e.conflictListeners.delete(t)}function f(i){let t=Ge(i);return{async getRegistry(){let e=await i.callWS({type:"bindhome/registry/get"});return D(t,e?.revision),e},async subscribeRegistryChanges(e){return i.connection.subscribeMessage(e,{type:"bindhome/registry/subscribe"})},async listAssets(){return(await i.callWS({type:"bindhome/assets/list"})).assets??[]},async listPresets(){return(await i.callWS({type:"bindhome/presets/list"})).presets??[]},async listBindingStatuses(){return i.callWS({type:"bindhome/bindings/status"})},async setBinding({assetId:e,capability:s,entityId:r,role:o="primary"}){return P(i,t,{type:"bindhome/bindings/set",asset_id:e,capability:s,entity_id:r,role:o})},async getReplacementCandidates({assetId:e,capability:s,role:r="primary"}){let o=await i.callWS({type:"bindhome/replacement/candidates",asset_id:e,capability:s,role:r});return D(t,o?.revision),o},async commitReplacement({assetId:e,capability:s,entityId:r,revision:o,role:n="primary"}){return Rt(i,t,{type:"bindhome/replacement/commit",asset_id:e,capability:s,entity_id:r,role:n},o)},async deleteBinding(e){return P(i,t,{type:"bindhome/bindings/delete",binding_id:e})},async createRelation({sourceAssetId:e,relationType:s,targetAssetId:r}){return P(i,t,{type:"bindhome/relations/create",source_asset_id:e,relation_type:s,target_asset_id:r})},async deleteRelation(e){return P(i,t,{type:"bindhome/relations/delete",relation_id:e})},async createAssetsBulk(e){return P(i,t,{type:"bindhome/assets/create_bulk",assets:e})},async updateAsset(e,s){return(await P(i,t,{...s,type:"bindhome/assets/update",asset_id:e})).asset},async deleteAsset(e){return P(i,t,{type:"bindhome/assets/delete",asset_id:e})},async getDeleteImpact(e){let s=await i.callWS({type:"bindhome/assets/delete_impact",asset_id:e});return D(t,s?.revision),s},async deleteAssetWithDependencies(e){return P(i,t,{type:"bindhome/assets/delete_with_dependencies",asset_id:e})},async discoverImport(e=null){let s=await i.callWS({type:"bindhome/import/discover",...e?{area_id:e}:{}});return D(t,s?.revision),s},async commitImport({areaId:e=null,revision:s,decisions:r}){return Rt(i,t,{type:"bindhome/import/commit",decisions:r,...e?{area_id:e}:{}},s)},async exportInventoryCsv(){return i.callWS({type:"bindhome/csv/export"})},async validateInventoryCsv(e){let s=await i.callWS({type:"bindhome/csv/validate",csv:e});return D(t,s?.revision),s},async importInventoryCsv({csv:e,revision:s}){return Rt(i,t,{type:"bindhome/csv/import",csv:e},s)},async exportRegistryBackup(){return i.callWS({type:"bindhome/backup/export"})},async getBackupRecoveryStatus(){return i.callWS({type:"bindhome/backup/recovery_status"})},async restoreRegistryBackup({backup:e,revision:s=null}){if(Number.isInteger(s))return Rt(i,t,{type:"bindhome/backup/restore",backup:e},s);let r=await i.callWS({type:"bindhome/backup/restore",backup:e});return D(t,r?.revision),r}}}var Ct="__bindhome_no_floor__";function Qe(i){return{async listFloors(){return(await i.callWS({type:"config/floor_registry/list"})??[]).map(e=>({floor_id:e.floor_id,name:e.name,level:e.level??null,icon:e.icon??null}))},async listAreas(){return(await i.callWS({type:"config/area_registry/list"})??[]).map(e=>({area_id:e.area_id,name:e.name,floor_id:e.floor_id??null,icon:e.icon??null}))},async listEntityRegistry(){return i.callWS({type:"config/entity_registry/list"})},async listDeviceRegistry(){return i.callWS({type:"config/device_registry/list"})}}}function te(i,t){return t===Ct?i.filter(e=>!e.floor_id):i.filter(e=>e.floor_id===t)}var ee="bindhome.advanced-pinned",se="bindhome.onboarding.v1",ie="bindhome.home-collapsed-floors",re="bindhome.backup.last-exported-at";function Je(i){let t=i?.connection;return t&&typeof t.sendMessagePromise=="function"?t:null}async function Pt(i,t){let e=Je(i);if(!e)return{available:!1,value:null};try{return{available:!0,value:(await e.sendMessagePromise({type:"frontend/get_user_data",key:t}))?.value??null}}catch{return{available:!1,value:null}}}async function R(i,t,e){let s=Je(i);if(!s)return!1;try{return await s.sendMessagePromise({type:"frontend/set_user_data",key:t,value:e}),!0}catch{return!1}}function Xe(i){try{return window.localStorage.getItem(i)}catch{return null}}function Ze(i){try{window.localStorage.removeItem(i)}catch{}}async function ae(i,t,e,s=!1){let r=await Pt(i,t);if(r.available&&r.value!==null)return typeof r.value=="boolean"?r.value:s;let o=Xe(e);if(o===null)return s;let n=o==="true"?!0:o==="false"?!1:s;return r.available&&await R(i,t,n)&&Ze(e),n}function Ye(i){return Array.isArray(i)?[...new Set(i.filter(t=>typeof t=="string"))].sort():[]}async function ts(i,t,e){let s=await Pt(i,t);if(s.available&&s.value!==null)return Ye(s.value);let r=Xe(e);if(r===null)return[];let o=[];try{o=Ye(JSON.parse(r))}catch{o=[]}return s.available&&await R(i,t,o)&&Ze(e),o}var Js="component.bindhome.common.panel_";async function oe(i,t){let e=async o=>(await i.callWS({type:"frontend/get_translations",language:o,category:"common",integration:["bindhome"]}))?.resources??{},s=await e("en"),r=s;if(t!=="en")try{r=await e(t)}catch{r=s}return ne(r,s)}function ne(i={},t={}){return(e,s={})=>{let r=`${Js}${e.replaceAll(".","_")}`;return(i[r]??t[r]??e).replace(/\{(\w+)\}/g,(n,d)=>s[d]??n)}}function Dt(i,t){return`${i}.${t===1?"one":"other"}`}function E(i,t){let e=`presets.${t.preset_id}.name`,s=i(e);return s===e?t.default_name:s}var Xs={light_point:["mdi:lightbulb-outline","lighting"],socket:["mdi:power-socket-eu","electricity"],switch:["mdi:light-switch","electricity"],electrical_panel:["mdi:electric-switch","electricity"],circuit:["mdi:transmission-tower","electricity"],junction_box:["mdi:connection","electricity"],ethernet_outlet:["mdi:ethernet","network"],telephone_outlet:["mdi:phone-classic","network"],antenna_outlet:["mdi:television-classic","network"],wifi_access_point:["mdi:wifi","network"],radiator:["mdi:radiator","climate"],thermostat:["mdi:thermostat","climate"],fan:["mdi:fan","climate"],air_conditioning_unit:["mdi:air-conditioner","climate"],tap:["mdi:faucet","water"],shutoff_valve:["mdi:valve","water"],valve:["mdi:valve","water"],drain:["mdi:water-minus","water"],manifold:["mdi:pipe-valve","water"],door:["mdi:door","structure"],window:["mdi:window-closed","structure"],blind:["mdi:blinds","structure"],skylight:["mdi:window-open","structure"],boiler:["mdi:water-boiler","equipment"],water_heater:["mdi:water-boiler","equipment"],pump:["mdi:pump","equipment"],freezer:["mdi:fridge-outline","equipment"],appliance:["mdi:dishwasher","equipment"],machine:["mdi:cog-outline","equipment"]};function k(i,t){let e=Xs[t],s=`presets.${t}.name`,r=i(s);return{type:t,label:r===s?le(t):r,icon:e?.[0]??"mdi:cube-outline",category:e?.[1]??"other",known:!!e}}function le(i){let t=String(i||"").replaceAll("_"," ").trim();return t?t.charAt(0).toUpperCase()+t.slice(1):"\u2014"}var zt=["lighting","electricity","water","climate","equipment","network","structure","other"];function Nt(i,t){let e={lighting:"mdi:lightbulb-outline",electricity:"mdi:flash-outline",water:"mdi:water-outline",climate:"mdi:thermometer",equipment:"mdi:tools",network:"mdi:lan",structure:"mdi:home-outline",other:"mdi:dots-horizontal-circle-outline"};return{category:t,label:i(`categories.${t}`),icon:e[t]??e.other}}var A="__bindhome_no_area__",I="__bindhome_stale_area__";function es(i,t,e){let s=new Map(t.map(l=>[l.area_id,l])),r=new Map;for(let l of e){let u=l.area_id?s.has(l.area_id)?l.area_id:I:A;r.set(u,[...r.get(u)??[],l])}let n=[...i].sort((l,u)=>(l.level??999)-(u.level??999)||l.name.localeCompare(u.name)).map(l=>({id:l.floor_id,name:l.name,icon:l.icon,level:l.level,areas:t.filter(u=>u.floor_id===l.floor_id).sort(Q)})),d=t.filter(l=>!l.floor_id).sort(Q);return d.length&&n.push({id:"__no_floor__",name:null,icon:null,level:null,areas:d}),{groups:n,assetsByArea:r,unassigned:r.get(A)??[],stale:r.get(I)??[]}}function Q(i,t){return i.name.localeCompare(t.name,void 0,{sensitivity:"base"})}function ss(i,t){let e=new Map;for(let s of t){let r=k(i,s.asset_type);e.set(r.category,[...e.get(r.category)??[],s])}return zt.filter(s=>e.has(s)).map(s=>({category:s,assets:e.get(s).sort(Q)}))}function is(i,t,e,s,r){let o=new Map(e.map(l=>[l.area_id,l])),n=new Map(s.map(l=>[l.floor_id,l])),d=r.trim().toLocaleLowerCase();return d?t.map(l=>{let u=l.area_id?o.get(l.area_id):null,b=u?.floor_id?n.get(u.floor_id):null,p=k(i,l.asset_type),x=[l.name,l.code,p.label,l.asset_type,u?.name,b?.name].filter(Boolean).map(w=>String(w).toLocaleLowerCase()).reduce((w,F,Ut)=>w+(F===d?100-Ut:F.startsWith(d)?50-Ut:F.includes(d)?10-Ut:0),0);return{asset:l,area:u,floor:b,type:p,score:x}}).filter(l=>l.score>0).sort((l,u)=>u.score-l.score||Q(l.asset,u.asset)).slice(0,30):t.slice().sort(Q).slice(0,8)}var rs="/bindhome";function he(){return{view:"home",areaId:null,assetId:null,query:"",contextAreaId:null,advancedAssetId:null}}function de(i){if(!i)return null;try{return decodeURIComponent(i)}catch{return null}}function Zs(i){let t=typeof i=="string"&&i?i:rs,e=t.startsWith("/")?t:`/${t}`;return e.length>1?e.replace(/\/+$/,""):e}function as(i,t=""){let e=he(),r=(typeof i?.path=="string"?i.path:"").split("/").filter(Boolean),o=new URLSearchParams(t.startsWith("?")?t.slice(1):t);if(r.length===0)return e;if(r[0]==="home"){if(r.length>3)return e;let n=r.length>=2?de(r[1]):null,d=r.length>=3?de(r[2]):null;return r.length>=2&&n===null||r.length>=3&&d===null?e:{...e,areaId:n,assetId:d}}if(r[0]==="add"&&r.length===1){let n=o.get("area");return{...e,view:"add",contextAreaId:n||null}}if(r[0]==="search"&&r.length===1)return{...e,view:"search",query:o.get("q")??""};if(r[0]==="advanced"){if(r.length>2)return e;let n=r.length===2?de(r[1]):null;return r.length===2&&n===null?e:{...e,view:"advanced",advancedAssetId:n}}return e}function ce(i){return encodeURIComponent(i)}function pe(i,t=rs){let e=Zs(t);if(i.view==="add"){let r=new URLSearchParams;i.contextAreaId&&r.set("area",i.contextAreaId);let o=r.toString();return`${e}/add${o?`?${o}`:""}`}if(i.view==="search"){let r=new URLSearchParams;i.query&&r.set("q",i.query);let o=r.toString();return`${e}/search${o?`?${o}`:""}`}if(i.view==="advanced")return i.advancedAssetId?`${e}/advanced/${ce(i.advancedAssetId)}`:`${e}/advanced`;let s=`${e}/home`;return i.areaId&&(s+=`/${ce(i.areaId)}`),i.areaId&&i.assetId&&(s+=`/${ce(i.assetId)}`),s}function ue(i,t={}){let e=t.window??window,s=t.replace===!0,r=`${e.location.pathname}${e.location.search}`;if(r===i)return!1;let o=e.history.state??{};if(s){let d={};o?.root&&(d.root=!0),o?.from!==void 0&&(d.from=o.from),e.history.replaceState(Object.keys(d).length?d:null,"",i)}else e.history.pushState({from:r},"",i);let n=e.document.createEvent("CustomEvent");return n.initCustomEvent("location-changed",!1,!1,{replace:s}),e.dispatchEvent(n),!0}var $=g`
  :host {
    --bh-space-1: 4px;
    --bh-space-2: 8px;
    --bh-space-3: 12px;
...
`;var ti={feeds:{outgoing:"relations.feeds.outgoing",incoming:"relations.feeds.incoming"},contains:{outgoing:"relations.contains.outgoing",incoming:"relations.contains.incoming"},controls:{outgoing:"relations.controls.outgoing",incoming:"relations.controls.incoming"},part_of:{outgoing:"relations.part_of.outgoing",incoming:"relations.part_of.incoming"}};function os(i,t,e){let s=ti[t]?.[e];return{type:t,direction:e,label:s?i(s):i("relations.unknown",{type:le(t)}),known:!!s,icon:t==="feeds"?"mdi:flash-outline":t==="controls"?"mdi:tune":t==="contains"||t==="part_of"?"mdi:folder-outline":"mdi:vector-link"}}function ns(i){return{socket:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.indicate_feeds"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}],circuit:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.panel_source"}],electrical_panel:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],junction_box:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],manifold:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],shutoff_valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],light_point:[{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}]}[i]??[]}function M(i=[],t){return{outgoing:i.filter(e=>e.source_asset_id===t),incoming:i.filter(e=>e.target_asset_id===t)}}function ls(i=[]){return[...new Set(i.map(t=>t.relation_type).filter(Boolean))].sort()}function me(i){return/^[a-z][a-z0-9_]*$/.test(String(i).trim())}function ge(i){return[i?.message,i?.body?.message,i?.data?.message,i?.error].filter(t=>typeof t=="string")}function v(i,t=null){let e=ge(i).find(s=>s.trim())??t;return{code:i?.code??i?.body?.code??i?.data?.code??null,message:e}}function ds(i,t=null){for(let s of ge(i))try{let r=JSON.parse(s);if(Number.isInteger(r?.index)&&r.index>=0&&typeof r?.field=="string"&&typeof r?.message=="string")return{structured:!0,index:r.index,field:r.field,message:r.message}}catch{}return{structured:!1,index:null,field:null,message:ge(i).find(s=>s.trim())??t}}function ei(i){return String(i??"").trim()}function U(i){return ei(i).toLocaleLowerCase()}function hs(i,t){return U(i.name).localeCompare(U(t.name),void 0,{numeric:!0,sensitivity:"base"})||i.entityId.localeCompare(t.entityId)}function cs(i,t,e){let s=U(t);if(!s)return e&&i.areaId===e?0:1;let r=[i.name,i.entityId,i.areaName,i.deviceName,i.domain].map(U),o=r.some(l=>l===s),n=r.some(l=>l.startsWith(s)),d=e&&i.areaId===e?0:1;return(o?0:n?1:2)*2+d}function _e({entityRegistry:i=[],deviceRegistry:t=[],states:e={},areas:s=[]}={}){let r=new Map(i.filter(l=>l?.entity_id).map(l=>[l.entity_id,l])),o=new Map(t.filter(l=>l?.id).map(l=>[l.id,l])),n=new Map(s.filter(l=>l?.area_id).map(l=>[l.area_id,l.name]));return[...new Set([...r.keys(),...Object.keys(e??{})])].map(l=>{let u=r.get(l)??null,b=e?.[l]??null,p=u?.device_id?o.get(u.device_id):null,[y]=l.split("."),x=u?.area_id??p?.area_id??null,w=b?.attributes?.friendly_name??u?.name??u?.original_name??l;return{entityId:l,domain:y,name:w,state:b?.state??null,registryEntry:u,deviceId:u?.device_id??null,deviceName:p?.name_by_user??p?.name??null,areaId:x,areaName:x?n.get(x)??null:null,disabled:!!u?.disabled_by,hidden:!!u?.hidden_by,isBindHome:u?.platform==="bindhome"}}).sort(hs)}function ps(i,t="",e=null){let s=U(t);return[...i??[]].filter(r=>s?[r.name,r.entityId,r.areaName,r.deviceName,r.domain].some(o=>U(o).includes(s)):!0).sort((r,o)=>cs(r,s,e)-cs(o,s,e)||hs(r,o))}var si=8,ii=20;function ri(i,t){let e=`capabilities.${t}`,s=i(e);return s!==e?s:t.replaceAll("_"," ").replace(/\b\w/g,r=>r.toUpperCase())}var Y=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.capability="",this.status=null,this.areas=[],this.entityRegistry=[],this.deviceRegistry=[],this.showEntityId=!0,this.refreshBindingData=null,this._editing=!1,this._search="",this._selectedEntityId=null,this._saving=!1,this._error=null,this._confirmDisconnect=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._bindingIdentity=null,this._operation=0,this._committedDisconnectId=null}_replacementMode(){return!!(this.status?.binding&&this.status?.status!=="binding_not_found")}_replacementCandidates(){if(!this._replacementPlan)return null;let t=new Map((this.areas??[]).map(s=>[s.area_id,s.name])),e=new Map((this.deviceRegistry??[]).map(s=>[s.id,s.name_by_user||s.name]));return(this._replacementPlan.candidates??[]).map(s=>({entityId:s.entity_id,entityRegistryId:s.entity_registry_id,name:s.name,domain:s.domain,areaId:s.area_id,areaName:t.get(s.area_id)??null,deviceId:s.device_id,deviceName:e.get(s.device_id)??null,state:s.state,disabled:!1,hidden:!1,reasons:s.reasons??[]}))}_candidates(){let t=this._replacementCandidates();return t||_e({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas})}willUpdate(){let t=this.asset?JSON.stringify([this.asset.id,this.capability,"primary"]):null;this._bindingIdentity!==null&&t!==this._bindingIdentity&&(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._saving=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._committedDisconnectId=null,this._operation+=1),this._bindingIdentity=t}_currentEntityId(){return this.status?.entity_id??this.status?.binding?.entity_id??null}_currentCandidate(){let t=this._currentEntityId();return _e({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas}).find(e=>e.entityId===t)??null}_runtimeLabel(t){return t?t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state===null?this.t("connection.no_runtime"):this.t("connection.available"):this.t("connection.stale")}_configurationLabel(){return this.status?.status==="entity_not_found"||this.status?.config_valid!==!1?this.t("connection.configured"):this.t("connection.invalid_configuration")}_candidateStateLabel(t){return!t||t.state===null?this.t("connection.no_runtime"):t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state}_displayName(t,e){return t?.name&&(this.showEntityId||t.name!==e)?t.name:t?.deviceName??(this.showEntityId?e:this.t("connection.configured"))}_candidateMeta(t){return[this.showEntityId?t?.entityId:null,t?.areaName,t?.deviceName,t?this._candidateStateLabel(t):null].filter(Boolean).join(" \xB7 ")}async _beginEdit(){if(this._saving||this._replacementLoading||(this._editing=!0,this._selectedEntityId=this._replacementMode()?null:this._currentEntityId(),this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._selectionMode="search",!this._replacementMode()))return;let t=++this._operation;this._replacementLoading=!0;try{let e=await f(this.hass).getReplacementCandidates({assetId:this.asset.id,capability:this.capability,role:"primary"});if(t!==this._operation)return;this._replacementPlan=e}catch(e){if(t!==this._operation)return;this._error=v(e,this.t("connection.replacement_load_error")).message}finally{t===this._operation&&(this._replacementLoading=!1)}}_cancelEdit(){this._saving||(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementPlan=null,this._replacementLoading=!1,this._selectionMode="search")}_select(t){this._saving||(this._selectedEntityId=t,this._error=null,this._confirmReplacement=!1,this._selectionMode="selected")}_changeSelection(){this._saving||(this._selectionMode="search",this._confirmReplacement=!1)}async _save(){if(this._saving||!this._selectedEntityId||!this.asset)return;if(this._replacementMode()&&!this._confirmReplacement){this._confirmReplacement=!0;return}this._saving=!0,this._error=null;let t=++this._operation,e=this._selectedEntityId;try{let s;if(this._replacementMode()){if(!this._replacementPlan||!Number.isInteger(this._replacementPlan.revision))throw new Error(this.t("connection.replacement_load_error"));s=await f(this.hass).commitReplacement({assetId:this.asset.id,capability:this.capability,entityId:e,revision:this._replacementPlan.revision,role:"primary"})}else s=await f(this.hass).setBinding({assetId:this.asset.id,capability:this.capability,entityId:e,role:"primary"});if(t!==this._operation)return;this._replacementSuccess=this._replacementMode()?s?.resolution?.entity_id??e:null,this._editing=!1,this._selectedEntityId=null,this._search="",this._confirmReplacement=!1,this._replacementPlan=null;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(t!==this._operation)return;let r=v(s,this.t("connection.save_error"));this._error=r.code==="binding_cycle"?this.t("connection.cycle_error"):r.message}finally{this._saving=!1}}async _disconnect(){let t=this.status?.binding;if(this._saving||!t||this._committedDisconnectId===t.id)return;this._saving=!0,this._error=null,this._editing=!1;let e=++this._operation;try{if(await f(this.hass).deleteBinding(t.id),e!==this._operation)return;this._committedDisconnectId=t.id,this._confirmDisconnect=!1;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(e!==this._operation)return;this._error=v(s,this.t("connection.disconnect_error")).message,this._confirmDisconnect=!0}finally{this._saving=!1}}_renderSummary(){let t=this.status?.binding,e=this._currentEntityId(),s=this._currentCandidate();return!t||this.status?.status==="binding_not_found"?a`<div class="summary">${this.t("connection.not_connected")}</div><div class="actions"><button class="primary" @click=${this._beginEdit}>${this.t("connection.connect")}</button></div>`:a`
    ...
    `}_renderEditor(){if(this._replacementLoading)return a`<div class="picker"><div class="muted">${this.t("connection.replacement_loading")}</div><div class="actions"><button @click=${this._cancelEdit}>${this.t("editor.cancel")}</button></div></div>`;let t=ps(this._candidates(),this._search,this.asset?.area_id),e=t.slice(0,this._search?ii:si),s=this._currentEntityId(),r=this._candidates().find(n=>n.entityId===this._selectedEntityId),o=!!(s&&s===this._selectedEntityId);return a`
      <div class="picker">
  ...
  `);_("bindhome-asset-delete-control",Z);var tt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.floors=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.advancedEnabled=!1,this.readOnly=!1,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this._action=null,this._sync=null,this._editingAsset=!1,this._identity=null}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._action=null,this._sync=null,this._editingAsset=!1)}_area(){return this.areas.find(t=>t.area_id===this.asset?.area_id)??null}_asset(t){return this.assets.find(e=>e.id===t)??null}_relations(){let t=M(this.registry?.relations??[],this.asset?.id);return[...t.incoming.map(e=>({relation:e,direction:"incoming",other:this._asset(e.source_asset_id)})),...t.outgoing.map(e=>({relation:e,direction:"outgoing",other:this._asset(e.target_asset_id)}))]}_devices(){let t=this.asset?.capabilities??[],e=(this.bindingStatuses?.records??[]).filter(o=>o.asset_id===this.asset?.id&&o.role==="primary"&&!!(o.binding||o.entity_id)).map(o=>({capability:o.capability,status:o})),s=e.length?e:t.length?[{capability:t[0],status:null}]:[],r=new Set;return s.filter(({capability:o,status:n})=>{let d=n?.binding?.entity_id??n?.entity_id,l=this.entityRegistry.find(b=>b.entity_id===d)?.device_id,u=l?`device:${l}`:d?`entity:${d}`:`capability:${o}`;return r.has(u)?!1:(r.add(u),!0)})}_forwardDeleted(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-deleted",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return c;if(this._editingAsset)return a`<bindhome-human-asset-editor
    ...
    ></bindhome-human-asset-editor>`;let t=k(this.t,this.asset.asset_type),e=this._area(),s=this._relations(),r=this._devices(),o=(this.registry.representations??[]).filter(d=>d.asset_id===this.asset.id),n=ns(this.asset.asset_type);return a`<button class="back text-button" @click=${()=>this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}>
      ...
      <article class="card surface">
        <header class="header">
          ...
          ${this.readOnly?c:a`<button class="text-button" @click=${()=>this._editingAsset=!0}>${this.t("common.edit")}</button>`}
        </header>
        <section class="section">
          <h3>${this.t("detail.connections")}</h3>
          ${s.length?a`<div class="relations">${s.map(({relation:d,direction:l,other:u})=>{let b=os(this.t,d.relation_type,l);return a`<div class="relation"><ha-icon icon=${b.icon}></ha-icon><div><small>${b.label}</small>${u?a`<button @click=${()=>this.dispatchEvent(new CustomEvent("navigate-asset",{detail:u.id,bubbles:!0,composed:!0}))}>${u.name}</button>`:a`<strong>${this.t("detail.missing_element")}</strong>`}</div></div>`})}</div>`:a`<p class="passive">${this.t("detail.no_connections")}</p>`}
          ${!this.readOnly&&n.length?a`<div class="actions">${n.map(d=>a`<button class="secondary" ?disabled=${!!this._action} @click=${()=>this._action=d}>${this.t(d.labelKey)}</button>`)}</div>`:c}
          ${!this.readOnly&&this._action?a`<bindhome-contextual-relation-editor .hass=${this.hass} .t=${this.t} .asset=${this.asset} .assets=${this.assets} .areas=${this.areas} .action=${this._action} .onRefresh=${this.refreshTopologyData} @cancel=${()=>this._action=null} @done=${()=>this._action=null} @sync-warning=${d=>this._sync=d.detail}></bindhome-contextual-relation-editor>`:c}
        ...
        <section class="section">
          ...
          ${r.length?r.map(d=>a`<div class="device">${this.readOnly?a`<strong>${d.capability}</strong><p class="raw">${d.status?.entity_id||this.t("common.not_set")}</p>${d.status?.status?a`<p class="passive">${d.status.status}</p>`:c}`:a`<bindhome-primary-connection-editor .hass=${this.hass} .t=${this.t} .asset=${this.asset} .capability=${d.capability} .status=${d.status} .areas=${this.areas} .entityRegistry=${this.entityRegistry} .deviceRegistry=${this.deviceRegistry} .refreshBindingData=${this.refreshBindingData} .showEntityId=${!1}></bindhome-primary-connection-editor>`}</div>`):a`<p class="passive">${this.t("detail.passive")}</p>`}
        </section>
        <section class="section">
          <details>
            ...
            ${!this.readOnly&&this.advancedEnabled?a`<button class="secondary open-advanced" @click=${()=>this.dispatchEvent(new CustomEvent("open-advanced",{detail:this.asset.id,bubbles:!0,composed:!0}))}>${this.t("detail.open_advanced")}</button>`:c}
          </details>
        </section>
        ${this.readOnly?c:a`<section class="section">
      ...
      </article>`}};h(tt,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},floors:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},advancedEnabled:{type:Boolean,attribute:!1},readOnly:{type:Boolean,attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},_action:{state:!0},_sync:{state:!0},_editingAsset:{state:!0}}),h(tt,"styles",[$,g`
    ...
    `]);_("bindhome-element-detail",tt);var et=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.floors=[],this.areas=[],this.assets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.advancedEnabled=!1,this.readOnly=!1,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this.selectedAssetId=null,this.selectedAreaId=null,this._collapsedFloorIds=new Set,this._collapsedPreferenceIdentity=null,this._collapsedPreferenceGeneration=0}updated(t){t.has("hass")&&this._restoreCollapsedFloors()}_legacyCollapsedPreferenceKey(){return`bindhome.home-collapsed-floors.${this.hass?.user?.id??"browser"}`}async _restoreCollapsedFloors(){let t=this.hass?.user?.id??"browser";if(t===this._collapsedPreferenceIdentity)return;this._collapsedPreferenceIdentity=t;let e=++this._collapsedPreferenceGeneration,s=await ts(this.hass,ie,this._legacyCollapsedPreferenceKey());e!==this._collapsedPreferenceGeneration||t!==this._collapsedPreferenceIdentity||(this._collapsedFloorIds=new Set(s))}_persistCollapsedFloors(){this._collapsedPreferenceIdentity=this.hass?.user?.id??"browser",this._collapsedPreferenceGeneration+=1,R(this.hass,ie,[...this._collapsedFloorIds].sort())}_areaAssets(t){return t===A?this.assets.filter(e=>!e.area_id):t===I?this.assets.filter(e=>e.area_id&&!this.areas.some(s=>s.area_id===e.area_id)):this.assets.filter(e=>e.area_id===t)}_selectArea(t){this.dispatchEvent(new CustomEvent("home-navigate",{detail:{areaId:t,assetId:null},bubbles:!0,composed:!0}))}_selectAsset(t){let e=this.assets.find(r=>r.id===t);if(!e)return;let s=e.area_id?this.areas.some(r=>r.area_id===e.area_id)?e.area_id:I:A;this.dispatchEvent(new CustomEvent("home-navigate",{detail:{areaId:s,assetId:t},bubbles:!0,composed:!0}))}_toggleFloor(t){let e=new Set(this._collapsedFloorIds);e.has(t)?e.delete(t):e.add(t),this._collapsedFloorIds=e,this._persistCollapsedFloors()}_floorIcon(t){return t.icon?t.icon:t.level===-1?"mdi:home-floor-negative-1":Number.isInteger(t.level)&&t.level>=0&&t.level<=3?`mdi:home-floor-${t.level}`:"mdi:floor-plan"}_roomCountLabel(t){return this.t(t===1?"home.room_count_one":"home.room_count_other",{count:t})}_selectedArea(){return this.areas.find(t=>t.area_id===this.selectedAreaId)??null}_areaName(){return this.selectedAreaId===A?this.t("home.unassigned"):this.selectedAreaId===I?this.t("home.stale_area"):this._selectedArea()?.name??this.t("home.choose_room")}_areaIcon(){return this.selectedAreaId===A?"mdi:map-marker-off-outline":this.selectedAreaId===I?"mdi:map-marker-alert-outline":this._selectedArea()?.icon||"mdi:floor-plan"}_addInSelectedArea(){!this.selectedAreaId||[A,I].includes(this.selectedAreaId)||this.dispatchEvent(new CustomEvent("add-in-area",{detail:this.selectedAreaId,bubbles:!0,composed:!0}))}_renderTree(){let t=es(this.floors,this.areas,this.assets);return a`<section
    ...
    >
      ${t.groups.map(e=>{let s=this._collapsedFloorIds.has(e.id);return a`<div>
          ...
          ${s?c:e.areas.map(r=>{let o=t.assetsByArea.get(r.area_id)?.length??0,n=this.selectedAreaId===r.area_id;return a`<button
    ...
    </section>`}_renderRoom(){if(!this.selectedAreaId)return a`<div class="empty room">${this.t("home.choose_room")}</div>`;let t=this._areaAssets(this.selectedAreaId),e=ss(this.t,t),s=!this.readOnly&&![A,I].includes(this.selectedAreaId);return a`<section class="room surface ${this.selectedAssetId?"hidden-mobile":""}">
      ...
      ${e.length?e.map(r=>{let o=Nt(this.t,r.category);return a`<section>
              ...
              ${r.assets.map(n=>{let d=k(this.t,n.asset_type);return a`<button class="asset-row" @click=${()=>this._selectAsset(n.id)}>
                  <ha-icon icon=${d.icon}></ha-icon><span class="grow"><strong>${n.name}</strong><span class="asset-meta">${d.label}</span></span><ha-icon icon="mdi:chevron-right"></ha-icon>
                </button>`})}
            </section>`}):a`<div class="empty empty-room">
            <span>${this.t("home.room_empty")}</span>
            ${s?a`<button class="primary" @click=${this._addInSelectedArea}><ha-icon icon="mdi:plus"></ha-icon>${this.t("home.add_first_element")}</button>`:c}
          </div>`}
    ...
    </div>`}};h(et,"properties",{hass:{attribute:!1},t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},advancedEnabled:{type:Boolean,attribute:!1},readOnly:{type:Boolean,attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},selectedAssetId:{attribute:!1},selectedAreaId:{attribute:!1},_collapsedFloorIds:{state:!0}}),h(et,"styles",[$,g`
    ...
    `]);_("bindhome-home-view",et);var ai=["light_point","socket","circuit","tap","shutoff_valve","window","door","appliance"];function us(i,t,e=""){let s=e.trim().toLocaleLowerCase(),r=t.map(n=>({preset:n,name:E(i,n),presentation:k(i,n.asset_type)})).filter(({preset:n,name:d})=>!s||[d,n.asset_type].some(l=>l.toLocaleLowerCase().includes(s))).sort((n,d)=>n.name.localeCompare(d.name,void 0,{sensitivity:"base",numeric:!0})),o=new Map;for(let n of r){let d=n.presentation.category;o.has(d)||o.set(d,[]),o.get(d).push(n)}return{featured:s?[]:ai.map(n=>r.find(({preset:d})=>d.preset_id===n)).filter(Boolean),groups:zt.filter(n=>o.has(n)).map(n=>({category:n,items:o.get(n)})),count:r.length}}function oi(i,t){return{key:`draft:${i.preset_id}:${t}`,presetId:i.preset_id,name:`${i.default_name} ${t}`,asset_type:i.asset_type,code:null,capabilities:[...i.suggested_capabilities??[]]}}function st(i=[]){return{presetOrder:i.map(t=>t.preset_id),presets:new Map(i.map(t=>[t.preset_id,t])),quantities:new Map(i.map(t=>[t.preset_id,0])),retained:new Map(i.map(t=>[t.preset_id,[]]))}}function ms(i,t,e){let s=i.presets.get(t);if(!s)return i;let r=Math.max(0,Math.floor(Number(e)||0)),o=[...i.retained.get(t)??[]];for(;o.length<r;)o.push(oi(s,o.length+1));return{...i,quantities:new Map(i.quantities).set(t,r),retained:new Map(i.retained).set(t,o)}}function gs(i,t,e){let s=new Map(i.retained);for(let[r,o]of s){let n=o.findIndex(l=>l.key===t);if(n===-1)continue;let d=[...o];d[n]={...d[n],...e},s.set(r,d);break}return{...i,retained:s}}function fe(i){return i.presetOrder.flatMap(t=>{let e=i.quantities.get(t)??0;return(i.retained.get(t)??[]).slice(0,e)})}function _s(i,t){return fe(i).map(e=>{let s={name:e.name,asset_type:e.asset_type,area_id:t,capabilities:[...e.capabilities]};return e.code?.trim()&&(s.code=e.code.trim()),s})}function fs(i,t){return(i??[]).filter(e=>e.area_id===t)}function bs(i,t){let e=new Map(t.map(r=>[r.asset_type,r.group])),s=new Map;for(let r of i){let o=e.get(r.asset_type)??"other",n=s.get(o)??[];n.push(r),s.set(o,n)}return s}var Bt=class{constructor(t,e=null){this.api=t,this.fallbackMessage=e,this.saving=!1}async save(t,e){if(this.saving)return{ok:!1,duplicate:!0};this.saving=!0;let s=_s(t,e),r;try{r=await this.api.createAssetsBulk(s)}catch(o){return this.saving=!1,{ok:!1,duplicate:!1,error:ds(o,this.fallbackMessage)}}try{let o=await this.api.listAssets();return{ok:!0,created:r.assets??[],assets:o,payload:s,refreshError:null}}catch(o){return{ok:!0,created:r.assets??[],assets:null,payload:s,refreshError:o}}finally{this.saving=!1}}};var it=class extends m{constructor(){super(),this.hass=null,this.presets=[],this.t=t=>t,this.floors=[],this.areas=[],this.assets=[],this._step="select",this._floorId="",this._areaId="",this._draftState=st(),this._openGroups=new Set,this._openDrafts=new Set,this._saveError=null,this._saving=!1,this._success=null,this._confirmRoomChange=!1,this._controller=null}willUpdate(t){(t.has("presets")||t.has("t"))&&this.presets.length&&this._activeDrafts.length===0&&(this._draftState=st(this._localizedPresets()),this._openGroups=new Set([this.presets[0].group])),(t.has("hass")||t.has("t"))&&this.hass&&(this._controller=new Bt(f(this.hass),this.t("errors.batch_fallback")))}get _selectedArea(){return this.areas.find(t=>t.area_id===this._areaId)}get _selectedFloor(){return this._floorId===Ct?null:this.floors.find(t=>t.floor_id===this._floorId)}get _areaAssets(){return fs(this.assets,this._areaId)}get _activeDrafts(){return fe(this._draftState)}_localizedPresets(){return this.presets.map(t=>({...t,default_name:E(this.t,t)}))}_groupLabel(t){return this.t(`groups.${t}`)===`groups.${t}`?t:this.t(`groups.${t}`)}_count(t,e){return this.t(Dt(t,e),{count:e})}_selectFloor(t){this._floorId=t.target.value,te(this.areas,this._floorId).some(s=>s.area_id===this._areaId)||(this._areaId="")}_continue(){this._areaId&&(this._step="quantity")}_changeQuantity(t,e){if(this._saving)return;let s=this._draftState.quantities.get(t)??0;this._draftState=ms(this._draftState,t,s+e),this._saveError=null}_toggleGroup(t){let e=new Set(this._openGroups);e.has(t)?e.delete(t):e.add(t),this._openGroups=e}_toggleDraft(t){let e=new Set(this._openDrafts);e.has(t)?e.delete(t):e.add(t),this._openDrafts=e}_updateDraft(t,e){if(this._saving)return;let s=Object.keys(e),r=this._activeDrafts.findIndex(o=>o.key===t);this._draftState=gs(this._draftState,t,e),(!this._saveError?.structured||this._saveError.index===r&&s.includes(this._saveError.field))&&(this._saveError=null)}_removeCapability(t,e){this._updateDraft(t.key,{capabilities:t.capabilities.filter(s=>s!==e)})}_addCapability(t,e){let s=e.value.trim();!s||t.capabilities.includes(s)||(this._updateDraft(t.key,{capabilities:[...t.capabilities,s]}),e.value="")}async _save(){if(this._saving||!this._controller||!this._activeDrafts.length)return;this._saving=!0,this._saveError=null;let t=await this._controller.save(this._draftState,this._areaId);if(this._saving=!1,t.duplicate)return;if(!t.ok){if(this._saveError=t.error,this._step="review",t.error.structured){let s=this._activeDrafts[t.error.index];if(s){this._openDrafts=new Set([...this._openDrafts,s.key]),await this.updateComplete;let r=this.renderRoot.querySelector(`#${CSS.escape(this._fieldId(s,t.error.field))}`)??this.renderRoot.querySelector(".alert");r?.classList.contains("alert")&&r.setAttribute("tabindex","-1"),r?.scrollIntoView({behavior:"smooth",block:"center"}),r instanceof HTMLElement&&r.focus({preventScroll:!0})}}return}let e=t.assets??[...this.assets,...t.created];this.assets=e,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:e,bubbles:!0,composed:!0})),this._success={count:t.created.length,areaName:this._selectedArea?.name??this.t("inventory.selected_area")},this._draftState=st(this._localizedPresets()),this._openGroups=new Set([this.presets[0]?.group].filter(Boolean)),this._openDrafts=new Set,this._step="success"}_backToQuantities(){this._step="quantity"}_requestRoomChange(){if(this._activeDrafts.length){this._confirmRoomChange=!0;return}this._step="select"}_discardAndChangeRoom(){this._draftState=st(this._localizedPresets()),this._saveError=null,this._openDrafts=new Set,this._confirmRoomChange=!1,this._floorId="",this._areaId="",this._step="select"}_fieldId(t,e){return`${t.key.replaceAll(":","-")}-${e}`}_fieldError(t,e){return this._saveError?.structured&&this._saveError.index===t&&this._saveError.field===e}_renderContext(){return a`<div class="context"><div class="context-inner">
    ...
    </div></div>`}_renderSelection(){let t=[...this.floors,{floor_id:Ct,name:this.t("common.no_floor")}],e=te(this.areas,this._floorId);return a`<div class="content selection">
    ...
    </div>`}_renderExisting(){let t=bs(this._areaAssets,this.presets);return this._areaAssets.length?a`<div class="existing-summary">${[...t].map(([e,s])=>a`<div class="existing-group"><div class="existing-heading"><strong>${this._groupLabel(e)}</strong><span class="muted">${s.length}</span></div><ul class="existing-list">${s.map(r=>a`<li>${r.name}</li>`)}</ul></div>`)}</div>`:a`<p class="muted helper">${this.t("inventory.no_existing")}</p>`}_renderQuantity(){let t=new Map;for(let e of this.presets)t.set(e.group,[...t.get(e.group)??[],e]);return a`${this._renderContext()}${this._renderRoomChangeConfirmation()}<div class="content layout"><section><h1>${this.t("inventory.quantity_title")}</h1><p class="muted intro">${this.t("inventory.quantity_intro")}</p>
  ...
  `);_("bindhome-inventory-workflow",it);function rt(i){let t=i.entity_registry_id?`registry:${i.entity_registry_id}`:`entity:${i.entity_id}`;return`${i.capability}:${i.role??"primary"}:${t}`}function vs(i){return{revision:i.revision,scope:i.scope,reviews:(i.proposals??[]).map(t=>({proposal:t,action:null,asset:{name:t.asset.name,asset_type:t.asset.asset_type,area_id:t.asset.area_id??"",capabilities:[...t.asset.capabilities??[]]},targetAssetId:"",selectedBindings:new Set((t.bindings??[]).map(e=>rt(e)))}))}}function Tt(i,t,e){return{...i,reviews:i.reviews.map(s=>s.proposal.proposal_id===t?e(s):s)}}function ys(i,t,e){return Tt(i,t,s=>({...s,action:e,targetAssetId:e==="merge"?s.targetAssetId:""}))}function be(i,t,e){return Tt(i,t,s=>({...s,asset:{...s.asset,...e}}))}function xs(i,t,e){return Tt(i,t,s=>({...s,targetAssetId:e}))}function $s(i,t,e){return Tt(i,t,s=>{let r=new Set(s.selectedBindings),o=rt(e);return r.has(o)?r.delete(o):r.add(o),{...s,selectedBindings:r}})}function ws(i,t,e){let s=[...new Set(e.split(",").map(r=>r.trim()).filter(Boolean))];return be(i,t,{capabilities:s})}function ni(i){return i.action?i.action==="skip"?!0:i.action==="merge"?!!i.targetAssetId:!!(i.asset.name.trim()&&i.asset.asset_type.trim()):!1}function ve(i){return!!i?.reviews?.length&&i.reviews.every(ni)}function li(i){return(i.proposal.bindings??[]).filter(t=>i.selectedBindings.has(rt(t))).map(t=>({capability:t.capability,role:t.role??"primary",entity_id:t.entity_id,...t.entity_registry_id?{entity_registry_id:t.entity_registry_id}:{}}))}function ks(i){return i.reviews.map(t=>{let e={proposal_id:t.proposal.proposal_id,action:t.action};if(t.action==="skip")return e;let s=li(t);return t.action==="merge"?{...e,target_asset_id:t.targetAssetId,bindings:s}:{...e,asset:{name:t.asset.name.trim(),asset_type:t.asset.asset_type.trim(),capabilities:[...t.asset.capabilities],...t.asset.area_id?{area_id:t.asset.area_id}:{}},bindings:s}})}function As(i){return`import.status.${i??"new"}`}function Is(i,t){let e=new Set(t.merge_candidate_asset_ids??[]);return[...i].sort((s,r)=>{let o=e.has(s.id)?0:1,n=e.has(r.id)?0:1;return o!==n?o-n:String(s.name??s.id).localeCompare(String(r.name??r.id))})}var at=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.areas=[],this.assets=[],this.contextAreaId=null,this._scope="all",this._areaId="",this._reviewState=null,this._loading=!1,this._saving=!1,this._error=null,this._success=null,this._initializedContext=!1}willUpdate(t){!this._initializedContext&&t.has("contextAreaId")&&(this._initializedContext=!0,this.contextAreaId&&(this._scope="area",this._areaId=this.contextAreaId))}get _selectedAreaId(){return this._scope==="area"&&this._areaId||null}async _discover(){if(!(this._loading||this._scope==="area"&&!this._areaId)){this._loading=!0,this._error=null,this._success=null;try{let t=await f(this.hass).discoverImport(this._selectedAreaId);this._reviewState=vs(t)}catch(t){let e=v(t,this.t("import.discover_error"));this._error=e.message}finally{this._loading=!1}}}_setAction(t,e){this._reviewState=ys(this._reviewState,t,e),this._error=null}_updateAsset(t,e){this._reviewState=be(this._reviewState,t,e),this._error=null}_toggleBinding(t,e){this._reviewState=$s(this._reviewState,t,e)}async _commit(){if(!(this._saving||!ve(this._reviewState))){this._saving=!0,this._error=null;try{let t=await f(this.hass).commitImport({areaId:this._reviewState.scope?.area_id??null,revision:this._reviewState.revision,decisions:ks(this._reviewState)});this._success=t,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t,bubbles:!0,composed:!0}))}catch(t){let e=v(t,this.t("import.commit_error"));this._error=e.message}finally{this._saving=!1}}}_startOver(){this._reviewState=null,this._error=null,this._success=null}_areaFor(t){return this.areas.find(e=>e.area_id===t.asset.area_id)??null}render(){return this._success?this._renderSuccess():this._reviewState?this._renderReview():this._renderScope()}_renderScope(){return a`
      <section>
    ...
    `}_renderProposal(t){let e=t.proposal,s=e.source?.entity_ids??[],r=e.duplicate_status??"new",o=this._areaFor(e);return a`
      <article class="proposal surface" data-proposal-id=${e.proposal_id}>
        <div class="proposal-head">
          ...
          <span class="status ${r}">${this.t(As(r))}</span>
        </div>
    ...
    `}_renderCreateEditor(t){let e=t.proposal.proposal_id;return a`<div class="editor">
      <div class="editor-grid">
        ...
        <label>${this.t("fields.capabilities")}<input
          ...
          @change=${s=>{this._reviewState=ws(this._reviewState,e,s.target.value)}}
        /></label>
      </div>
      ${this._renderBindings(t)}
    </div>`}_renderMergeEditor(t){let e=t.proposal.proposal_id,s=Is(this.assets,t.proposal);return a`<div class="editor">
      <label>${this.t("import.merge_target")}<select
        .value=${t.targetAssetId}
        @change=${r=>{this._reviewState=xs(this._reviewState,e,r.target.value),this._error=null}}
      >
      ...
      ${e.map(s=>{let r=t.selectedBindings.has(rt(s));return a`<label class="binding">
          <input
            type="checkbox"
            .checked=${r}
    ...
    </section>`}};h(at,"properties",{hass:{attribute:!1},t:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},contextAreaId:{attribute:!1},_scope:{state:!0},_areaId:{state:!0},_reviewState:{state:!0},_loading:{state:!0},_saving:{state:!0},_error:{state:!0},_success:{state:!0}}),h(at,"styles",g`
  ...
  `);_("bindhome-assisted-import-workflow",at);var ot=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.contextAreaId=null,this.sessionId=0,this.onCreated=null,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId="",this._search="",this._saving=!1,this._error=null,this._sync=null,this._committed=!1,this._identity=null,this._operation=0}willUpdate(){this.sessionId!==this._identity&&(this._identity=this.sessionId,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId=this.contextAreaId??"",this._search="",this._operation+=1,this._saving=!1,this._error=null,this._sync=null,this._committed=!1)}_choose(t){this._preset=t,this._name=E(this.t,t),this._code="",this._error=null,this._sync=null,this._committed=!1}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_goHome(t){t?.stopPropagation?.(),this.dispatchEvent(new CustomEvent("go-home",{bubbles:!0,composed:!0}))}async _submit(t){if(t.preventDefault(),this._saving||this._committed||!this._preset||!this._name.trim())return;let e=++this._operation,s=this.sessionId;this._saving=!0,this._error=null,this._sync=null;try{let r={name:this._name.trim(),asset_type:this._preset.asset_type,capabilities:[...this._preset.suggested_capabilities??[]]};this._code.trim()&&(r.code=this._code.trim()),this._areaId&&(r.area_id=this._areaId);let o=await f(this.hass).createAssetsBulk([r]),n=o?.assets?.[0]??o?.created?.[0]??null;if(e!==this._operation||s!==this.sessionId)return;this._committed=!0,this._saving=!1;try{this.onCreated&&await this.onCreated(n)}catch{if(e!==this._operation||s!==this.sessionId)return;this._sync=this.t("shell.refresh_error")}e===this._operation&&s===this.sessionId&&this.dispatchEvent(new CustomEvent("asset-created",{detail:n,bubbles:!0,composed:!0}))}catch(r){if(e!==this._operation||s!==this.sessionId)return;let o=v(r,this.t("add.create_error"));this._error=o.code==="conflict"?this.t("add.create_error"):o.message}finally{e===this._operation&&s===this.sessionId&&(this._saving=!1)}}render(){let t=us(this.t,this.presets,this._search);return a`<div class="page">
    ...
    `]);_("bindhome-add-view",ot);var nt=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.floors=[],this.query=""}render(){let e=is(this.t,this.assets,this.areas,this.floors,this.query).map(s=>s.asset?s:{asset:s,area:this.areas.find(r=>r.area_id===s.area_id),type:k(this.t,s.asset_type)});return a`<div class="page">
    ...
    </div>`}};h(nt,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},floors:{attribute:!1},query:{type:String}}),h(nt,"styles",[$,g`
      .search {
        position: relative;
        max-width: 720px;
        margin-top: 22px;
    ...
    `]);_("bindhome-search-view",nt);function xe(i,t){return(i?.name??"").localeCompare(t?.name??"",void 0,{sensitivity:"base",numeric:!0})}function ye(i){return[...i].sort(xe)}function $e(i,t,e){let s=new Map((i??[]).map(p=>[p.floor_id,p])),r=new Map((t??[]).map(p=>[p.area_id,p])),o=new Map;for(let p of e??[]){if(!p.area_id||!r.has(p.area_id))continue;let y=o.get(p.area_id)??[];y.push(p),o.set(p.area_id,y)}let n=(t??[]).map(p=>({area:p,assets:ye(o.get(p.area_id)??[])})).sort((p,y)=>xe(p.area,y.area)),d=(i??[]).map(p=>({floor:p,areas:n.filter(({area:y})=>y.floor_id===p.floor_id)})).sort((p,y)=>{let x=p.floor.level,w=y.floor.level;return typeof x=="number"&&typeof w=="number"&&x!==w?x-w:xe(p.floor,y.floor)}),l=n.filter(({area:p})=>!p.floor_id||!s.has(p.floor_id)),u=ye((e??[]).filter(p=>!p.area_id)),b=ye((e??[]).filter(p=>p.area_id&&!r.has(p.area_id)));return{floors:d,noFloorAreas:l,noAreaAssets:u,unknownAreaAssets:b}}function lt(i){return{asset_id:i.id,name:i.name,asset_type:i.asset_type,code:i.code??"",area_id:i.area_id??"",capabilities:[...i.capabilities??[]]}}function Es(i){return i==null?null:String(i).trim()||null}function di(i,t){return i.length!==t.length?!1:i.every((e,s)=>e===t[s])}function we(i,t){if(t.asset_id!==i.id)throw new Error("Asset edit draft identity does not match the persisted Asset");let e={name:t.name,asset_type:t.asset_type,code:Es(t.code),area_id:Es(t.area_id),capabilities:[...t.capabilities??[]]},s={asset_id:i.id};e.name!==i.name&&(s.name=e.name),e.asset_type!==i.asset_type&&(s.asset_type=e.asset_type),e.code!==(i.code??null)&&(s.code=e.code),e.area_id!==(i.area_id??null)&&(s.area_id=e.area_id);let r=[...i.capabilities??[]];return di(e.capabilities,r)||(s.capabilities=e.capabilities),s}function Ss(i,t){return Object.keys(we(i,t)).length>1}var dt="__bindhome_no_area_assets__",ct="__bindhome_unknown_area_assets__";function Rs(i,t,e){if(!i)return null;if(i===dt)return t.noAreaAssets.length?{kind:"no-area",title:e("browser.no_area"),description:e("browser.no_area_intro"),assets:t.noAreaAssets}:null;if(i===ct)return t.unknownAreaAssets.length?{kind:"unknown-area",title:e("browser.unknown_area"),description:e("browser.unknown_area_intro"),assets:t.unknownAreaAssets}:null;let r=[...t.floors.flatMap(o=>o.areas),...t.noFloorAreas].find(({area:o})=>o.area_id===i);return r?{kind:"area",title:r.area.name,description:"",area:r.area,assets:r.assets}:null}function Cs(i,t){return i.area_id?t.some(e=>e.area_id===i.area_id)?i.area_id:ct:dt}function Ps(i,t){return i.map(e=>e.id===t.id?t:e)}function ci(i,t,e="primary"){return`${i}:${t}:${e}`}function Ds(i){let t=i?.records??[];return new Map(t.map(e=>[ci(e.asset_id,e.capability,e.role),e]))}function ke(i,t=[]){return t.find(e=>e.area_id===i?.area_id)?.name??null}function hi(i,t=[]){return{asset:i,id:i.id,name:i.name,code:i.code??"",assetType:i.asset_type,areaId:i.area_id??null,areaName:ke(i,t)}}function Lt(i,t="",e=null,s=[]){let r=String(t).trim().toLocaleLowerCase(),o=i.map(d=>hi(d,s));return(r?o.filter(d=>[d.name,d.code,d.assetType,d.areaName??""].join(" ").toLocaleLowerCase().includes(r)):o).sort((d,l)=>+!!(e&&l.areaId===e)-+!!(e&&d.areaId===e)||d.name.localeCompare(l.name)||d.id.localeCompare(l.id))}var ht=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.onRefresh=null,this.onDone=null,this.onSyncWarning=null,this._direction="outgoing",this._type="",this._other="",this._search="",this._saving=!1,this._error=null,this._identity="",this._token=0}connectedCallback(){super.connectedCallback(),this._resetIdentity()}willUpdate(t){if(!t.has("asset"))return;let e=this.asset?.id??"";this._identity&&e!==this._identity&&this._resetIdentity(),this._identity=e}_resetIdentity(){this._token+=1,this._direction="outgoing",this._type="",this._other="",this._search="",this._error=null,this._saving=!1,this._identity=this.asset?.id??""}_isCurrent(t,e){return t===this._token&&this.asset?.id===e}_candidates(){let t=Lt(this.assets.filter(s=>s.id!==this.asset?.id),this._search,this.asset?.area_id,this.areas),e=this._search.trim()?20:8;return{all:t,shown:t.slice(0,e)}}async _save(){if(this._saving||!this._other||!me(this._type))return;let t=++this._token,e=this.asset?.id,s=this._direction==="outgoing"?e:this._other,r=this._direction==="outgoing"?this._other:e;this._saving=!0,this._error=null;try{if(await f(this.hass).createRelation({sourceAssetId:s,relationType:this._type.trim(),targetAssetId:r}),!this._isCurrent(t,e))return;this._saving=!1,this.onDone?.();try{await this.onRefresh?.()}catch{if(!this._isCurrent(t,e))return;this.onSyncWarning?.(this.t("topology.sync_warning"))}}catch(o){if(!this._isCurrent(t,e))return;let n=v(o,this.t("topology.save_error"));this._error=n.code==="conflict"?this.t("topology.duplicate_relation"):n.message,this._saving=!1}}_cancel(){this.onDone?.()}render(){let{all:t,shown:e}=this._candidates();return a`
      <form
        class="editor"
      ...
      >
        ...
        <label>
          ...
          <datalist id="relation-types">
            ${ls(this.registry?.relations).map(s=>a`
        ...
        <div class="actions">
          ...
          <button
            type="submit"
            ?disabled=${this._saving||!this._other||!me(this._type)}
          >
            ${this.t("editor.save")}
          </button>
        </div>
      </form>
    `}};h(ht,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onDone:{attribute:!1},onSyncWarning:{attribute:!1},_direction:{state:!0},_type:{state:!0},_other:{state:!0},_search:{state:!0},_saving:{state:!0},_error:{state:!0}}),h(ht,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-relation-editor",ht);var pt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.onRefresh=null,this.onNavigate=null,this._editing=!1,this._deleting=null,this._error=null,this._sync=null,this._confirm=null,this._identity="",this._token=0}willUpdate(t){t.has("asset")&&this.asset&&this._identity&&this.asset.id!==this._identity&&(this._token+=1,this._deleting=null,this._confirm=null,this._error=null,this._sync=null),this.asset&&(this._identity=this.asset.id)}_asset(t){return this.assets.find(e=>e.id===t)??null}_area(t){return t?.area_id?this.areas.find(e=>e.area_id===t.area_id)?.name??null:null}async _delete(t){if(this._deleting)return;let e=++this._token,s=this.asset?.id;this._deleting=t.id,this._error=null;try{if(await f(this.hass).deleteRelation(t.id),e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._confirm=null;try{await this.onRefresh?.()}catch{if(e!==this._token||this.asset?.id!==s)return;this._sync=this.t("topology.sync_warning")}}catch(r){if(e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._error=v(r,this.t("topology.delete_error")).message}}_navigate(t){this._asset(t)&&(this.onNavigate?.(t),this.dispatchEvent(new CustomEvent("navigate-asset",{detail:t,bubbles:!0,composed:!0})))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
    ...
    `}};h(pt,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onNavigate:{attribute:!1},_editing:{state:!0},_deleting:{state:!0},_error:{state:!0},_sync:{state:!0},_confirm:{state:!0}}),h(pt,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-asset-topology",pt);var ut=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null}_bindings(){return this.asset?(this.registry?.bindings??[]).filter(t=>t.asset_id===this.asset.id):[]}_primaryStatus(t){if(!this.asset)return null;let e=Ds(this.bindingStatuses).get(`${this.asset.id}:${t}:primary`);if(e)return e;let s=this._bindings().find(r=>r.capability===t&&r.role==="primary");return s?{asset_id:this.asset.id,capability:t,role:"primary",status:"resolved",config_valid:!0,runtime_available:!0,entity_id:s.entity_id,binding:s}:null}_representation(){return this.asset?(this.registry?.representations??[]).find(t=>t.asset_id===this.asset.id):null}_forwardTopologyWarning(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("topology-sync-warning",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return c;let t=this._representation();return a`
    ...
    `}};h(ut,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1}}),h(ut,"styles",g`
    :host { display: block; }
  ...
  `);_("bindhome-asset-connections",ut);function Ot(i){return{...i,capabilities:[...i.capabilities??[]]}}var mt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.floors=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this._editing=!1,this._draft=null,this._snapshot=null,this._saving=!1,this._error=null,this._saved=!1,this._newCapability=""}willUpdate(t){t.has("asset")&&this.asset&&!this._editing&&(this._snapshot=Ot(this.asset),this._draft=lt(this.asset))}get _dirty(){return!this._editing||!this._snapshot||!this._draft?!1:Ss(this._snapshot,this._draft)}_emitEditing(t){this.dispatchEvent(new CustomEvent("editing-changed",{detail:t,bubbles:!0,composed:!0}))}_startEdit(){this._snapshot=Ot(this.asset),this._draft=lt(this.asset),this._editing=!0,this._error=null,this._saved=!1,this._newCapability="",this._emitEditing(!0)}_cancel(){this._draft=lt(this.asset),this._snapshot=Ot(this.asset),this._editing=!1,this._error=null,this._newCapability="",this._emitEditing(!1)}_close(){this._editing||this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_updateField(t,e){!this._draft||this._saving||(this._draft={...this._draft,[t]:e},this._error=null,this._saved=!1)}_removeCapability(t){this._updateField("capabilities",this._draft.capabilities.filter(e=>e!==t))}_addCapability(){let t=this._newCapability.trim();if(!t||this._draft.capabilities.includes(t)){this._newCapability="";return}this._updateField("capabilities",[...this._draft.capabilities,t]),this._newCapability=""}async _save(t=null){if(t?.preventDefault(),this._saving||!this._snapshot||!this._draft)return;let e=we(this._snapshot,this._draft);if(Object.keys(e).length===1){this._editing=!1,this._emitEditing(!1);return}let{asset_id:s,...r}=e;this._saving=!0,this._error=null,this._saved=!1;try{let n=await f(this.hass).updateAsset(s,r);this.asset=n,this._snapshot=Ot(n),this._draft=lt(n),this._editing=!1,this._saved=!0,this._emitEditing(!1),this.dispatchEvent(new CustomEvent("asset-updated",{detail:n,bubbles:!0,composed:!0}))}catch(o){let n=v(o,this.t("editor.save_error"));this._error=n.message??this.t("editor.save_error")}finally{this._saving=!1}}_areaName(t){return t?this.areas.find(e=>e.area_id===t)?.name??this.t("infrastructure.unknown_area"):this.t("browser.no_area")}_renderAreaOptions(){let t=new Set(this.floors.map(o=>o.floor_id)),e=new Set(this.areas.map(o=>o.area_id)),s=this._draft?.area_id&&!e.has(this._draft.area_id)?this._draft.area_id:null,r=this.areas.filter(o=>!o.floor_id||!t.has(o.floor_id));return a`
      <option
        value=""
  ...
  `);_("bindhome-asset-detail-editor",mt);var gt=class extends m{constructor(){super(),this.hass=null,this.floors=[],this.areas=[],this.assets=[],this.presets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this.t=t=>t,this._selectedKey="",this._selectedAssetId=null,this._editorLocked=!1}get _hierarchy(){return $e(this.floors,this.areas,this.assets)}_countAssets(t){return this.t(Dt("counts.asset",t),{count:t})}_targetForKey(t,e=this._hierarchy){return Rs(t,e,this.t)}willUpdate(t){if(t.has("selectedAssetId")&&this.selectedAssetId){let e=this.assets.find(s=>s.id===this.selectedAssetId);e&&(this._selectedKey=this._locationKeyForAsset(e),this._selectedAssetId=e.id)}if(this._selectedKey&&(t.has("floors")||t.has("areas")||t.has("assets"))){let e=$e(this.floors,this.areas,this.assets);this._targetForKey(this._selectedKey,e)||(this._selectedKey=""),this._selectedAssetId&&!this.assets.some(s=>s.id===this._selectedAssetId)&&(this._selectedAssetId=null,this._editorLocked=!1)}}_select(t){this._editorLocked||(this._selectedAssetId=null,this._selectedKey=t)}_openAsset(t){this._selectedAssetId=t}_closeAsset(){this._editorLocked||(this._selectedAssetId=null)}_locationKeyForAsset(t){return Cs(t,this.areas)}_handleEditingChanged(t){this._editorLocked=!!t.detail}_handleAssetUpdated(t){t.stopPropagation();let e=t.detail,s=Ps(this.assets,e);this.assets=s,this._selectedKey=this._locationKeyForAsset(e),this._selectedAssetId=e.id,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:s,bubbles:!0,composed:!0}))}_assetTypeLabel(t){let e=this.presets.find(s=>s.asset_type===t.asset_type);return e?E(this.t,e):t.asset_type}_renderAreaButton(t){let e=this._selectedKey===t.area.area_id;return a`
      <button
    ...
    `:c}_renderSpecials(t){if(!t.noAreaAssets.length&&!t.unknownAreaAssets.length)return c;let e=this._selectedKey===dt,s=this._selectedKey===ct;return a`
      <div class="specials">
    ...
    `}};h(gt,"properties",{hass:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},presets:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},selectedAssetId:{attribute:!1},t:{attribute:!1},_selectedKey:{state:!0},_selectedAssetId:{state:!0},_editorLocked:{state:!0}}),h(gt,"styles",g`
    :host {
      display: block;
      min-height: 100%;
      color: var(--primary-text-color);
  ...
  `);_("bindhome-inventory-browser",gt);var _t=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.registry={},this.focalAssetId=null,this.onNavigate=null,this._search=""}_asset(t){return this.assets.find(e=>e.id===t)??null}_focal(){return this._asset(this.focalAssetId)??this.assets[0]??null}_neighbors(){let t=this._focal();return t?M(this.registry?.relations??[],t.id):{incoming:[],outgoing:[]}}_focus(t){let e=this._asset(t);e&&(this.focalAssetId=e.id,this._search="",this.onNavigate?.(e.id))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
    ...
    `}render(){let t=this._focal(),e=Lt(this.assets,this._search,t?.area_id,this.areas),s=this._search.trim()?20:8,r=e.slice(0,s),{incoming:o,outgoing:n}=this._neighbors();return a`
    ...
    `}};h(_t,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},focalAssetId:{attribute:!1},onNavigate:{attribute:!1},_search:{state:!0}}),h(_t,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-topology-explorer",_t);var ft=class extends m{constructor(){super(),this.hass=null,this.registry={},this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._active="browse"}_show(t){this._active=t}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._active="browse")}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_showBrowseFromWorkflow(t){t.stopPropagation(),this._active="browse"}render(){return a`
      <nav
        class="subnav"
    ...
    `}};h(ft,"properties",{hass:{attribute:!1},registry:{attribute:!1},t:{attribute:!1},presets:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},selectedAssetId:{attribute:!1},_active:{state:!0}}),h(ft,"styles",g`
    :host {
      display: block;
      min-height: 100%;
    }
  ...
  `);_("bindhome-infrastructure-inspector",bt);function pi(i){let t=[],e=[],s="",r=!1;for(let o=0;o<i.length;o+=1){let n=i[o];if(r){n==='"'?i[o+1]==='"'?(s+='"',o+=1):r=!1:s+=n;continue}if(n==='"'&&s.length===0){r=!0;continue}if(n===","){e.push(s),s="";continue}if(n===`
`){e.push(s),t.push(e),e=[],s="";continue}if(n==="\r"){i[o+1]===`
`&&(o+=1),e.push(s),t.push(e),e=[],s="";continue}s+=n}if(r)throw new Error("CSV contains an unterminated quoted field");return(s.length||e.length)&&(e.push(s),t.push(e)),t}function ui(i){let t=String(i??"");return/[",\r\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function mi(i){return`${i.map(t=>t.map(ui).join(",")).join(`
`)}
`}function zs(i,t){if(t.scope==="all")return i;let e=pi(i);if(!e.length)return i;let s=e[0],r=s.indexOf("area_id");if(r<0)throw new Error("BindHome CSV is missing area_id");let o=new Set;if(t.scope==="area"&&t.areaId)o.add(t.areaId);else if(t.scope==="floor"&&t.floorId)for(let n of t.areas??[])n.floor_id===t.floorId&&o.add(n.area_id);return mi([s,...e.slice(1).filter(n=>o.has(n[r]??""))])}function Ns(i,t=null){let e=t?t.replace(/[^a-zA-Z0-9_-]+/g,"-"):null;return i==="floor"&&e?`bindhome-inventory-floor-${e}.csv`:i==="area"&&e?`bindhome-inventory-area-${e}.csv`:"bindhome-inventory.csv"}function Mt(i,t,e="text/plain;charset=utf-8"){let s=new Blob([t],{type:e}),r=URL.createObjectURL(s),o=document.createElement("a");o.href=r,o.download=i,o.style.display="none",document.body.append(o),o.click(),o.remove(),queueMicrotask(()=>URL.revokeObjectURL(r))}var vt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.floors=[],this.areas=[],this._scope="all",this._floorId="",this._areaId="",this._fileName="",this._csvText="",this._validation=null,this._busy=!1,this._error=null,this._success=null}_api(){return f(this.hass)}_selectedScopeId(){return this._scope==="floor"?this._floorId:this._scope==="area"?this._areaId:null}_scopeReady(){return this._scope==="all"||(this._scope==="floor"?!!this._floorId:!!this._areaId)}async _export(){if(!(!this.hass||!this._scopeReady())){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().exportInventoryCsv(),e=this._selectedScopeId(),s=zs(t.csv,{scope:this._scope,floorId:this._floorId||null,areaId:this._areaId||null,areas:this.areas});Mt(Ns(this._scope,e),s,"text/csv;charset=utf-8"),this._success=this.t("csv.export_success")}catch(t){this._error=v(t,this.t("csv.export_error")).message}finally{this._busy=!1}}}async _fileSelected(t){let e=t.currentTarget.files?.[0];e&&(this._fileName=e.name,this._csvText=await e.text(),await this._validate())}async _validate(){if(!(!this.hass||!this._csvText)){this._busy=!0,this._error=null,this._success=null,this._validation=null;try{this._validation=await this._api().validateInventoryCsv(this._csvText)}catch(t){this._error=v(t,this.t("csv.validate_error")).message}finally{this._busy=!1}}}async _commit(){if(!(!this.hass||!this._validation?.valid||!Number.isInteger(this._validation.revision))){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().importInventoryCsv({csv:this._csvText,revision:this._validation.revision}),e=await this._api().listAssets();this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:e,bubbles:!0,composed:!0})),this._validation={...t,revision:t.revision},this._success=this.t("csv.import_success",{created:t.preview?.created??0,updated:t.preview?.updated??0})}catch(t){let e=v(t,this.t("csv.import_error"));this._error=e.code==="conflict"?this.t("csv.conflict"):e.message}finally{this._busy=!1}}}_renderValidation(){let t=this._validation;if(!t)return a`<p class="muted">${this.t("csv.import_hint")}</p>`;if(!t.valid){let s=t.errors??[];return a`<div class="status error" role="alert">${this.t("csv.invalid",{count:s.length})}</div>
      ...
      <div class="split">
        ...
        <section class="pane">
          ...
          ${this._fileName?a`<p class="muted">${this._fileName}</p>`:c}
          ${this._renderValidation()}
        </section>
      </div>
      ${this._error?a`<div class="status error" role="alert">${this._error}</div>`:c}
      ${this._success?a`<div class="status success" role="status">${this._success}</div>`:c}
    ...
    `]);_("bindhome-csv-inventory-tool",vt);function gi(i){let t=i?.registry;return!t||typeof t!="object"?null:{assets:Array.isArray(t.assets)?t.assets.length:0,relations:Array.isArray(t.relations)?t.relations.length:0,bindings:Array.isArray(t.bindings)?t.bindings.length:0,representations:Array.isArray(t.representations)?t.representations.length:0}}var yt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.revision=null,this._lastBackup=null,this._recovery=null,this._restoreFileName="",this._restoreBackup=null,this._restoreSummary=null,this._confirmed=!1,this._busy=!1,this._error=null,this._success=null,this._loadedIdentity=null}updated(t){if(!t.has("hass")||!this.hass)return;let e=this.hass?.user?.id??"browser";e!==this._loadedIdentity&&(this._loadedIdentity=e,this._loadStatus())}_api(){return f(this.hass)}async _loadStatus(){let t=this._loadedIdentity,[e,s]=await Promise.all([Pt(this.hass,re),this._api().getBackupRecoveryStatus().catch(()=>null)]);t===this._loadedIdentity&&(this._lastBackup=e.available&&typeof e.value=="string"?e.value:null,this._recovery=s)}async _exportBackup(){if(this.hass){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().exportRegistryBackup(),e=`${JSON.stringify(t.backup,null,2)}
`,s=new Date,r=s.toISOString().slice(0,10);Mt(`bindhome-registry-backup-${r}.json`,e,"application/json;charset=utf-8"),this._lastBackup=s.toISOString(),await R(this.hass,re,this._lastBackup),this._success=this.t("backup.export_success")}catch(t){this._error=v(t,this.t("backup.export_error")).message}finally{this._busy=!1}}}async _restoreFileSelected(t){let e=t.currentTarget.files?.[0];if(e){this._error=null,this._success=null,this._confirmed=!1,this._restoreFileName=e.name;try{let s=JSON.parse(await e.text());if(s?.format!=="bindhome.registry"||!s.registry)throw new Error(this.t("backup.invalid_envelope"));let r=gi(s);if(!r)throw new Error(this.t("backup.invalid_envelope"));this._restoreBackup=s,this._restoreSummary=r}catch(s){this._restoreBackup=null,this._restoreSummary=null,this._error=s instanceof Error?s.message:this.t("backup.invalid_file")}}}async _restore(){if(!(!this.hass||!this._restoreBackup||!this._confirmed)){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().restoreRegistryBackup({backup:this._restoreBackup,revision:this._recovery?.recovery_required?null:this.revision});this._confirmed=!1,this._success=t.reloaded===!1?this.t("backup.restore_saved_reload_failed"):this.t("backup.restore_success"),t.registry?.assets&&this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.registry.assets,bubbles:!0,composed:!0})),await this._loadStatus()}catch(t){let e=v(t,this.t("backup.restore_error"));this._error=e.code==="conflict"?this.t("backup.conflict"):e.message}finally{this._busy=!1}}}_renderSummary(){let t=this._restoreSummary;return t?a`<div class="summary">
    ...
    </div>`:c}render(){return a`<section class="tool">
      <h2>${this.t("backup.title")}</h2>
      <p class="muted">${this.t("backup.intro")}</p>
      ${this._recovery?.recovery_required?a`<div class="status warning" role="alert">${this.t("backup.recovery_required")}</div>`:c}
      <div class="grid">
        <section class="pane">
        ...
        <section class="pane">
          ...
          ${this._restoreFileName?a`<p class="muted">${this._restoreFileName}</p>`:c}
          ${this._renderSummary()}
      ...
      ${this._error?a`<div class="status error" role="alert">${this._error}</div>`:c}
      ${this._success?a`<div class="status success" role="status">${this._success}</div>`:c}
    </section>`}};h(yt,"properties",{hass:{attribute:!1},t:{attribute:!1},revision:{attribute:!1},_lastBackup:{state:!0},_recovery:{state:!0},_restoreFileName:{state:!0},_restoreBackup:{state:!0},_restoreSummary:{state:!0},_confirmed:{state:!0},_busy:{state:!0},_error:{state:!0},_success:{state:!0}}),h(yt,"styles",[$,g`
      :host { display: block; }
    ...
    `]);_("bindhome-backup-restore-tool",yt);var _i=new Set(["entity_not_found"]),fi="binding_not_found",bi="already_bound";function vi(i){let t={};for(let e of i??[]){let s=e?.status??"unknown";t[s]=(t[s]??0)+1}return t}var xt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.areas=[],this.assets=[],this.bindingStatuses={records:[],summary:{}},this._recovery=null,this._drift=[],this._loading=!1,this._error=null}connectedCallback(){super.connectedCallback(),this.hass&&this._refreshSupplementalHealth()}updated(t){t.has("hass")&&this.hass&&t.get("hass")!==this.hass&&this._refreshSupplementalHealth()}_assetName(t){return this.assets.find(e=>e.id===t)?.name??t}_areaName(t){return t?this.areas.find(e=>e.area_id===t)?.name??t:this.t("health.no_area")}_staleAreas(){let t=new Set(this.areas.map(e=>e.area_id));return this.assets.filter(e=>e.area_id&&!t.has(e.area_id))}_bindingRecords(t){return(this.bindingStatuses?.records??[]).filter(e=>e.status===t)}_actionableBindings(){return(this.bindingStatuses?.records??[]).filter(t=>_i.has(t.status))}_dispatch(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_openAsset(t){this._dispatch("health-open-asset",t)}_reviewImport(t){this._dispatch("health-review-import",t||null)}_openRecovery(){this._dispatch("health-open-recovery",null)}async _refreshSupplementalHealth(){if(!(!this.hass||this._loading)){this._loading=!0,this._error=null;try{let t=f(this.hass),[e,s]=await Promise.all([t.getBackupRecoveryStatus(),t.discoverImport()]);this._recovery=e;let r=new Map;for(let o of s?.proposals??[]){if(o?.duplicate_status===bi)continue;let n=o?.asset?.area_id??null,d=Math.max(1,o?.source?.entity_ids?.length??o?.bindings?.length??1);r.set(n,(r.get(n)??0)+d)}this._drift=[...r.entries()].map(([o,n])=>({areaId:o,count:n})).sort((o,n)=>this._areaName(o.areaId).localeCompare(this._areaName(n.areaId)))}catch(t){this._error=t instanceof Error?t.message:String(t)}finally{this._loading=!1}}}_renderBindingItems(t,e,s){return a`<div class="section">
      <h3>${this.t(e)}</h3>
    ...
    </div>`}render(){let t=this.bindingStatuses?.summary??{},e=this.bindingStatuses?.records??[],s=t.by_status??vi(e),r=this._actionableBindings(),o=this._bindingRecords(fi),n=this._staleAreas(),d=r.length+o.length+n.length+(this._recovery?.recovery_required?1:0)+this._drift.reduce((l,u)=>l+u.count,0);return a`<section class="card" aria-busy=${this._loading?"true":"false"}>
      <div class="head">
        <div>
      ...
      <p class=${d?"warning":"ok"}>${this.t(d?"health.actionable_count":"health.all_clear",{count:d})}</p>
      ...
      ${this._error?a`<p class="error" role="alert">${this.t("health.load_error",{error:this._error})}</p>`:c}
    </section>`}};h(xt,"properties",{hass:{attribute:!1},t:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},bindingStatuses:{attribute:!1},_recovery:{state:!0},_drift:{state:!0},_loading:{state:!0},_error:{state:!0}}),h(xt,"styles",[$,g`
    ...
    `]);_("bindhome-health-tool",xt);var $t=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._tab="inventory"}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._tab="inventory")}render(){return a`<div class="content-head">
    ...
    </div>`}};h(wt,"properties",{t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},_step:{state:!0}}),h(wt,"styles",g`
    :host { display: block; }
    * { box-sizing: border-box; }
