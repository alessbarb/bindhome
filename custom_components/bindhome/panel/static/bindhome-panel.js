...
`;var ei={feeds:{outgoing:"relations.feeds.outgoing",incoming:"relations.feeds.incoming"},contains:{outgoing:"relations.contains.outgoing",incoming:"relations.contains.incoming"},controls:{outgoing:"relations.controls.outgoing",incoming:"relations.controls.incoming"},part_of:{outgoing:"relations.part_of.outgoing",incoming:"relations.part_of.incoming"}};function ns(i,t,e){let s=ei[t]?.[e];return{type:t,direction:e,label:s?i(s):i("relations.unknown",{type:de(t)}),known:!!s,icon:t==="feeds"?"mdi:flash-outline":t==="controls"?"mdi:tune":t==="contains"||t==="part_of"?"mdi:folder-outline":"mdi:vector-link"}}function ls(i){return{socket:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.indicate_feeds"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}],circuit:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.panel_source"}],electrical_panel:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],junction_box:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],manifold:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],shutoff_valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],light_point:[{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}]}[i]??[]}function U(i=[],t){return{outgoing:i.filter(e=>e.source_asset_id===t),incoming:i.filter(e=>e.target_asset_id===t)}}function ds(i=[]){return[...new Set(i.map(t=>t.relation_type).filter(Boolean))].sort()}function _e(i){return/^[a-z][a-z0-9_]*$/.test(String(i).trim())}function ge(i){return[i?.message,i?.body?.message,i?.data?.message,i?.error].filter(t=>typeof t=="string")}function v(i,t=null){let e=ge(i).find(s=>s.trim())??t;return{code:i?.code??i?.body?.code??i?.data?.code??null,message:e}}function cs(i,t=null){for(let s of ge(i))try{let r=JSON.parse(s);if(Number.isInteger(r?.index)&&r.index>=0&&typeof r?.field=="string"&&typeof r?.message=="string")return{structured:!0,index:r.index,field:r.field,message:r.message}}catch{}return{structured:!1,index:null,field:null,message:ge(i).find(s=>s.trim())??t}}function si(i){return String(i??"").trim()}function F(i){return si(i).toLocaleLowerCase()}function ps(i,t){return F(i.name).localeCompare(F(t.name),void 0,{numeric:!0,sensitivity:"base"})||i.entityId.localeCompare(t.entityId)}function hs(i,t,e){let s=F(t);if(!s)return e&&i.areaId===e?0:1;let r=[i.name,i.entityId,i.areaName,i.deviceName,i.domain].map(F),o=r.some(c=>c===s),n=r.some(c=>c.startsWith(s)),d=e&&i.areaId===e?0:1;return(o?0:n?1:2)*2+d}function fe({entityRegistry:i=[],deviceRegistry:t=[],states:e={},areas:s=[]}={}){let r=new Map(i.filter(c=>c?.entity_id).map(c=>[c.entity_id,c])),o=new Map(t.filter(c=>c?.id).map(c=>[c.id,c])),n=new Map(s.filter(c=>c?.area_id).map(c=>[c.area_id,c.name]));return[...new Set([...r.keys(),...Object.keys(e??{})])].map(c=>{let u=r.get(c)??null,f=e?.[c]??null,p=u?.device_id?o.get(u.device_id):null,[y]=c.split("."),$=u?.area_id??p?.area_id??null,w=f?.attributes?.friendly_name??u?.name??u?.original_name??c;return{entityId:c,domain:y,name:w,state:f?.state??null,registryEntry:u,deviceId:u?.device_id??null,deviceName:p?.name_by_user??p?.name??null,areaId:$,areaName:$?n.get($)??null:null,disabled:!!u?.disabled_by,hidden:!!u?.hidden_by,isBindHome:u?.platform==="bindhome"}}).sort(ps)}function us(i,t="",e=null){let s=F(t);return[...i??[]].filter(r=>s?[r.name,r.entityId,r.areaName,r.deviceName,r.domain].some(o=>F(o).includes(s)):!0).sort((r,o)=>hs(r,s,e)-hs(o,s,e)||ps(r,o))}var ii=8,ri=20;function ai(i,t){let e=`capabilities.${t}`,s=i(e);return s!==e?s:t.replaceAll("_"," ").replace(/\b\w/g,r=>r.toUpperCase())}var J=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.capability="",this.status=null,this.areas=[],this.entityRegistry=[],this.deviceRegistry=[],this.showEntityId=!0,this.refreshBindingData=null,this._editing=!1,this._search="",this._selectedEntityId=null,this._saving=!1,this._error=null,this._confirmDisconnect=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._bindingIdentity=null,this._operation=0,this._committedDisconnectId=null}_replacementMode(){return!!(this.status?.binding&&this.status?.status!=="binding_not_found")}_replacementCandidates(){if(!this._replacementPlan)return null;let t=new Map((this.areas??[]).map(s=>[s.area_id,s.name])),e=new Map((this.deviceRegistry??[]).map(s=>[s.id,s.name_by_user||s.name]));return(this._replacementPlan.candidates??[]).map(s=>({entityId:s.entity_id,entityRegistryId:s.entity_registry_id,name:s.name,domain:s.domain,areaId:s.area_id,areaName:t.get(s.area_id)??null,deviceId:s.device_id,deviceName:e.get(s.device_id)??null,state:s.state,disabled:!1,hidden:!1,reasons:s.reasons??[]}))}_candidates(){let t=this._replacementCandidates();return t||fe({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas})}willUpdate(){let t=this.asset?JSON.stringify([this.asset.id,this.capability,"primary"]):null;this._bindingIdentity!==null&&t!==this._bindingIdentity&&(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._saving=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._committedDisconnectId=null,this._operation+=1),this._bindingIdentity=t}_currentEntityId(){return this.status?.entity_id??this.status?.binding?.entity_id??null}_currentCandidate(){let t=this._currentEntityId();return fe({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas}).find(e=>e.entityId===t)??null}_runtimeLabel(t){return t?t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state===null?this.t("connection.no_runtime"):this.t("connection.available"):this.t("connection.stale")}_configurationLabel(){return this.status?.status==="entity_not_found"||this.status?.config_valid!==!1?this.t("connection.configured"):this.t("connection.invalid_configuration")}_candidateStateLabel(t){return!t||t.state===null?this.t("connection.no_runtime"):t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state}_displayName(t,e){return t?.name&&(this.showEntityId||t.name!==e)?t.name:t?.deviceName??(this.showEntityId?e:this.t("connection.configured"))}_candidateMeta(t){return[this.showEntityId?t?.entityId:null,t?.areaName,t?.deviceName,t?this._candidateStateLabel(t):null].filter(Boolean).join(" \xB7 ")}async _beginEdit(){if(this._saving||this._replacementLoading||(this._editing=!0,this._selectedEntityId=this._replacementMode()?null:this._currentEntityId(),this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._selectionMode="search",!this._replacementMode()))return;let t=++this._operation;this._replacementLoading=!0;try{let e=await b(this.hass).getReplacementCandidates({assetId:this.asset.id,capability:this.capability,role:"primary"});if(t!==this._operation)return;this._replacementPlan=e}catch(e){if(t!==this._operation)return;this._error=v(e,this.t("connection.replacement_load_error")).message}finally{t===this._operation&&(this._replacementLoading=!1)}}_cancelEdit(){this._saving||(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementPlan=null,this._replacementLoading=!1,this._selectionMode="search")}_select(t){this._saving||(this._selectedEntityId=t,this._error=null,this._confirmReplacement=!1,this._selectionMode="selected")}_changeSelection(){this._saving||(this._selectionMode="search",this._confirmReplacement=!1)}async _save(){if(this._saving||!this._selectedEntityId||!this.asset)return;if(this._replacementMode()&&!this._confirmReplacement){this._confirmReplacement=!0;return}this._saving=!0,this._error=null;let t=++this._operation,e=this._selectedEntityId;try{let s;if(this._replacementMode()){if(!this._replacementPlan||!Number.isInteger(this._replacementPlan.revision))throw new Error(this.t("connection.replacement_load_error"));s=await b(this.hass).commitReplacement({assetId:this.asset.id,capability:this.capability,entityId:e,revision:this._replacementPlan.revision,role:"primary"})}else s=await b(this.hass).setBinding({assetId:this.asset.id,capability:this.capability,entityId:e,role:"primary"});if(t!==this._operation)return;this._replacementSuccess=this._replacementMode()?s?.resolution?.entity_id??e:null,this._editing=!1,this._selectedEntityId=null,this._search="",this._confirmReplacement=!1,this._replacementPlan=null;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(t!==this._operation)return;let r=v(s,this.t("connection.save_error"));this._error=r.code==="binding_cycle"?this.t("connection.cycle_error"):r.message}finally{this._saving=!1}}async _disconnect(){let t=this.status?.binding;if(this._saving||!t||this._committedDisconnectId===t.id)return;this._saving=!0,this._error=null,this._editing=!1;let e=++this._operation;try{if(await b(this.hass).deleteBinding(t.id),e!==this._operation)return;this._committedDisconnectId=t.id,this._confirmDisconnect=!1;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(e!==this._operation)return;this._error=v(s,this.t("connection.disconnect_error")).message,this._confirmDisconnect=!0}finally{this._saving=!1}}_renderSummary(){let t=this.status?.binding,e=this._currentEntityId(),s=this._currentCandidate();return!t||this.status?.status==="binding_not_found"?a`<div class="summary">${this.t("connection.not_connected")}</div><div class="actions"><button class="primary" @click=${this._beginEdit}>${this.t("connection.connect")}</button></div>`:a`
  ...
  `);g("bindhome-primary-connection-editor",J);var X=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.action=null,this.onRefresh=null,this._target="",this._query="",this._saving=!1,this._error=null,this._token=0,this._identity="",this._committed=!1}connectedCallback(){super.connectedCallback(),this._resetIdentity()}willUpdate(){let t=this._currentIdentity();this._identity&&t!==this._identity&&this._resetIdentity(),this._identity=t}_currentIdentity(){return`${this.asset?.id??""}:${this.action?.direction??""}:${this.action?.relationType??""}`}_resetIdentity(){this._token+=1,this._target="",this._query="",this._saving=!1,this._error=null,this._committed=!1,this._identity=this._currentIdentity()}_isCurrent(t,e){return t===this._token&&e===this._currentIdentity()}async _save(){if(this._saving||this._committed||!this._target||!this.asset||!this.action)return;let t=++this._token,e=this._currentIdentity();this._saving=!0,this._error=null;let s=this.action.direction==="incoming";try{if(await b(this.hass).createRelation({sourceAssetId:s?this._target:this.asset.id,relationType:this.action.relationType,targetAssetId:s?this.asset.id:this._target}),!this._isCurrent(t,e))return;this._committed=!0,this._saving=!1;try{await this.onRefresh?.()}catch{if(!this._isCurrent(t,e))return;this.dispatchEvent(new CustomEvent("sync-warning",{detail:this.t("topology.sync_warning"),bubbles:!0,composed:!0}))}if(!this._isCurrent(t,e))return;this.dispatchEvent(new CustomEvent("done",{bubbles:!0,composed:!0}))}catch(r){if(!this._isCurrent(t,e))return;let o=v(r,this.t("topology.create_error"));this._error=o.code==="conflict"?this.t("topology.duplicate_relation"):o.message}finally{this._isCurrent(t,e)&&!this._committed&&(this._saving=!1)}}render(){let t=this._query.toLocaleLowerCase(),e=this.assets.filter(s=>s.id!==this.asset?.id&&(!t||[s.name,s.code,s.asset_type].filter(Boolean).some(r=>String(r).toLocaleLowerCase().includes(t)))).slice(0,20);return a`<label
      ...
      </div>`}};h(X,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},action:{attribute:!1},onRefresh:{attribute:!1},_target:{state:!0},_query:{state:!0},_saving:{state:!0},_error:{state:!0}}),h(X,"styles",[x,_`
      :host {
        display: block;
        margin-top: 12px;
        padding: 14px;
    ...
    </form>`}};h(Z,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},areas:{attribute:!1},refreshAssets:{attribute:!1},_name:{state:!0},_code:{state:!0},_areaId:{state:!0},_saving:{state:!0},_error:{state:!0}}),h(Z,"styles",[x,_`
    :host { display:block; }
    form { padding:20px; }
  ...
  `]);g("bindhome-human-asset-editor",Z);var tt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this._impact=null,this._loading=!1,this._deleting=!1,this._error=null,this._identity=null}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._impact=null,this._loading=!1,this._deleting=!1,this._error=null)}async _prepare(){if(!(!this.hass||!this.asset||this._loading||this._deleting)){this._loading=!0,this._error=null;try{this._impact=await b(this.hass).getDeleteImpact(this.asset.id)}catch(t){this._error=v(t,this.t("delete.error")).message}finally{this._loading=!1}}}async _delete(){if(!(!this.hass||!this.asset||!this._impact||this._deleting)){this._deleting=!0,this._error=null;try{await b(this.hass).deleteAssetWithDependencies(this.asset.id),await Promise.allSettled([this.refreshBindingData?.(),this.refreshTopologyData?.(),this.refreshAssets?.()]),this.dispatchEvent(new CustomEvent("asset-deleted",{detail:this.asset.id,bubbles:!0,composed:!0}))}catch(t){this._error=v(t,this.t("delete.error")).message,this._deleting=!1}}}render(){if(!this.asset)return l;let t=this._impact,e=t?.relations?.length??0,s=t?.owned_bindings?.length??0,r=t?.dependent_bindings?.length??0;return a`<div class="danger">
      ...
      ${this._error?a`<div class="error" role="alert">${this._error}</div>`:l}
    </div>`}};h(tt,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},_impact:{state:!0},_loading:{state:!0},_deleting:{state:!0},_error:{state:!0}}),h(tt,"styles",_`
    :host { display:block; }
  ...
  `);g("bindhome-asset-delete-control",tt);var et=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.registry={},this.bindingStatuses={records:[]},this.readOnly=!1,this.onRefresh=null,this._confirmation=null,this._busy=!1,this._error=null,this._notice=null,this._needsRefresh=!1,this._identity=null,this._generation=0}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._generation++,this._confirmation=null,this._busy=!1,this._error=null,this._notice=null,this._needsRefresh=!1),(this.readOnly||this.hass?.user?.is_admin===!1)&&(this._confirmation=null)}_representation(){return this.registry.representations?.find(t=>t.asset_id===this.asset?.id)}_binding(){return this.bindingStatuses.records.find(t=>t.asset_id===this.asset?.id&&t.capability==="on_off"&&t.role==="primary")}_reason(){return this._needsRefresh||!Number.isInteger(this.registry.revision)?"representation.refresh_required":this.asset?.capabilities?.includes("on_off")?this._binding()?.config_valid?null:"representation.missing_binding":"representation.missing_capability"}_canWrite(){return!this.readOnly&&this.hass&&this.hass.user?.is_admin!==!1}_prepare(){if(!this._canWrite()||this._busy||this._needsRefresh||!Number.isInteger(this.registry.revision))return;let t=!!this._representation();!t&&this._reason()||(this._error=null,this._notice=null,this._confirmation={assetId:this.asset.id,revision:this.registry.revision,remove:t})}async _commit(){let t=this._confirmation;if(!this._canWrite()||this._busy||!t||t.assetId!==this.asset?.id)return;this._busy=!0,this._error=null;let e=this._generation;try{let s=b(this.hass),r={assetId:t.assetId,revision:t.revision};if(t.remove?await s.deleteRepresentation(r):await s.setRepresentation(r),e!==this._generation)return;this._confirmation=null,this._needsRefresh=!0,this._notice=this.t(t.remove?"representation.removed":"representation.created");try{if(!this.onRefresh)throw new Error("Refresh unavailable");await this.onRefresh(),e===this._generation&&(this._needsRefresh=!1)}catch{e===this._generation&&(this._error=this.t("representation.saved_refresh_failed"))}}catch(s){if(e!==this._generation)return;this._confirmation=null;let r=v(s,this.t("representation.error"));this._error=r.code==="conflict"?this.t("representation.conflict"):r.message,this._needsRefresh=!0}finally{e===this._generation&&(this._busy=!1)}}async _refresh(){if(this._busy||!this.onRefresh)return;let t=this._generation;this._busy=!0,this._confirmation=null;try{await this.onRefresh(),t===this._generation&&(this._needsRefresh=!1,this._error=null)}catch(e){t===this._generation&&(this._error=v(e,this.t("representation.error")).message)}finally{t===this._generation&&(this._busy=!1)}}render(){if(!this.asset)return l;let t=this._representation(),e=this._binding(),s=this.registry.representation_entities?.[this.asset.id],r=s?this.hass?.states?.[s]:null,o=r&&!["unavailable","unknown"].includes(r.state),n=this._reason(),d=t?o?"active":"unavailable":n?"not_ready":"ready",c=!!(e?.entity_id&&!e.entity_id.startsWith("light."));return a`<h3>${this.t("representation.title")}</h3>
      <p>${this.t("representation.intro")}</p>
      <p class="muted">${this.t("representation.dependency")}</p>
      <p><strong>${this.t(`representation.${d}`)}</strong></p>
      ${t&&s?a`<p class="entity">${s}</p>`:l}
      ${t&&!s?a`<p class="muted">${this.t("representation.pending_entity")}</p>`:l}
      <p class=${c?"warning":"muted"}>${this.t(c?"representation.limited":"representation.mirrored")}</p>
  ...
  `]);g("bindhome-representation-control",et);var st=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.floors=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.advancedEnabled=!1,this.readOnly=!1,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this._action=null,this._sync=null,this._editingAsset=!1,this._identity=null}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._action=null,this._sync=null,this._editingAsset=!1)}_area(){return this.areas.find(t=>t.area_id===this.asset?.area_id)??null}_asset(t){return this.assets.find(e=>e.id===t)??null}_relations(){let t=U(this.registry?.relations??[],this.asset?.id);return[...t.incoming.map(e=>({relation:e,direction:"incoming",other:this._asset(e.source_asset_id)})),...t.outgoing.map(e=>({relation:e,direction:"outgoing",other:this._asset(e.target_asset_id)}))]}_devices(){let t=this.asset?.capabilities??[],e=(this.bindingStatuses?.records??[]).filter(o=>o.asset_id===this.asset?.id&&o.role==="primary"&&!!(o.binding||o.entity_id)).map(o=>({capability:o.capability,status:o})),s=e.length?e:t.length?[{capability:t[0],status:null}]:[],r=new Set;return s.filter(({capability:o,status:n})=>{let d=n?.binding?.entity_id??n?.entity_id,c=this.entityRegistry.find(f=>f.entity_id===d)?.device_id,u=c?`device:${c}`:d?`entity:${d}`:`capability:${o}`;return r.has(u)?!1:(r.add(u),!0)})}_forwardDeleted(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-deleted",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return l;if(this._editingAsset)return a`<bindhome-human-asset-editor
    ...
    ></bindhome-human-asset-editor>`;let t=k(this.t,this.asset.asset_type),e=this._area(),s=this._relations(),r=this._devices(),o=(this.registry.representations??[]).filter(d=>d.asset_id===this.asset.id),n=ls(this.asset.asset_type);return a`<button class="back text-button" @click=${()=>this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}>
      ...
      <article class="card surface">
        ...
        <section class="section">
          ...
          ${s.length?a`<div class="relations">${s.map(({relation:d,direction:c,other:u})=>{let f=ns(this.t,d.relation_type,c);return a`<div class="relation"><ha-icon icon=${f.icon}></ha-icon><div><small>${f.label}</small>${u?a`<button @click=${()=>this.dispatchEvent(new CustomEvent("navigate-asset",{detail:u.id,bubbles:!0,composed:!0}))}>${u.name}</button>`:a`<strong>${this.t("detail.missing_element")}</strong>`}</div></div>`})}</div>`:a`<p class="passive">${this.t("detail.no_connections")}</p>`}
          ${!this.readOnly&&n.length?a`<div class="actions">${n.map(d=>a`<button class="secondary" ?disabled=${!!this._action} @click=${()=>this._action=d}>${this.t(d.labelKey)}</button>`)}</div>`:l}
          ${!this.readOnly&&this._action?a`<bindhome-contextual-relation-editor .hass=${this.hass} .t=${this.t} .asset=${this.asset} .assets=${this.assets} .areas=${this.areas} .action=${this._action} .onRefresh=${this.refreshTopologyData} @cancel=${()=>this._action=null} @done=${()=>this._action=null} @sync-warning=${d=>this._sync=d.detail}></bindhome-contextual-relation-editor>`:l}
    ...
    </div>`}};h(it,"properties",{hass:{attribute:!1},t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},advancedEnabled:{type:Boolean,attribute:!1},readOnly:{type:Boolean,attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},selectedAssetId:{attribute:!1},selectedAreaId:{attribute:!1},_collapsedFloorIds:{state:!0}}),h(it,"styles",[x,_`
  ...
  `);g("bindhome-inventory-workflow",at);function ot(i){let t=i.entity_registry_id?`registry:${i.entity_registry_id}`:`entity:${i.entity_id}`;return`${i.capability}:${i.role??"primary"}:${t}`}function ys(i){return{revision:i.revision,scope:i.scope,reviews:(i.proposals??[]).map(t=>({proposal:t,action:null,asset:{name:t.asset.name,asset_type:t.asset.asset_type,area_id:t.asset.area_id??"",capabilities:[...t.asset.capabilities??[]]},targetAssetId:"",selectedBindings:new Set((t.bindings??[]).map(e=>ot(e)))}))}}function Lt(i,t,e){return{...i,reviews:i.reviews.map(s=>s.proposal.proposal_id===t?e(s):s)}}function xs(i,t,e){return Lt(i,t,s=>({...s,action:e,targetAssetId:e==="merge"?s.targetAssetId:""}))}function ve(i,t,e){return Lt(i,t,s=>({...s,asset:{...s.asset,...e}}))}function $s(i,t,e){return Lt(i,t,s=>({...s,targetAssetId:e}))}function ws(i,t,e){return Lt(i,t,s=>{let r=new Set(s.selectedBindings),o=ot(e);return r.has(o)?r.delete(o):r.add(o),{...s,selectedBindings:r}})}function ks(i,t,e){let s=[...new Set(e.split(",").map(r=>r.trim()).filter(Boolean))];return ve(i,t,{capabilities:s})}function li(i){return i.action?i.action==="skip"?!0:i.action==="merge"?!!i.targetAssetId:!!(i.asset.name.trim()&&i.asset.asset_type.trim()):!1}function ye(i){return!!i?.reviews?.length&&i.reviews.every(li)}function di(i){return(i.proposal.bindings??[]).filter(t=>i.selectedBindings.has(ot(t))).map(t=>({capability:t.capability,role:t.role??"primary",entity_id:t.entity_id,...t.entity_registry_id?{entity_registry_id:t.entity_registry_id}:{}}))}function As(i){return i.reviews.map(t=>{let e={proposal_id:t.proposal.proposal_id,action:t.action};if(t.action==="skip")return e;let s=di(t);return t.action==="merge"?{...e,target_asset_id:t.targetAssetId,bindings:s}:{...e,asset:{name:t.asset.name.trim(),asset_type:t.asset.asset_type.trim(),capabilities:[...t.asset.capabilities],...t.asset.area_id?{area_id:t.asset.area_id}:{}},bindings:s}})}function Is(i){return`import.status.${i??"new"}`}function Es(i,t){let e=new Set(t.merge_candidate_asset_ids??[]);return[...i].sort((s,r)=>{let o=e.has(s.id)?0:1,n=e.has(r.id)?0:1;return o!==n?o-n:String(s.name??s.id).localeCompare(String(r.name??r.id))})}var nt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.areas=[],this.assets=[],this.contextAreaId=null,this._scope="all",this._areaId="",this._reviewState=null,this._loading=!1,this._saving=!1,this._error=null,this._success=null,this._initializedContext=!1}willUpdate(t){!this._initializedContext&&t.has("contextAreaId")&&(this._initializedContext=!0,this.contextAreaId&&(this._scope="area",this._areaId=this.contextAreaId))}get _selectedAreaId(){return this._scope==="area"&&this._areaId||null}async _discover(){if(!(this._loading||this._scope==="area"&&!this._areaId)){this._loading=!0,this._error=null,this._success=null;try{let t=await b(this.hass).discoverImport(this._selectedAreaId);this._reviewState=ys(t)}catch(t){let e=v(t,this.t("import.discover_error"));this._error=e.message}finally{this._loading=!1}}}_setAction(t,e){this._reviewState=xs(this._reviewState,t,e),this._error=null}_updateAsset(t,e){this._reviewState=ve(this._reviewState,t,e),this._error=null}_toggleBinding(t,e){this._reviewState=ws(this._reviewState,t,e)}async _commit(){if(!(this._saving||!ye(this._reviewState))){this._saving=!0,this._error=null;try{let t=await b(this.hass).commitImport({areaId:this._reviewState.scope?.area_id??null,revision:this._reviewState.revision,decisions:As(this._reviewState)});this._success=t,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t,bubbles:!0,composed:!0}))}catch(t){let e=v(t,this.t("import.commit_error"));this._error=e.message}finally{this._saving=!1}}}_startOver(){this._reviewState=null,this._error=null,this._success=null}_areaFor(t){return this.areas.find(e=>e.area_id===t.asset.area_id)??null}render(){return this._success?this._renderSuccess():this._reviewState?this._renderReview():this._renderScope()}_renderScope(){return a`
    ...
    </section>`}};h(nt,"properties",{hass:{attribute:!1},t:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},contextAreaId:{attribute:!1},_scope:{state:!0},_areaId:{state:!0},_reviewState:{state:!0},_loading:{state:!0},_saving:{state:!0},_error:{state:!0},_success:{state:!0}}),h(nt,"styles",_`
  ...
  `);g("bindhome-assisted-import-workflow",nt);var lt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.contextAreaId=null,this.sessionId=0,this.onCreated=null,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId="",this._search="",this._saving=!1,this._error=null,this._sync=null,this._committed=!1,this._identity=null,this._operation=0}willUpdate(){this.sessionId!==this._identity&&(this._identity=this.sessionId,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId=this.contextAreaId??"",this._search="",this._operation+=1,this._saving=!1,this._error=null,this._sync=null,this._committed=!1)}_choose(t){this._preset=t,this._name=E(this.t,t),this._code="",this._error=null,this._sync=null,this._committed=!1}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_goHome(t){t?.stopPropagation?.(),this.dispatchEvent(new CustomEvent("go-home",{bubbles:!0,composed:!0}))}async _submit(t){if(t.preventDefault(),this._saving||this._committed||!this._preset||!this._name.trim())return;let e=++this._operation,s=this.sessionId;this._saving=!0,this._error=null,this._sync=null;try{let r={name:this._name.trim(),asset_type:this._preset.asset_type,capabilities:[...this._preset.suggested_capabilities??[]]};this._code.trim()&&(r.code=this._code.trim()),this._areaId&&(r.area_id=this._areaId);let o=await b(this.hass).createAssetsBulk([r]),n=o?.assets?.[0]??o?.created?.[0]??null;if(e!==this._operation||s!==this.sessionId)return;this._committed=!0,this._saving=!1;try{this.onCreated&&await this.onCreated(n)}catch{if(e!==this._operation||s!==this.sessionId)return;this._sync=this.t("shell.refresh_error")}e===this._operation&&s===this.sessionId&&this.dispatchEvent(new CustomEvent("asset-created",{detail:n,bubbles:!0,composed:!0}))}catch(r){if(e!==this._operation||s!==this.sessionId)return;let o=v(r,this.t("add.create_error"));this._error=o.code==="conflict"?this.t("add.create_error"):o.message}finally{e===this._operation&&s===this.sessionId&&(this._saving=!1)}}render(){let t=ms(this.t,this.presets,this._search);return a`<div class="page">
    ...
    `]);g("bindhome-add-view",lt);var dt=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.floors=[],this.query=""}render(){let e=rs(this.t,this.assets,this.areas,this.floors,this.query).map(s=>s.asset?s:{asset:s,area:this.areas.find(r=>r.area_id===s.area_id),type:k(this.t,s.asset_type)});return a`<div class="page">
    ...
    </div>`}};h(dt,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},floors:{attribute:!1},query:{type:String}}),h(dt,"styles",[x,_`
      .search {
        position: relative;
        max-width: 720px;
        margin-top: 22px;
    ...
    `}};h(ut,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onDone:{attribute:!1},onSyncWarning:{attribute:!1},_direction:{state:!0},_type:{state:!0},_other:{state:!0},_search:{state:!0},_saving:{state:!0},_error:{state:!0}}),h(ut,"styles",_`
    :host {
      display: block;
    }
  ...
  `);g("bindhome-relation-editor",ut);var mt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.onRefresh=null,this.onNavigate=null,this._editing=!1,this._deleting=null,this._error=null,this._sync=null,this._confirm=null,this._identity="",this._token=0}willUpdate(t){t.has("asset")&&this.asset&&this._identity&&this.asset.id!==this._identity&&(this._token+=1,this._deleting=null,this._confirm=null,this._error=null,this._sync=null),this.asset&&(this._identity=this.asset.id)}_asset(t){return this.assets.find(e=>e.id===t)??null}_area(t){return t?.area_id?this.areas.find(e=>e.area_id===t.area_id)?.name??null:null}async _delete(t){if(this._deleting)return;let e=++this._token,s=this.asset?.id;this._deleting=t.id,this._error=null;try{if(await b(this.hass).deleteRelation(t.id),e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._confirm=null;try{await this.onRefresh?.()}catch{if(e!==this._token||this.asset?.id!==s)return;this._sync=this.t("topology.sync_warning")}}catch(r){if(e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._error=v(r,this.t("topology.delete_error")).message}}_navigate(t){this._asset(t)&&(this.onNavigate?.(t),this.dispatchEvent(new CustomEvent("navigate-asset",{detail:t,bubbles:!0,composed:!0})))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
    ...
    `}};h(mt,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onNavigate:{attribute:!1},_editing:{state:!0},_deleting:{state:!0},_error:{state:!0},_sync:{state:!0},_confirm:{state:!0}}),h(mt,"styles",_`
    :host {
      display: block;
    }
  ...
  `);g("bindhome-asset-topology",mt);var _t=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null}_bindings(){return this.asset?(this.registry?.bindings??[]).filter(t=>t.asset_id===this.asset.id):[]}_primaryStatus(t){if(!this.asset)return null;let e=zs(this.bindingStatuses).get(`${this.asset.id}:${t}:primary`);if(e)return e;let s=this._bindings().find(r=>r.capability===t&&r.role==="primary");return s?{asset_id:this.asset.id,capability:t,role:"primary",status:"resolved",config_valid:!0,runtime_available:!0,entity_id:s.entity_id,binding:s}:null}_representation(){return this.asset?(this.registry?.representations??[]).find(t=>t.asset_id===this.asset.id):null}_forwardTopologyWarning(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("topology-sync-warning",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return l;let t=this._representation();return a`
    ...
    `}};h(_t,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1}}),h(_t,"styles",_`
    :host { display: block; }
  ...
  `);g("bindhome-inventory-browser",ft);var bt=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.registry={},this.focalAssetId=null,this.onNavigate=null,this._search=""}_asset(t){return this.assets.find(e=>e.id===t)??null}_focal(){return this._asset(this.focalAssetId)??this.assets[0]??null}_neighbors(){let t=this._focal();return t?U(this.registry?.relations??[],t.id):{incoming:[],outgoing:[]}}_focus(t){let e=this._asset(t);e&&(this.focalAssetId=e.id,this._search="",this.onNavigate?.(e.id))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
        ...
        <div class="picker">
          ${r.length?r.map(d=>a`
                  ...
                  >
                    ...
                    ${d.areaName?a`<span>${d.areaName}</span>`:l}
                  </button>
                `):a`
                <p class="muted">
                  ${this.t("topology.no_matches")}
    ...
    `}};h(bt,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},focalAssetId:{attribute:!1},onNavigate:{attribute:!1},_search:{state:!0}}),h(bt,"styles",_`
    :host {
      display: block;
    }
  ...
  `);g("bindhome-topology-explorer",bt);var vt=class extends m{constructor(){super(),this.hass=null,this.registry={},this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._active="browse"}_show(t){this._active=t}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._active="browse")}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_showBrowseFromWorkflow(t){t.stopPropagation(),this._active="browse"}render(){return a`
      <nav
        class="subnav"
    ...
    `}};h(vt,"properties",{hass:{attribute:!1},registry:{attribute:!1},t:{attribute:!1},presets:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},selectedAssetId:{attribute:!1},_active:{state:!0}}),h(vt,"styles",_`
    :host {
      display: block;
      min-height: 100%;
    }
  ...
  `);g("bindhome-infrastructure-inspector",yt);function ui(i){let t=[],e=[],s="",r=!1;for(let o=0;o<i.length;o+=1){let n=i[o];if(r){n==='"'?i[o+1]==='"'?(s+='"',o+=1):r=!1:s+=n;continue}if(n==='"'&&s.length===0){r=!0;continue}if(n===","){e.push(s),s="";continue}if(n===`
`){e.push(s),t.push(e),e=[],s="";continue}if(n==="\r"){i[o+1]===`
`&&(o+=1),e.push(s),t.push(e),e=[],s="";continue}s+=n}if(r)throw new Error("CSV contains an unterminated quoted field");return(s.length||e.length)&&(e.push(s),t.push(e)),t}function mi(i){let t=String(i??"");return/[",\r\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function _i(i){return`${i.map(t=>t.map(mi).join(",")).join(`
`)}
`}function Ns(i,t){if(t.scope==="all")return i;let e=ui(i);if(!e.length)return i;let s=e[0],r=s.indexOf("area_id");if(r<0)throw new Error("BindHome CSV is missing area_id");let o=new Set;if(t.scope==="area"&&t.areaId)o.add(t.areaId);else if(t.scope==="floor"&&t.floorId)for(let n of t.areas??[])n.floor_id===t.floorId&&o.add(n.area_id);return _i([s,...e.slice(1).filter(n=>o.has(n[r]??""))])}function Bs(i,t=null){let e=t?t.replace(/[^a-zA-Z0-9_-]+/g,"-"):null;return i==="floor"&&e?`bindhome-inventory-floor-${e}.csv`:i==="area"&&e?`bindhome-inventory-area-${e}.csv`:"bindhome-inventory.csv"}function Ut(i,t,e="text/plain;charset=utf-8"){let s=new Blob([t],{type:e}),r=URL.createObjectURL(s),o=document.createElement("a");o.href=r,o.download=i,o.style.display="none",document.body.append(o),o.click(),o.remove(),queueMicrotask(()=>URL.revokeObjectURL(r))}var xt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.floors=[],this.areas=[],this._scope="all",this._floorId="",this._areaId="",this._fileName="",this._csvText="",this._validation=null,this._busy=!1,this._error=null,this._success=null}_api(){return b(this.hass)}_selectedScopeId(){return this._scope==="floor"?this._floorId:this._scope==="area"?this._areaId:null}_scopeReady(){return this._scope==="all"||(this._scope==="floor"?!!this._floorId:!!this._areaId)}async _export(){if(!(!this.hass||!this._scopeReady())){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().exportInventoryCsv(),e=this._selectedScopeId(),s=Ns(t.csv,{scope:this._scope,floorId:this._floorId||null,areaId:this._areaId||null,areas:this.areas});Ut(Bs(this._scope,e),s,"text/csv;charset=utf-8"),this._success=this.t("csv.export_success")}catch(t){this._error=v(t,this.t("csv.export_error")).message}finally{this._busy=!1}}}async _fileSelected(t){let e=t.currentTarget.files?.[0];e&&(this._fileName=e.name,this._csvText=await e.text(),await this._validate())}async _validate(){if(!(!this.hass||!this._csvText)){this._busy=!0,this._error=null,this._success=null,this._validation=null;try{this._validation=await this._api().validateInventoryCsv(this._csvText)}catch(t){this._error=v(t,this.t("csv.validate_error")).message}finally{this._busy=!1}}}async _commit(){if(!(!this.hass||!this._validation?.valid||!Number.isInteger(this._validation.revision))){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().importInventoryCsv({csv:this._csvText,revision:this._validation.revision}),e=await this._api().listAssets();this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:e,bubbles:!0,composed:!0})),this._validation={...t,revision:t.revision},this._success=this.t("csv.import_success",{created:t.preview?.created??0,updated:t.preview?.updated??0})}catch(t){let e=v(t,this.t("csv.import_error"));this._error=e.code==="conflict"?this.t("csv.conflict"):e.message}finally{this._busy=!1}}}_renderValidation(){let t=this._validation;if(!t)return a`<p class="muted">${this.t("csv.import_hint")}</p>`;if(!t.valid){let s=t.errors??[];return a`<div class="status error" role="alert">${this.t("csv.invalid",{count:s.length})}</div>
    ...
    </section>`}};h(xt,"properties",{hass:{attribute:!1},t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},_scope:{state:!0},_floorId:{state:!0},_areaId:{state:!0},_fileName:{state:!0},_csvText:{state:!0},_validation:{state:!0},_busy:{state:!0},_error:{state:!0},_success:{state:!0}}),h(xt,"styles",[x,_`
      :host { display: block; }
      .tool { padding: 20px; }
...
`,s=new Date,r=s.toISOString().slice(0,10);Ut(`bindhome-registry-backup-${r}.json`,e,"application/json;charset=utf-8"),this._lastBackup=s.toISOString(),await R(this.hass,ae,this._lastBackup),this._success=this.t("backup.export_success")}catch(t){this._error=v(t,this.t("backup.export_error")).message}finally{this._busy=!1}}}async _restoreFileSelected(t){let e=t.currentTarget.files?.[0];if(e){this._error=null,this._success=null,this._confirmed=!1,this._restoreFileName=e.name;try{let s=JSON.parse(await e.text());if(s?.format!=="bindhome.registry"||!s.registry)throw new Error(this.t("backup.invalid_envelope"));let r=gi(s);if(!r)throw new Error(this.t("backup.invalid_envelope"));this._restoreBackup=s,this._restoreSummary=r}catch(s){this._restoreBackup=null,this._restoreSummary=null,this._error=s instanceof Error?s.message:this.t("backup.invalid_file")}}}async _restore(){if(!(!this.hass||!this._restoreBackup||!this._confirmed)){this._busy=!0,this._error=null,this._success=null;try{let t=await this._api().restoreRegistryBackup({backup:this._restoreBackup,revision:this._recovery?.recovery_required?null:this.revision});this._confirmed=!1,this._success=t.reloaded===!1?this.t("backup.restore_saved_reload_failed"):this.t("backup.restore_success"),t.registry?.assets&&this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.registry.assets,bubbles:!0,composed:!0})),await this._loadStatus()}catch(t){let e=v(t,this.t("backup.restore_error"));this._error=e.code==="conflict"?this.t("backup.conflict"):e.message}finally{this._busy=!1}}}_renderSummary(){let t=this._restoreSummary;return t?a`<div class="summary">
      ...
      ${this._error?a`<div class="status error" role="alert">${this._error}</div>`:l}
      ${this._success?a`<div class="status success" role="status">${this._success}</div>`:l}
    </section>`}};h($t,"properties",{hass:{attribute:!1},t:{attribute:!1},revision:{attribute:!1},_lastBackup:{state:!0},_recovery:{state:!0},_restoreFileName:{state:!0},_restoreBackup:{state:!0},_restoreSummary:{state:!0},_confirmed:{state:!0},_busy:{state:!0},_error:{state:!0},_success:{state:!0}}),h($t,"styles",[x,_`
      :host { display: block; }
    ...
    `]);g("bindhome-backup-restore-tool",$t);var fi=new Set(["entity_not_found"]),bi="binding_not_found",vi="already_bound";function yi(i){let t={};for(let e of i??[]){let s=e?.status??"unknown";t[s]=(t[s]??0)+1}return t}var wt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.areas=[],this.assets=[],this.bindingStatuses={records:[],summary:{}},this._recovery=null,this._drift=[],this._referenceAudit=null,this._loading=!1,this._error=null}connectedCallback(){super.connectedCallback(),this.hass&&this._refreshSupplementalHealth()}updated(t){t.has("hass")&&this.hass&&t.get("hass")!==this.hass&&this._refreshSupplementalHealth()}_assetName(t){return this.assets.find(e=>e.id===t)?.name??t}_areaName(t){return t?this.areas.find(e=>e.area_id===t)?.name??t:this.t("health.no_area")}_staleAreas(){let t=new Set(this.areas.map(e=>e.area_id));return this.assets.filter(e=>e.area_id&&!t.has(e.area_id))}_bindingRecords(t){return(this.bindingStatuses?.records??[]).filter(e=>e.status===t)}_actionableBindings(){return(this.bindingStatuses?.records??[]).filter(t=>fi.has(t.status))}_dispatch(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_openAsset(t){this._dispatch("health-open-asset",t)}_reviewImport(t){this._dispatch("health-review-import",t||null)}_openRecovery(){this._dispatch("health-open-recovery",null)}async _refreshSupplementalHealth(){if(!(!this.hass||this._loading)){this._loading=!0,this._error=null;try{let t=b(this.hass),[e,s,r]=await Promise.all([t.getBackupRecoveryStatus(),t.discoverImport(),t.auditDirectReferences()]);this._recovery=e,this._referenceAudit=r;let o=new Map;for(let n of s?.proposals??[]){if(n?.duplicate_status===vi)continue;let d=n?.asset?.area_id??null,c=Math.max(1,n?.source?.entity_ids?.length??n?.bindings?.length??1);o.set(d,(o.get(d)??0)+c)}this._drift=[...o.entries()].map(([n,d])=>({areaId:n,count:d})).sort((n,d)=>this._areaName(n.areaId).localeCompare(this._areaName(d.areaId)))}catch(t){this._error=t instanceof Error?t.message:String(t)}finally{this._loading=!1}}}_renderBindingItems(t,e,s){return a`<div class="section">
      <h3>${this.t(e)}</h3>
    ...
    </div>`}_renderReferenceDebt(){let t=this._referenceAudit?.groups??[],e=this._referenceAudit?.summary??{};return a`<div class="section">
      <h3>${this.t("health.direct_references")}</h3>
      <p class="muted">${this.t("health.direct_references_intro")}</p>
      ${e.incomplete_sources?a`<p class="warning">${this.t("health.reference_sources_incomplete",{count:e.incomplete_sources})}</p>`:l}
      ${t.length?t.map(s=>a`<div class="item">
            <div class="item-copy">
              <strong>${s.entity_id}</strong>
              <span>${this.t("health.direct_reference_count",{count:s.reference_count})}</span>
              <div class="reference-list">
                ${(s.references??[]).map(r=>a`<div class="reference">
                  <strong>${r.consumer_name||r.consumer_id}</strong>
                  <span><code>${r.consumer_id}</code> · <code>${r.path}</code></span>
                  <span>${this.t(r.classification==="deterministic_rewrite"?"health.reference_deterministic":"health.reference_manual")}${r.replacement_entity_id?` \xB7 ${r.replacement_entity_id}`:""}</span>
                </div>`)}
              </div>
            </div>
          </div>`):a`<p class="empty">${this.t("health.no_direct_references")}</p>`}
    </div>`}render(){let t=this.bindingStatuses?.summary??{},e=this.bindingStatuses?.records??[],s=t.by_status??yi(e),r=this._actionableBindings(),o=this._bindingRecords(bi),n=this._staleAreas(),c=(this._referenceAudit?.summary??{}).references??0,u=r.length+o.length+n.length+(this._recovery?.recovery_required?1:0)+this._drift.reduce((f,p)=>f+p.count,0)+c;return a`<section class="card" aria-busy=${this._loading?"true":"false"}>
      <div class="head">
        <div>
      ...
      <div class="summary">
        ...
        <div class="metric"><strong>${c}</strong><span>${this.t("health.direct_reference_debt")}</span></div>
      </div>
      <div class="status-strip">
        ${Object.entries(s).map(([f,p])=>a`<span class="pill">${this.t(`health.status.${f}`)}: ${p}</span>`)}
      </div>
      <p class=${u?"warning":"ok"}>${this.t(u?"health.actionable_count":"health.all_clear",{count:u})}</p>
      ...
      <div class="section">
        ...
        ${n.length?n.map(f=>a`<div class="item">
              <div class="item-copy"><strong>${f.name}</strong><span>${this.t("health.stale_area_detail",{area:f.area_id})}</span></div>
              <button class="action" @click=${()=>this._openAsset(f.id)}>${this.t("health.fix_asset")}</button>
            </div>`):a`<p class="empty">${this.t("health.none")}</p>`}
      </div>

      <div class="section">
        <h3>${this.t("health.inverse_drift")}</h3>
        ${this._drift.length?this._drift.map(f=>a`<div class="item">
              <div class="item-copy"><strong>${this._areaName(f.areaId)}</strong><span>${this.t("health.undocumented_entities",{count:f.count})}</span></div>
              <button class="action" @click=${()=>this._reviewImport(f.areaId)}>${this.t("health.review_import")}</button>
    ...
    </section>`}};h(wt,"properties",{hass:{attribute:!1},t:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},bindingStatuses:{attribute:!1},_recovery:{state:!0},_drift:{state:!0},_referenceAudit:{state:!0},_loading:{state:!0},_error:{state:!0}}),h(wt,"styles",[x,_`
    ...
    `]);g("bindhome-health-tool",wt);var kt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._tab="inventory"}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._tab="inventory")}render(){return a`<div class="content-head">
    ...
    </div>`}};h(At,"properties",{t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},_step:{state:!0}}),h(At,"styles",_`
    :host { display: block; }
    * { box-sizing: border-box; }
