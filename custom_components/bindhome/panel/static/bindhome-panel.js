(()=>{var fs=Object.defineProperty;var bs=(i,t,e)=>t in i?fs(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var p=(i,t,e)=>bs(i,typeof t!="symbol"?t+"":t,e);function _(i,t,e=customElements){let s=e.get(i);return s||(e.define(i,t),t)}var xt=globalThis,$t=xt.ShadowRoot&&(xt.ShadyCSS===void 0||xt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Nt=Symbol(),ge=new WeakMap,q=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Nt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if($t&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=ge.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&ge.set(e,t))}return t}toString(){return this.cssText}},_e=i=>new q(typeof i=="string"?i:i+"",void 0,Nt),g=(i,...t)=>{let e=i.length===1?i[0]:t.reduce((s,r,o)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1],i[0]);return new q(e,i,Nt)},fe=(i,t)=>{if($t)i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),r=xt.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},Tt=$t?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return _e(e)})(i):i;var{is:ys,defineProperty:vs,getOwnPropertyDescriptor:xs,getOwnPropertyNames:$s,getOwnPropertySymbols:ws,getPrototypeOf:As}=Object,wt=globalThis,be=wt.trustedTypes,ks=be?be.emptyScript:"",Is=wt.reactiveElementPolyfillSupport,F=(i,t)=>i,Bt={toAttribute(i,t){switch(t){case Boolean:i=i?ks:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let e=i;switch(t){case Boolean:e=i!==null;break;case Number:e=i===null?null:Number(i);break;case Object:case Array:try{e=JSON.parse(i)}catch{e=null}}return e}},ve=(i,t)=>!ys(i,t),ye={attribute:!0,type:String,converter:Bt,reflect:!1,useDefault:!1,hasChanged:ve};Symbol.metadata??=Symbol("metadata"),wt.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=ye){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),r=this.getPropertyDescriptor(t,s,e);r!==void 0&&vs(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){let{get:r,set:o}=xs(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:r,set(n){let l=r?.call(this);o?.call(this,n),this.requestUpdate(t,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ye}static _$Ei(){if(this.hasOwnProperty(F("elementProperties")))return;let t=As(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(F("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(F("properties"))){let e=this.properties,s=[...$s(e),...ws(e)];for(let r of s)this.createProperty(r,e[r])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,r]of e)this.elementProperties.set(s,r)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let r=this._$Eu(e,s);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let r of s)e.unshift(Tt(r))}else t!==void 0&&e.push(Tt(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return fe(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,s);if(r!==void 0&&s.reflect===!0){let o=(s.converter?.toAttribute!==void 0?s.converter:Bt).toAttribute(e,s.type);this._$Em=t,o==null?this.removeAttribute(r):this.setAttribute(r,o),this._$Em=null}}_$AK(t,e){let s=this.constructor,r=s._$Eh.get(t);if(r!==void 0&&this._$Em!==r){let o=s.getPropertyOptions(r),n=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:Bt;this._$Em=r;let l=n.fromAttribute(e,o.type);this[r]=l??this._$Ej?.get(r)??l,this._$Em=null}}requestUpdate(t,e,s,r=!1,o){if(t!==void 0){let n=this.constructor;if(r===!1&&(o=this[t]),s??=n.getPropertyOptions(t),!((s.hasChanged??ve)(o,e)||s.useDefault&&s.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:r,wrapped:o},n){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),o!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),r===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,o]of this._$Ep)this[r]=o;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[r,o]of s){let{wrapped:n}=o,l=this[r];n!==!0||this._$AL.has(r)||l===void 0||this.C(r,void 0,o,l)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[F("elementProperties")]=new Map,S[F("finalized")]=new Map,Is?.({ReactiveElement:S}),(wt.reactiveElementVersions??=[]).push("2.1.2");var jt=globalThis,xe=i=>i,At=jt.trustedTypes,$e=At?At.createPolicy("lit-html",{createHTML:i=>i}):void 0,Se="$lit$",R=`lit$${Math.random().toFixed(9).slice(2)}$`,Re="?"+R,Es=`<${Re}>`,P=document,K=()=>P.createComment(""),W=i=>i===null||typeof i!="object"&&typeof i!="function",Kt=Array.isArray,Ss=i=>Kt(i)||typeof i?.[Symbol.iterator]=="function",Lt=`[ 	
\f\r]`,j=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,we=/-->/g,Ae=/>/g,D=RegExp(`>|${Lt}(?:([^\\s"'>=/]+)(${Lt}*=${Lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ke=/'/g,Ie=/"/g,Ce=/^(?:script|style|textarea|title)$/i,Wt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),a=Wt(1),ti=Wt(2),ei=Wt(3),N=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),Ee=new WeakMap,z=P.createTreeWalker(P,129);function De(i,t){if(!Kt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return $e!==void 0?$e.createHTML(t):t}var Rs=(i,t)=>{let e=i.length-1,s=[],r,o=t===2?"<svg>":t===3?"<math>":"",n=j;for(let l=0;l<e;l++){let d=i[l],u,b,h=-1,y=0;for(;y<d.length&&(n.lastIndex=y,b=n.exec(d),b!==null);)y=n.lastIndex,n===j?b[1]==="!--"?n=we:b[1]!==void 0?n=Ae:b[2]!==void 0?(Ce.test(b[2])&&(r=RegExp("</"+b[2],"g")),n=D):b[3]!==void 0&&(n=D):n===D?b[0]===">"?(n=r??j,h=-1):b[1]===void 0?h=-2:(h=n.lastIndex-b[2].length,u=b[1],n=b[3]===void 0?D:b[3]==='"'?Ie:ke):n===Ie||n===ke?n=D:n===we||n===Ae?n=j:(n=D,r=void 0);let x=n===D&&i[l+1].startsWith("/>")?" ":"";o+=n===j?d+Es:h>=0?(s.push(u),d.slice(0,h)+Se+d.slice(h)+R+x):d+R+(h===-2?l:x)}return[De(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},G=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,n=0,l=t.length-1,d=this.parts,[u,b]=Rs(t,e);if(this.el=i.createElement(u,s),z.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=z.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(let h of r.getAttributeNames())if(h.endsWith(Se)){let y=b[n++],x=r.getAttribute(h).split(R),$=/([.?@])?(.*)/.exec(y);d.push({type:1,index:o,name:$[2],strings:x,ctor:$[1]==="."?Mt:$[1]==="?"?Ut:$[1]==="@"?qt:B}),r.removeAttribute(h)}else h.startsWith(R)&&(d.push({type:6,index:o}),r.removeAttribute(h));if(Ce.test(r.tagName)){let h=r.textContent.split(R),y=h.length-1;if(y>0){r.textContent=At?At.emptyScript:"";for(let x=0;x<y;x++)r.append(h[x],K()),z.nextNode(),d.push({type:2,index:++o});r.append(h[y],K())}}}else if(r.nodeType===8)if(r.data===Re)d.push({type:2,index:o});else{let h=-1;for(;(h=r.data.indexOf(R,h+1))!==-1;)d.push({type:7,index:o}),h+=R.length-1}o++}}static createElement(t,e){let s=P.createElement("template");return s.innerHTML=t,s}};function T(i,t,e=i,s){if(t===N)return t;let r=s!==void 0?e._$Co?.[s]:e._$Cl,o=W(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,e,s)),s!==void 0?(e._$Co??=[])[s]=r:e._$Cl=r),r!==void 0&&(t=T(i,r._$AS(i,t.values),r,s)),t}var Ot=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??P).importNode(e,!0);z.currentNode=r;let o=z.nextNode(),n=0,l=0,d=s[0];for(;d!==void 0;){if(n===d.index){let u;d.type===2?u=new H(o,o.nextSibling,this,t):d.type===1?u=new d.ctor(o,d.name,d.strings,this,t):d.type===6&&(u=new Ft(o,this,t)),this._$AV.push(u),d=s[++l]}n!==d?.index&&(o=z.nextNode(),n++)}return z.currentNode=P,r}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},H=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=T(this,t,e),W(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==N&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ss(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&W(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=G.createElement(De(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(e);else{let o=new Ot(r,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Ee.get(t.strings);return e===void 0&&Ee.set(t.strings,e=new G(t)),e}k(t){Kt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let o of t)r===e.length?e.push(s=new i(this.O(K()),this.O(K()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=xe(t).nextSibling;xe(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},B=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=c}_$AI(t,e=this,s,r){let o=this.strings,n=!1;if(o===void 0)t=T(this,t,e,0),n=!W(t)||t!==this._$AH&&t!==N,n&&(this._$AH=t);else{let l=t,d,u;for(t=o[0],d=0;d<o.length-1;d++)u=T(this,l[s+d],e,d),u===N&&(u=this._$AH[d]),n||=!W(u)||u!==this._$AH[d],u===c?t=c:t!==c&&(t+=(u??"")+o[d+1]),this._$AH[d]=u}n&&!r&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Mt=class extends B{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}},Ut=class extends B{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}},qt=class extends B{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=T(this,t,e,0)??c)===N)return;let s=this._$AH,r=t===c&&s!==c||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==c&&(s===c||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Ft=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){T(this,t)}};var Cs=jt.litHtmlPolyfillSupport;Cs?.(G,H),(jt.litHtmlVersions??=[]).push("3.3.3");var ze=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let o=e?.renderBefore??null;s._$litPart$=r=new H(t.insertBefore(K(),o),o,void 0,e??{})}return r._$AI(i),r};var Gt=globalThis,m=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ze(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return N}};m._$litElement$=!0,m.finalized=!0,Gt.litElementHydrateSupport?.({LitElement:m});var Ds=Gt.litElementPolyfillSupport;Ds?.({LitElement:m});(Gt.litElementVersions??=[]).push("4.2.2");var Pe=new WeakMap;function Te(i){let t=i?.connection??i;if(typeof t!="object"&&typeof t!="function"||t===null)throw new TypeError("BindHome API requires a Home Assistant connection");let e=Pe.get(t);return e||(e={revision:null,conflictListeners:new Set},Pe.set(t,e)),e}function L(i,t){Number.isInteger(t)&&t>=0&&(i.revision=t)}function zs(i){return i?.code??i?.body?.code??i?.data?.code??null}function Be(i,t){if(zs(t)==="conflict")for(let e of i.conflictListeners)e(t)}async function C(i,t,e){let s={...e};t.revision!==null&&(s.based_on_revision=t.revision);try{let r=await i.callWS(s);return L(t,r?.revision),r}catch(r){throw Be(t,r),r}}async function Ne(i,t,e,s){try{let r=await i.callWS({...e,based_on_revision:s});return L(t,r?.revision),r}catch(r){throw Be(t,r),r}}function Le(i,t){let e=Te(i);return e.conflictListeners.add(t),()=>e.conflictListeners.delete(t)}function f(i){let t=Te(i);return{async getRegistry(){let e=await i.callWS({type:"bindhome/registry/get"});return L(t,e?.revision),e},async subscribeRegistryChanges(e){return i.connection.subscribeMessage(e,{type:"bindhome/registry/subscribe"})},async listAssets(){return(await i.callWS({type:"bindhome/assets/list"})).assets??[]},async listPresets(){return(await i.callWS({type:"bindhome/presets/list"})).presets??[]},async listBindingStatuses(){return i.callWS({type:"bindhome/bindings/status"})},async setBinding({assetId:e,capability:s,entityId:r,role:o="primary"}){return C(i,t,{type:"bindhome/bindings/set",asset_id:e,capability:s,entity_id:r,role:o})},async getReplacementCandidates({assetId:e,capability:s,role:r="primary"}){let o=await i.callWS({type:"bindhome/replacement/candidates",asset_id:e,capability:s,role:r});return L(t,o?.revision),o},async commitReplacement({assetId:e,capability:s,entityId:r,revision:o,role:n="primary"}){return Ne(i,t,{type:"bindhome/replacement/commit",asset_id:e,capability:s,entity_id:r,role:n},o)},async deleteBinding(e){return C(i,t,{type:"bindhome/bindings/delete",binding_id:e})},async createRelation({sourceAssetId:e,relationType:s,targetAssetId:r}){return C(i,t,{type:"bindhome/relations/create",source_asset_id:e,relation_type:s,target_asset_id:r})},async deleteRelation(e){return C(i,t,{type:"bindhome/relations/delete",relation_id:e})},async createAssetsBulk(e){return C(i,t,{type:"bindhome/assets/create_bulk",assets:e})},async updateAsset(e,s){return(await C(i,t,{...s,type:"bindhome/assets/update",asset_id:e})).asset},async deleteAsset(e){return C(i,t,{type:"bindhome/assets/delete",asset_id:e})},async getDeleteImpact(e){let s=await i.callWS({type:"bindhome/assets/delete_impact",asset_id:e});return L(t,s?.revision),s},async deleteAssetWithDependencies(e){return C(i,t,{type:"bindhome/assets/delete_with_dependencies",asset_id:e})},async discoverImport(e=null){let s=await i.callWS({type:"bindhome/import/discover",...e?{area_id:e}:{}});return L(t,s?.revision),s},async commitImport({areaId:e=null,revision:s,decisions:r}){return Ne(i,t,{type:"bindhome/import/commit",decisions:r,...e?{area_id:e}:{}},s)}}}var kt="__bindhome_no_floor__";function Oe(i){return{async listFloors(){return(await i.callWS({type:"config/floor_registry/list"})??[]).map(e=>({floor_id:e.floor_id,name:e.name,level:e.level??null,icon:e.icon??null}))},async listAreas(){return(await i.callWS({type:"config/area_registry/list"})??[]).map(e=>({area_id:e.area_id,name:e.name,floor_id:e.floor_id??null,icon:e.icon??null}))},async listEntityRegistry(){return i.callWS({type:"config/entity_registry/list"})},async listDeviceRegistry(){return i.callWS({type:"config/device_registry/list"})}}}function Ht(i,t){return t===kt?i.filter(e=>!e.floor_id):i.filter(e=>e.floor_id===t)}var Ps="component.bindhome.common.panel_";async function Qt(i,t){let e=async o=>(await i.callWS({type:"frontend/get_translations",language:o,category:"common",integration:["bindhome"]}))?.resources??{},s=await e("en"),r=s;if(t!=="en")try{r=await e(t)}catch{r=s}return Vt(r,s)}function Vt(i={},t={}){return(e,s={})=>{let r=`${Ps}${e.replaceAll(".","_")}`;return(i[r]??t[r]??e).replace(/\{(\w+)\}/g,(n,l)=>s[l]??n)}}function It(i,t){return`${i}.${t===1?"one":"other"}`}function E(i,t){let e=`presets.${t.preset_id}.name`,s=i(e);return s===e?t.default_name:s}var Ns={light_point:["mdi:lightbulb-outline","lighting"],socket:["mdi:power-socket-eu","electricity"],switch:["mdi:light-switch","electricity"],electrical_panel:["mdi:electric-switch","electricity"],circuit:["mdi:transmission-tower","electricity"],junction_box:["mdi:connection","electricity"],ethernet_outlet:["mdi:ethernet","network"],telephone_outlet:["mdi:phone-classic","network"],antenna_outlet:["mdi:television-classic","network"],wifi_access_point:["mdi:wifi","network"],radiator:["mdi:radiator","climate"],thermostat:["mdi:thermostat","climate"],fan:["mdi:fan","climate"],air_conditioning_unit:["mdi:air-conditioner","climate"],tap:["mdi:faucet","water"],shutoff_valve:["mdi:valve","water"],valve:["mdi:valve","water"],drain:["mdi:water-minus","water"],manifold:["mdi:pipe-valve","water"],door:["mdi:door","structure"],window:["mdi:window-closed","structure"],blind:["mdi:blinds","structure"],skylight:["mdi:window-open","structure"],boiler:["mdi:water-boiler","equipment"],water_heater:["mdi:water-boiler","equipment"],pump:["mdi:pump","equipment"],freezer:["mdi:fridge-outline","equipment"],appliance:["mdi:dishwasher","equipment"],machine:["mdi:cog-outline","equipment"]};function w(i,t){let e=Ns[t],s=`presets.${t}.name`,r=i(s);return{type:t,label:r===s?Yt(t):r,icon:e?.[0]??"mdi:cube-outline",category:e?.[1]??"other",known:!!e}}function Yt(i){let t=String(i||"").replaceAll("_"," ").trim();return t?t.charAt(0).toUpperCase()+t.slice(1):"\u2014"}var Et=["lighting","electricity","water","climate","equipment","network","structure","other"];function St(i,t){let e={lighting:"mdi:lightbulb-outline",electricity:"mdi:flash-outline",water:"mdi:water-outline",climate:"mdi:thermometer",equipment:"mdi:tools",network:"mdi:lan",structure:"mdi:home-outline",other:"mdi:dots-horizontal-circle-outline"};return{category:t,label:i(`categories.${t}`),icon:e[t]??e.other}}var A="__bindhome_no_area__",k="__bindhome_stale_area__";function Me(i,t,e){let s=new Map(t.map(d=>[d.area_id,d])),r=new Map;for(let d of e){let u=d.area_id?s.has(d.area_id)?d.area_id:k:A;r.set(u,[...r.get(u)??[],d])}let n=[...i].sort((d,u)=>(d.level??999)-(u.level??999)||d.name.localeCompare(u.name)).map(d=>({id:d.floor_id,name:d.name,icon:d.icon,level:d.level,areas:t.filter(u=>u.floor_id===d.floor_id).sort(Q)})),l=t.filter(d=>!d.floor_id).sort(Q);return l.length&&n.push({id:"__no_floor__",name:null,icon:null,level:null,areas:l}),{groups:n,assetsByArea:r,unassigned:r.get(A)??[],stale:r.get(k)??[]}}function Q(i,t){return i.name.localeCompare(t.name,void 0,{sensitivity:"base"})}function Ue(i,t){let e=new Map;for(let s of t){let r=w(i,s.asset_type);e.set(r.category,[...e.get(r.category)??[],s])}return Et.filter(s=>e.has(s)).map(s=>({category:s,assets:e.get(s).sort(Q)}))}function qe(i,t,e,s,r){let o=new Map(e.map(d=>[d.area_id,d])),n=new Map(s.map(d=>[d.floor_id,d])),l=r.trim().toLocaleLowerCase();return l?t.map(d=>{let u=d.area_id?o.get(d.area_id):null,b=u?.floor_id?n.get(u.floor_id):null,h=w(i,d.asset_type),x=[d.name,d.code,h.label,d.asset_type,u?.name,b?.name].filter(Boolean).map($=>String($).toLocaleLowerCase()).reduce(($,U,Pt)=>$+(U===l?100-Pt:U.startsWith(l)?50-Pt:U.includes(l)?10-Pt:0),0);return{asset:d,area:u,floor:b,type:h,score:x}}).filter(d=>d.score>0).sort((d,u)=>u.score-d.score||Q(d.asset,u.asset)).slice(0,30):t.slice().sort(Q).slice(0,8)}var Fe="/bindhome";function Zt(){return{view:"home",areaId:null,assetId:null,query:"",contextAreaId:null,advancedAssetId:null}}function Jt(i){if(!i)return null;try{return decodeURIComponent(i)}catch{return null}}function Ts(i){let t=typeof i=="string"&&i?i:Fe,e=t.startsWith("/")?t:`/${t}`;return e.length>1?e.replace(/\/+$/,""):e}function je(i,t=""){let e=Zt(),r=(typeof i?.path=="string"?i.path:"").split("/").filter(Boolean),o=new URLSearchParams(t.startsWith("?")?t.slice(1):t);if(r.length===0)return e;if(r[0]==="home"){if(r.length>3)return e;let n=r.length>=2?Jt(r[1]):null,l=r.length>=3?Jt(r[2]):null;return r.length>=2&&n===null||r.length>=3&&l===null?e:{...e,areaId:n,assetId:l}}if(r[0]==="add"&&r.length===1){let n=o.get("area");return{...e,view:"add",contextAreaId:n||null}}if(r[0]==="search"&&r.length===1)return{...e,view:"search",query:o.get("q")??""};if(r[0]==="advanced"){if(r.length>2)return e;let n=r.length===2?Jt(r[1]):null;return r.length===2&&n===null?e:{...e,view:"advanced",advancedAssetId:n}}return e}function Xt(i){return encodeURIComponent(i)}function te(i,t=Fe){let e=Ts(t);if(i.view==="add"){let r=new URLSearchParams;i.contextAreaId&&r.set("area",i.contextAreaId);let o=r.toString();return`${e}/add${o?`?${o}`:""}`}if(i.view==="search"){let r=new URLSearchParams;i.query&&r.set("q",i.query);let o=r.toString();return`${e}/search${o?`?${o}`:""}`}if(i.view==="advanced")return i.advancedAssetId?`${e}/advanced/${Xt(i.advancedAssetId)}`:`${e}/advanced`;let s=`${e}/home`;return i.areaId&&(s+=`/${Xt(i.areaId)}`),i.areaId&&i.assetId&&(s+=`/${Xt(i.assetId)}`),s}function ee(i,t={}){let e=t.window??window,s=t.replace===!0,r=`${e.location.pathname}${e.location.search}`;if(r===i)return!1;let o=e.history.state??{};if(s){let l={};o?.root&&(l.root=!0),o?.from!==void 0&&(l.from=o.from),e.history.replaceState(Object.keys(l).length?l:null,"",i)}else e.history.pushState({from:r},"",i);let n=e.document.createEvent("CustomEvent");return n.initCustomEvent("location-changed",!1,!1,{replace:s}),e.dispatchEvent(n),!0}var I=g`
  :host {
    --bh-space-1: 4px;
    --bh-space-2: 8px;
    --bh-space-3: 12px;
...
`;var Bs={feeds:{outgoing:"relations.feeds.outgoing",incoming:"relations.feeds.incoming"},contains:{outgoing:"relations.contains.outgoing",incoming:"relations.contains.incoming"},controls:{outgoing:"relations.controls.outgoing",incoming:"relations.controls.incoming"},part_of:{outgoing:"relations.part_of.outgoing",incoming:"relations.part_of.incoming"}};function Ke(i,t,e){let s=Bs[t]?.[e];return{type:t,direction:e,label:s?i(s):i("relations.unknown",{type:Yt(t)}),known:!!s,icon:t==="feeds"?"mdi:flash-outline":t==="controls"?"mdi:tune":t==="contains"||t==="part_of"?"mdi:folder-outline":"mdi:vector-link"}}function We(i){return{socket:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.indicate_feeds"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}],circuit:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.panel_source"}],electrical_panel:[{direction:"outgoing",relationType:"feeds",labelKey:"relations.actions.add_powered"},{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],junction_box:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],manifold:[{direction:"outgoing",relationType:"contains",labelKey:"relations.actions.add_content"}],shutoff_valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],valve:[{direction:"outgoing",relationType:"controls",labelKey:"relations.actions.indicate_controls"}],light_point:[{direction:"incoming",relationType:"feeds",labelKey:"relations.actions.power_source"}]}[i]??[]}function O(i=[],t){return{outgoing:i.filter(e=>e.source_asset_id===t),incoming:i.filter(e=>e.target_asset_id===t)}}function Ge(i=[]){return[...new Set(i.map(t=>t.relation_type).filter(Boolean))].sort()}function se(i){return/^[a-z][a-z0-9_]*$/.test(String(i).trim())}function ie(i){return[i?.message,i?.body?.message,i?.data?.message,i?.error].filter(t=>typeof t=="string")}function v(i,t=null){let e=ie(i).find(s=>s.trim())??t;return{code:i?.code??i?.body?.code??i?.data?.code??null,message:e}}function He(i,t=null){for(let s of ie(i))try{let r=JSON.parse(s);if(Number.isInteger(r?.index)&&r.index>=0&&typeof r?.field=="string"&&typeof r?.message=="string")return{structured:!0,index:r.index,field:r.field,message:r.message}}catch{}return{structured:!1,index:null,field:null,message:ie(i).find(s=>s.trim())??t}}function Ls(i){return String(i??"").trim()}function M(i){return Ls(i).toLocaleLowerCase()}function Ve(i,t){return M(i.name).localeCompare(M(t.name),void 0,{numeric:!0,sensitivity:"base"})||i.entityId.localeCompare(t.entityId)}function Qe(i,t,e){let s=M(t);if(!s)return e&&i.areaId===e?0:1;let r=[i.name,i.entityId,i.areaName,i.deviceName,i.domain].map(M),o=r.some(d=>d===s),n=r.some(d=>d.startsWith(s)),l=e&&i.areaId===e?0:1;return(o?0:n?1:2)*2+l}function re({entityRegistry:i=[],deviceRegistry:t=[],states:e={},areas:s=[]}={}){let r=new Map(i.filter(d=>d?.entity_id).map(d=>[d.entity_id,d])),o=new Map(t.filter(d=>d?.id).map(d=>[d.id,d])),n=new Map(s.filter(d=>d?.area_id).map(d=>[d.area_id,d.name]));return[...new Set([...r.keys(),...Object.keys(e??{})])].map(d=>{let u=r.get(d)??null,b=e?.[d]??null,h=u?.device_id?o.get(u.device_id):null,[y]=d.split("."),x=u?.area_id??h?.area_id??null,$=b?.attributes?.friendly_name??u?.name??u?.original_name??d;return{entityId:d,domain:y,name:$,state:b?.state??null,registryEntry:u,deviceId:u?.device_id??null,deviceName:h?.name_by_user??h?.name??null,areaId:x,areaName:x?n.get(x)??null:null,disabled:!!u?.disabled_by,hidden:!!u?.hidden_by,isBindHome:u?.platform==="bindhome"}}).sort(Ve)}function Ye(i,t="",e=null){let s=M(t);return[...i??[]].filter(r=>s?[r.name,r.entityId,r.areaName,r.deviceName,r.domain].some(o=>M(o).includes(s)):!0).sort((r,o)=>Qe(r,s,e)-Qe(o,s,e)||Ve(r,o))}var Os=8,Ms=20;function Us(i,t){let e=`capabilities.${t}`,s=i(e);return s!==e?s:t.replaceAll("_"," ").replace(/\b\w/g,r=>r.toUpperCase())}var V=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.capability="",this.status=null,this.areas=[],this.entityRegistry=[],this.deviceRegistry=[],this.showEntityId=!0,this.refreshBindingData=null,this._editing=!1,this._search="",this._selectedEntityId=null,this._saving=!1,this._error=null,this._confirmDisconnect=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._bindingIdentity=null,this._operation=0,this._committedDisconnectId=null}_replacementMode(){return!!(this.status?.binding&&this.status?.status!=="binding_not_found")}_replacementCandidates(){if(!this._replacementPlan)return null;let t=new Map((this.areas??[]).map(s=>[s.area_id,s.name])),e=new Map((this.deviceRegistry??[]).map(s=>[s.id,s.name_by_user||s.name]));return(this._replacementPlan.candidates??[]).map(s=>({entityId:s.entity_id,entityRegistryId:s.entity_registry_id,name:s.name,domain:s.domain,areaId:s.area_id,areaName:t.get(s.area_id)??null,deviceId:s.device_id,deviceName:e.get(s.device_id)??null,state:s.state,disabled:!1,hidden:!1,reasons:s.reasons??[]}))}_candidates(){let t=this._replacementCandidates();return t||re({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas})}willUpdate(){let t=this.asset?JSON.stringify([this.asset.id,this.capability,"primary"]):null;this._bindingIdentity!==null&&t!==this._bindingIdentity&&(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._saving=!1,this._selectionMode="search",this._replacementPlan=null,this._replacementLoading=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._committedDisconnectId=null,this._operation+=1),this._bindingIdentity=t}_currentEntityId(){return this.status?.entity_id??this.status?.binding?.entity_id??null}_currentCandidate(){let t=this._currentEntityId();return re({entityRegistry:this.entityRegistry,deviceRegistry:this.deviceRegistry,states:this.hass?.states,areas:this.areas}).find(e=>e.entityId===t)??null}_runtimeLabel(t){return t?t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state===null?this.t("connection.no_runtime"):this.t("connection.available"):this.t("connection.stale")}_configurationLabel(){return this.status?.status==="entity_not_found"||this.status?.config_valid!==!1?this.t("connection.configured"):this.t("connection.invalid_configuration")}_candidateStateLabel(t){return!t||t.state===null?this.t("connection.no_runtime"):t.state==="unavailable"?this.t("connection.unavailable"):t.state==="unknown"?this.t("connection.unknown"):t.state}_displayName(t,e){return t?.name&&(this.showEntityId||t.name!==e)?t.name:t?.deviceName??(this.showEntityId?e:this.t("connection.configured"))}_candidateMeta(t){return[this.showEntityId?t?.entityId:null,t?.areaName,t?.deviceName,t?this._candidateStateLabel(t):null].filter(Boolean).join(" \xB7 ")}async _beginEdit(){if(this._saving||this._replacementLoading||(this._editing=!0,this._selectedEntityId=this._replacementMode()?null:this._currentEntityId(),this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementSuccess=null,this._selectionMode="search",!this._replacementMode()))return;let t=++this._operation;this._replacementLoading=!0;try{let e=await f(this.hass).getReplacementCandidates({assetId:this.asset.id,capability:this.capability,role:"primary"});if(t!==this._operation)return;this._replacementPlan=e}catch(e){if(t!==this._operation)return;this._error=v(e,this.t("connection.replacement_load_error")).message}finally{t===this._operation&&(this._replacementLoading=!1)}}_cancelEdit(){this._saving||(this._editing=!1,this._selectedEntityId=null,this._search="",this._error=null,this._confirmDisconnect=!1,this._confirmReplacement=!1,this._replacementPlan=null,this._replacementLoading=!1,this._selectionMode="search")}_select(t){this._saving||(this._selectedEntityId=t,this._error=null,this._confirmReplacement=!1,this._selectionMode="selected")}_changeSelection(){this._saving||(this._selectionMode="search",this._confirmReplacement=!1)}async _save(){if(this._saving||!this._selectedEntityId||!this.asset)return;if(this._replacementMode()&&!this._confirmReplacement){this._confirmReplacement=!0;return}this._saving=!0,this._error=null;let t=++this._operation,e=this._selectedEntityId;try{let s;if(this._replacementMode()){if(!this._replacementPlan||!Number.isInteger(this._replacementPlan.revision))throw new Error(this.t("connection.replacement_load_error"));s=await f(this.hass).commitReplacement({assetId:this.asset.id,capability:this.capability,entityId:e,revision:this._replacementPlan.revision,role:"primary"})}else s=await f(this.hass).setBinding({assetId:this.asset.id,capability:this.capability,entityId:e,role:"primary"});if(t!==this._operation)return;this._replacementSuccess=this._replacementMode()?s?.resolution?.entity_id??e:null,this._editing=!1,this._selectedEntityId=null,this._search="",this._confirmReplacement=!1,this._replacementPlan=null;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(t!==this._operation)return;let r=v(s,this.t("connection.save_error"));this._error=r.code==="binding_cycle"?this.t("connection.cycle_error"):r.message}finally{this._saving=!1}}async _disconnect(){let t=this.status?.binding;if(this._saving||!t||this._committedDisconnectId===t.id)return;this._saving=!0,this._error=null,this._editing=!1;let e=++this._operation;try{if(await f(this.hass).deleteBinding(t.id),e!==this._operation)return;this._committedDisconnectId=t.id,this._confirmDisconnect=!1;try{this.refreshBindingData&&await this.refreshBindingData()}catch{this._error=this.t("connection.sync_warning")}}catch(s){if(e!==this._operation)return;this._error=v(s,this.t("connection.disconnect_error")).message,this._confirmDisconnect=!0}finally{this._saving=!1}}_renderSummary(){let t=this.status?.binding,e=this._currentEntityId(),s=this._currentCandidate();return!t||this.status?.status==="binding_not_found"?a`<div class="summary">${this.t("connection.not_connected")}</div><div class="actions"><button class="primary" @click=${this._beginEdit}>${this.t("connection.connect")}</button></div>`:a`
    ...
    `}_renderEditor(){if(this._replacementLoading)return a`<div class="picker"><div class="muted">${this.t("connection.replacement_loading")}</div><div class="actions"><button @click=${this._cancelEdit}>${this.t("editor.cancel")}</button></div></div>`;let t=Ye(this._candidates(),this._search,this.asset?.area_id),e=t.slice(0,this._search?Ms:Os),s=this._currentEntityId(),r=this._candidates().find(n=>n.entityId===this._selectedEntityId),o=!!(s&&s===this._selectedEntityId);return a`
      <div class="picker">
  ...
  `);_("bindhome-primary-connection-editor",V);var Y=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.action=null,this.onRefresh=null,this._target="",this._query="",this._saving=!1,this._error=null,this._token=0,this._identity="",this._committed=!1}connectedCallback(){super.connectedCallback(),this._resetIdentity()}willUpdate(){let t=this._currentIdentity();this._identity&&t!==this._identity&&this._resetIdentity(),this._identity=t}_currentIdentity(){return`${this.asset?.id??""}:${this.action?.direction??""}:${this.action?.relationType??""}`}_resetIdentity(){this._token+=1,this._target="",this._query="",this._saving=!1,this._error=null,this._committed=!1,this._identity=this._currentIdentity()}_isCurrent(t,e){return t===this._token&&e===this._currentIdentity()}async _save(){if(this._saving||this._committed||!this._target||!this.asset||!this.action)return;let t=++this._token,e=this._currentIdentity();this._saving=!0,this._error=null;let s=this.action.direction==="incoming";try{if(await f(this.hass).createRelation({sourceAssetId:s?this._target:this.asset.id,relationType:this.action.relationType,targetAssetId:s?this.asset.id:this._target}),!this._isCurrent(t,e))return;this._committed=!0,this._saving=!1;try{await this.onRefresh?.()}catch{if(!this._isCurrent(t,e))return;this.dispatchEvent(new CustomEvent("sync-warning",{detail:this.t("topology.sync_warning"),bubbles:!0,composed:!0}))}if(!this._isCurrent(t,e))return;this.dispatchEvent(new CustomEvent("done",{bubbles:!0,composed:!0}))}catch(r){if(!this._isCurrent(t,e))return;let o=v(r,this.t("topology.create_error"));this._error=o.code==="conflict"?this.t("topology.duplicate_relation"):o.message}finally{this._isCurrent(t,e)&&!this._committed&&(this._saving=!1)}}render(){let t=this._query.toLocaleLowerCase(),e=this.assets.filter(s=>s.id!==this.asset?.id&&(!t||[s.name,s.code,s.asset_type].filter(Boolean).some(r=>String(r).toLocaleLowerCase().includes(t)))).slice(0,20);return a`<label
      ...
      </div>`}};p(Y,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},action:{attribute:!1},onRefresh:{attribute:!1},_target:{state:!0},_query:{state:!0},_saving:{state:!0},_error:{state:!0}}),p(Y,"styles",[I,g`
      :host {
        display: block;
        margin-top: 12px;
        padding: 14px;
    ...
    </form>`}};p(J,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},areas:{attribute:!1},refreshAssets:{attribute:!1},_name:{state:!0},_code:{state:!0},_areaId:{state:!0},_saving:{state:!0},_error:{state:!0}}),p(J,"styles",[I,g`
    :host { display:block; }
    form { padding:20px; }
  ...
  `]);_("bindhome-human-asset-editor",J);var X=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this._impact=null,this._loading=!1,this._deleting=!1,this._error=null,this._identity=null}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._impact=null,this._loading=!1,this._deleting=!1,this._error=null)}async _prepare(){if(!(!this.hass||!this.asset||this._loading||this._deleting)){this._loading=!0,this._error=null;try{this._impact=await f(this.hass).getDeleteImpact(this.asset.id)}catch(t){this._error=v(t,this.t("delete.error")).message}finally{this._loading=!1}}}async _delete(){if(!(!this.hass||!this.asset||!this._impact||this._deleting)){this._deleting=!0,this._error=null;try{await f(this.hass).deleteAssetWithDependencies(this.asset.id),await Promise.allSettled([this.refreshBindingData?.(),this.refreshTopologyData?.(),this.refreshAssets?.()]),this.dispatchEvent(new CustomEvent("asset-deleted",{detail:this.asset.id,bubbles:!0,composed:!0}))}catch(t){this._error=v(t,this.t("delete.error")).message,this._deleting=!1}}}render(){if(!this.asset)return c;let t=this._impact,e=t?.relations?.length??0,s=t?.owned_bindings?.length??0,r=t?.dependent_bindings?.length??0;return a`<div class="danger">
      ...
      ${this._error?a`<div class="error" role="alert">${this._error}</div>`:c}
    </div>`}};p(X,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},_impact:{state:!0},_loading:{state:!0},_deleting:{state:!0},_error:{state:!0}}),p(X,"styles",g`
    :host { display:block; }
  ...
  `);_("bindhome-asset-delete-control",X);var Z=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.floors=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.advancedEnabled=!1,this.readOnly=!1,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this._action=null,this._sync=null,this._editingAsset=!1,this._identity=null}willUpdate(){this.asset?.id!==this._identity&&(this._identity=this.asset?.id,this._action=null,this._sync=null,this._editingAsset=!1)}_area(){return this.areas.find(t=>t.area_id===this.asset?.area_id)??null}_asset(t){return this.assets.find(e=>e.id===t)??null}_relations(){let t=O(this.registry?.relations??[],this.asset?.id);return[...t.incoming.map(e=>({relation:e,direction:"incoming",other:this._asset(e.source_asset_id)})),...t.outgoing.map(e=>({relation:e,direction:"outgoing",other:this._asset(e.target_asset_id)}))]}_devices(){let t=this.asset?.capabilities??[],e=(this.bindingStatuses?.records??[]).filter(o=>o.asset_id===this.asset?.id&&o.role==="primary"&&!!(o.binding||o.entity_id)).map(o=>({capability:o.capability,status:o})),s=e.length?e:t.length?[{capability:t[0],status:null}]:[],r=new Set;return s.filter(({capability:o,status:n})=>{let l=n?.binding?.entity_id??n?.entity_id,d=this.entityRegistry.find(b=>b.entity_id===l)?.device_id,u=d?`device:${d}`:l?`entity:${l}`:`capability:${o}`;return r.has(u)?!1:(r.add(u),!0)})}_forwardDeleted(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("asset-deleted",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return c;if(this._editingAsset)return a`<bindhome-human-asset-editor
    ...
    `]);_("bindhome-element-detail",Z);var tt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.floors=[],this.areas=[],this.assets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.advancedEnabled=!1,this.readOnly=!1,this.refreshBindingData=null,this.refreshTopologyData=null,this.refreshAssets=null,this.selectedAssetId=null,this.selectedAreaId=null,this._collapsedFloorIds=new Set,this._collapsedPreferenceIdentity=null}updated(t){t.has("hass")&&this._restoreCollapsedFloors()}_collapsedPreferenceKey(){return`bindhome.home-collapsed-floors.${this.hass?.user?.id??"browser"}`}_restoreCollapsedFloors(){let t=this._collapsedPreferenceKey();if(t!==this._collapsedPreferenceIdentity){this._collapsedPreferenceIdentity=t;try{let e=JSON.parse(window.localStorage.getItem(t)??"[]");this._collapsedFloorIds=new Set(Array.isArray(e)?e.filter(s=>typeof s=="string"):[])}catch{this._collapsedFloorIds=new Set}}}_persistCollapsedFloors(){try{window.localStorage.setItem(this._collapsedPreferenceKey(),JSON.stringify([...this._collapsedFloorIds].sort()))}catch{}}_areaAssets(t){return t===A?this.assets.filter(e=>!e.area_id):t===k?this.assets.filter(e=>e.area_id&&!this.areas.some(s=>s.area_id===e.area_id)):this.assets.filter(e=>e.area_id===t)}_selectArea(t){this.dispatchEvent(new CustomEvent("home-navigate",{detail:{areaId:t,assetId:null},bubbles:!0,composed:!0}))}_selectAsset(t){let e=this.assets.find(r=>r.id===t);if(!e)return;let s=e.area_id?this.areas.some(r=>r.area_id===e.area_id)?e.area_id:k:A;this.dispatchEvent(new CustomEvent("home-navigate",{detail:{areaId:s,assetId:t},bubbles:!0,composed:!0}))}_toggleFloor(t){let e=new Set(this._collapsedFloorIds);e.has(t)?e.delete(t):e.add(t),this._collapsedFloorIds=e,this._persistCollapsedFloors()}_floorIcon(t){return t.icon?t.icon:t.level===-1?"mdi:home-floor-negative-1":Number.isInteger(t.level)&&t.level>=0&&t.level<=3?`mdi:home-floor-${t.level}`:"mdi:floor-plan"}_roomCountLabel(t){return this.t(t===1?"home.room_count_one":"home.room_count_other",{count:t})}_selectedArea(){return this.areas.find(t=>t.area_id===this.selectedAreaId)??null}_areaName(){return this.selectedAreaId===A?this.t("home.unassigned"):this.selectedAreaId===k?this.t("home.stale_area"):this._selectedArea()?.name??this.t("home.choose_room")}_areaIcon(){return this.selectedAreaId===A?"mdi:map-marker-off-outline":this.selectedAreaId===k?"mdi:map-marker-alert-outline":this._selectedArea()?.icon||"mdi:floor-plan"}_addInSelectedArea(){!this.selectedAreaId||[A,k].includes(this.selectedAreaId)||this.dispatchEvent(new CustomEvent("add-in-area",{detail:this.selectedAreaId,bubbles:!0,composed:!0}))}_renderTree(){let t=Me(this.floors,this.areas,this.assets);return a`<section
    ...
    >
    ...
    </section>`}_renderRoom(){if(!this.selectedAreaId)return a`<div class="empty room">${this.t("home.choose_room")}</div>`;let t=this._areaAssets(this.selectedAreaId),e=Ue(this.t,t),s=!this.readOnly&&![A,k].includes(this.selectedAreaId);return a`<section class="room surface ${this.selectedAssetId?"hidden-mobile":""}">
      ...
      ${e.length?e.map(r=>{let o=St(this.t,r.category);return a`<section>
    ...
    </div>`}};p(tt,"properties",{hass:{attribute:!1},t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},advancedEnabled:{type:Boolean,attribute:!1},readOnly:{type:Boolean,attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},refreshAssets:{attribute:!1},selectedAssetId:{attribute:!1},selectedAreaId:{attribute:!1},_collapsedFloorIds:{state:!0}}),p(tt,"styles",[I,g`
    ...
    `]);_("bindhome-home-view",tt);var qs=["light_point","socket","circuit","tap","shutoff_valve","window","door","appliance"];function Je(i,t,e=""){let s=e.trim().toLocaleLowerCase(),r=t.map(n=>({preset:n,name:E(i,n),presentation:w(i,n.asset_type)})).filter(({preset:n,name:l})=>!s||[l,n.asset_type].some(d=>d.toLocaleLowerCase().includes(s))).sort((n,l)=>n.name.localeCompare(l.name,void 0,{sensitivity:"base",numeric:!0})),o=new Map;for(let n of r){let l=n.presentation.category;o.has(l)||o.set(l,[]),o.get(l).push(n)}return{featured:s?[]:qs.map(n=>r.find(({preset:l})=>l.preset_id===n)).filter(Boolean),groups:Et.filter(n=>o.has(n)).map(n=>({category:n,items:o.get(n)})),count:r.length}}function Fs(i,t){return{key:`draft:${i.preset_id}:${t}`,presetId:i.preset_id,name:`${i.default_name} ${t}`,asset_type:i.asset_type,code:null,capabilities:[...i.suggested_capabilities??[]]}}function et(i=[]){return{presetOrder:i.map(t=>t.preset_id),presets:new Map(i.map(t=>[t.preset_id,t])),quantities:new Map(i.map(t=>[t.preset_id,0])),retained:new Map(i.map(t=>[t.preset_id,[]]))}}function Xe(i,t,e){let s=i.presets.get(t);if(!s)return i;let r=Math.max(0,Math.floor(Number(e)||0)),o=[...i.retained.get(t)??[]];for(;o.length<r;)o.push(Fs(s,o.length+1));return{...i,quantities:new Map(i.quantities).set(t,r),retained:new Map(i.retained).set(t,o)}}function Ze(i,t,e){let s=new Map(i.retained);for(let[r,o]of s){let n=o.findIndex(d=>d.key===t);if(n===-1)continue;let l=[...o];l[n]={...l[n],...e},s.set(r,l);break}return{...i,retained:s}}function ae(i){return i.presetOrder.flatMap(t=>{let e=i.quantities.get(t)??0;return(i.retained.get(t)??[]).slice(0,e)})}function ts(i,t){return ae(i).map(e=>{let s={name:e.name,asset_type:e.asset_type,area_id:t,capabilities:[...e.capabilities]};return e.code?.trim()&&(s.code=e.code.trim()),s})}function es(i,t){return(i??[]).filter(e=>e.area_id===t)}function ss(i,t){let e=new Map(t.map(r=>[r.asset_type,r.group])),s=new Map;for(let r of i){let o=e.get(r.asset_type)??"other",n=s.get(o)??[];n.push(r),s.set(o,n)}return s}var Rt=class{constructor(t,e=null){this.api=t,this.fallbackMessage=e,this.saving=!1}async save(t,e){if(this.saving)return{ok:!1,duplicate:!0};this.saving=!0;let s=ts(t,e),r;try{r=await this.api.createAssetsBulk(s)}catch(o){return this.saving=!1,{ok:!1,duplicate:!1,error:He(o,this.fallbackMessage)}}try{let o=await this.api.listAssets();return{ok:!0,created:r.assets??[],assets:o,payload:s,refreshError:null}}catch(o){return{ok:!0,created:r.assets??[],assets:null,payload:s,refreshError:o}}finally{this.saving=!1}}};var st=class extends m{constructor(){super(),this.hass=null,this.presets=[],this.t=t=>t,this.floors=[],this.areas=[],this.assets=[],this._step="select",this._floorId="",this._areaId="",this._draftState=et(),this._openGroups=new Set,this._openDrafts=new Set,this._saveError=null,this._saving=!1,this._success=null,this._confirmRoomChange=!1,this._controller=null}willUpdate(t){(t.has("presets")||t.has("t"))&&this.presets.length&&this._activeDrafts.length===0&&(this._draftState=et(this._localizedPresets()),this._openGroups=new Set([this.presets[0].group])),(t.has("hass")||t.has("t"))&&this.hass&&(this._controller=new Rt(f(this.hass),this.t("errors.batch_fallback")))}get _selectedArea(){return this.areas.find(t=>t.area_id===this._areaId)}get _selectedFloor(){return this._floorId===kt?null:this.floors.find(t=>t.floor_id===this._floorId)}get _areaAssets(){return es(this.assets,this._areaId)}get _activeDrafts(){return ae(this._draftState)}_localizedPresets(){return this.presets.map(t=>({...t,default_name:E(this.t,t)}))}_groupLabel(t){return this.t(`groups.${t}`)===`groups.${t}`?t:this.t(`groups.${t}`)}_count(t,e){return this.t(It(t,e),{count:e})}_selectFloor(t){this._floorId=t.target.value,Ht(this.areas,this._floorId).some(s=>s.area_id===this._areaId)||(this._areaId="")}_continue(){this._areaId&&(this._step="quantity")}_changeQuantity(t,e){if(this._saving)return;let s=this._draftState.quantities.get(t)??0;this._draftState=Xe(this._draftState,t,s+e),this._saveError=null}_toggleGroup(t){let e=new Set(this._openGroups);e.has(t)?e.delete(t):e.add(t),this._openGroups=e}_toggleDraft(t){let e=new Set(this._openDrafts);e.has(t)?e.delete(t):e.add(t),this._openDrafts=e}_updateDraft(t,e){if(this._saving)return;let s=Object.keys(e),r=this._activeDrafts.findIndex(o=>o.key===t);this._draftState=Ze(this._draftState,t,e),(!this._saveError?.structured||this._saveError.index===r&&s.includes(this._saveError.field))&&(this._saveError=null)}_removeCapability(t,e){this._updateDraft(t.key,{capabilities:t.capabilities.filter(s=>s!==e)})}_addCapability(t,e){let s=e.value.trim();!s||t.capabilities.includes(s)||(this._updateDraft(t.key,{capabilities:[...t.capabilities,s]}),e.value="")}async _save(){if(this._saving||!this._controller||!this._activeDrafts.length)return;this._saving=!0,this._saveError=null;let t=await this._controller.save(this._draftState,this._areaId);if(this._saving=!1,t.duplicate)return;if(!t.ok){if(this._saveError=t.error,this._step="review",t.error.structured){let s=this._activeDrafts[t.error.index];if(s){this._openDrafts=new Set([...this._openDrafts,s.key]),await this.updateComplete;let r=this.renderRoot.querySelector(`#${CSS.escape(this._fieldId(s,t.error.field))}`)??this.renderRoot.querySelector(".alert");r?.classList.contains("alert")&&r.setAttribute("tabindex","-1"),r?.scrollIntoView({behavior:"smooth",block:"center"}),r instanceof HTMLElement&&r.focus({preventScroll:!0})}}return}let e=t.assets??[...this.assets,...t.created];this.assets=e,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:e,bubbles:!0,composed:!0})),this._success={count:t.created.length,areaName:this._selectedArea?.name??this.t("inventory.selected_area")},this._draftState=et(this._localizedPresets()),this._openGroups=new Set([this.presets[0]?.group].filter(Boolean)),this._openDrafts=new Set,this._step="success"}_backToQuantities(){this._step="quantity"}_requestRoomChange(){if(this._activeDrafts.length){this._confirmRoomChange=!0;return}this._step="select"}_discardAndChangeRoom(){this._draftState=et(this._localizedPresets()),this._saveError=null,this._openDrafts=new Set,this._confirmRoomChange=!1,this._floorId="",this._areaId="",this._step="select"}_fieldId(t,e){return`${t.key.replaceAll(":","-")}-${e}`}_fieldError(t,e){return this._saveError?.structured&&this._saveError.index===t&&this._saveError.field===e}_renderContext(){return a`<div class="context"><div class="context-inner">
    ...
    </div></div>`}_renderSelection(){let t=[...this.floors,{floor_id:kt,name:this.t("common.no_floor")}],e=Ht(this.areas,this._floorId);return a`<div class="content selection">
    ...
    </div>`}_renderExisting(){let t=ss(this._areaAssets,this.presets);return this._areaAssets.length?a`<div class="existing-summary">${[...t].map(([e,s])=>a`<div class="existing-group"><div class="existing-heading"><strong>${this._groupLabel(e)}</strong><span class="muted">${s.length}</span></div><ul class="existing-list">${s.map(r=>a`<li>${r.name}</li>`)}</ul></div>`)}</div>`:a`<p class="muted helper">${this.t("inventory.no_existing")}</p>`}_renderQuantity(){let t=new Map;for(let e of this.presets)t.set(e.group,[...t.get(e.group)??[],e]);return a`${this._renderContext()}${this._renderRoomChangeConfirmation()}<div class="content layout"><section><h1>${this.t("inventory.quantity_title")}</h1><p class="muted intro">${this.t("inventory.quantity_intro")}</p>
  ...
  `);_("bindhome-inventory-workflow",st);function it(i){let t=i.entity_registry_id?`registry:${i.entity_registry_id}`:`entity:${i.entity_id}`;return`${i.capability}:${i.role??"primary"}:${t}`}function is(i){return{revision:i.revision,scope:i.scope,reviews:(i.proposals??[]).map(t=>({proposal:t,action:null,asset:{name:t.asset.name,asset_type:t.asset.asset_type,area_id:t.asset.area_id??"",capabilities:[...t.asset.capabilities??[]]},targetAssetId:"",selectedBindings:new Set((t.bindings??[]).map(e=>it(e)))}))}}function Ct(i,t,e){return{...i,reviews:i.reviews.map(s=>s.proposal.proposal_id===t?e(s):s)}}function rs(i,t,e){return Ct(i,t,s=>({...s,action:e,targetAssetId:e==="merge"?s.targetAssetId:""}))}function oe(i,t,e){return Ct(i,t,s=>({...s,asset:{...s.asset,...e}}))}function as(i,t,e){return Ct(i,t,s=>({...s,targetAssetId:e}))}function os(i,t,e){return Ct(i,t,s=>{let r=new Set(s.selectedBindings),o=it(e);return r.has(o)?r.delete(o):r.add(o),{...s,selectedBindings:r}})}function ns(i,t,e){let s=[...new Set(e.split(",").map(r=>r.trim()).filter(Boolean))];return oe(i,t,{capabilities:s})}function js(i){return i.action?i.action==="skip"?!0:i.action==="merge"?!!i.targetAssetId:!!(i.asset.name.trim()&&i.asset.asset_type.trim()):!1}function ne(i){return!!i?.reviews?.length&&i.reviews.every(js)}function Ks(i){return(i.proposal.bindings??[]).filter(t=>i.selectedBindings.has(it(t))).map(t=>({capability:t.capability,role:t.role??"primary",entity_id:t.entity_id,...t.entity_registry_id?{entity_registry_id:t.entity_registry_id}:{}}))}function ls(i){return i.reviews.map(t=>{let e={proposal_id:t.proposal.proposal_id,action:t.action};if(t.action==="skip")return e;let s=Ks(t);return t.action==="merge"?{...e,target_asset_id:t.targetAssetId,bindings:s}:{...e,asset:{name:t.asset.name.trim(),asset_type:t.asset.asset_type.trim(),capabilities:[...t.asset.capabilities],...t.asset.area_id?{area_id:t.asset.area_id}:{}},bindings:s}})}function ds(i){return`import.status.${i??"new"}`}function cs(i,t){let e=new Set(t.merge_candidate_asset_ids??[]);return[...i].sort((s,r)=>{let o=e.has(s.id)?0:1,n=e.has(r.id)?0:1;return o!==n?o-n:String(s.name??s.id).localeCompare(String(r.name??r.id))})}var rt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.areas=[],this.assets=[],this.contextAreaId=null,this._scope="all",this._areaId="",this._reviewState=null,this._loading=!1,this._saving=!1,this._error=null,this._success=null,this._initializedContext=!1}willUpdate(t){!this._initializedContext&&t.has("contextAreaId")&&(this._initializedContext=!0,this.contextAreaId&&(this._scope="area",this._areaId=this.contextAreaId))}get _selectedAreaId(){return this._scope==="area"&&this._areaId||null}async _discover(){if(!(this._loading||this._scope==="area"&&!this._areaId)){this._loading=!0,this._error=null,this._success=null;try{let t=await f(this.hass).discoverImport(this._selectedAreaId);this._reviewState=is(t)}catch(t){let e=v(t,this.t("import.discover_error"));this._error=e.message}finally{this._loading=!1}}}_setAction(t,e){this._reviewState=rs(this._reviewState,t,e),this._error=null}_updateAsset(t,e){this._reviewState=oe(this._reviewState,t,e),this._error=null}_toggleBinding(t,e){this._reviewState=os(this._reviewState,t,e)}async _commit(){if(!(this._saving||!ne(this._reviewState))){this._saving=!0,this._error=null;try{let t=await f(this.hass).commitImport({areaId:this._reviewState.scope?.area_id??null,revision:this._reviewState.revision,decisions:ls(this._reviewState)});this._success=t,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t,bubbles:!0,composed:!0}))}catch(t){let e=v(t,this.t("import.commit_error"));this._error=e.message}finally{this._saving=!1}}}_startOver(){this._reviewState=null,this._error=null,this._success=null}_areaFor(t){return this.areas.find(e=>e.area_id===t.asset.area_id)??null}render(){return this._success?this._renderSuccess():this._reviewState?this._renderReview():this._renderScope()}_renderScope(){return a`
      <section>
    ...
    `}_renderProposal(t){let e=t.proposal,s=e.source?.entity_ids??[],r=e.duplicate_status??"new",o=this._areaFor(e);return a`
      <article class="proposal surface" data-proposal-id=${e.proposal_id}>
        <div class="proposal-head">
          ...
          <span class="status ${r}">${this.t(ds(r))}</span>
        </div>
    ...
    `}_renderCreateEditor(t){let e=t.proposal.proposal_id;return a`<div class="editor">
      <div class="editor-grid">
        ...
        <label>${this.t("fields.capabilities")}<input
          ...
          @change=${s=>{this._reviewState=ns(this._reviewState,e,s.target.value)}}
        /></label>
      </div>
      ${this._renderBindings(t)}
    </div>`}_renderMergeEditor(t){let e=t.proposal.proposal_id,s=cs(this.assets,t.proposal);return a`<div class="editor">
      <label>${this.t("import.merge_target")}<select
        .value=${t.targetAssetId}
        @change=${r=>{this._reviewState=as(this._reviewState,e,r.target.value),this._error=null}}
      >
    ...
    </section>`}};p(rt,"properties",{hass:{attribute:!1},t:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},contextAreaId:{attribute:!1},_scope:{state:!0},_areaId:{state:!0},_reviewState:{state:!0},_loading:{state:!0},_saving:{state:!0},_error:{state:!0},_success:{state:!0}}),p(rt,"styles",g`
  ...
  `);_("bindhome-assisted-import-workflow",rt);var at=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.contextAreaId=null,this.sessionId=0,this.onCreated=null,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId="",this._search="",this._saving=!1,this._error=null,this._sync=null,this._committed=!1,this._identity=null,this._operation=0}willUpdate(){this.sessionId!==this._identity&&(this._identity=this.sessionId,this._mode="single",this._preset=null,this._name="",this._code="",this._areaId=this.contextAreaId??"",this._search="",this._operation+=1,this._saving=!1,this._error=null,this._sync=null,this._committed=!1)}_choose(t){this._preset=t,this._name=E(this.t,t),this._code="",this._error=null,this._sync=null,this._committed=!1}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_goHome(t){t?.stopPropagation?.(),this.dispatchEvent(new CustomEvent("go-home",{bubbles:!0,composed:!0}))}async _submit(t){if(t.preventDefault(),this._saving||this._committed||!this._preset||!this._name.trim())return;let e=++this._operation,s=this.sessionId;this._saving=!0,this._error=null,this._sync=null;try{let r={name:this._name.trim(),asset_type:this._preset.asset_type,capabilities:[...this._preset.suggested_capabilities??[]]};this._code.trim()&&(r.code=this._code.trim()),this._areaId&&(r.area_id=this._areaId);let o=await f(this.hass).createAssetsBulk([r]),n=o?.assets?.[0]??o?.created?.[0]??null;if(e!==this._operation||s!==this.sessionId)return;this._committed=!0,this._saving=!1;try{this.onCreated&&await this.onCreated(n)}catch{if(e!==this._operation||s!==this.sessionId)return;this._sync=this.t("shell.refresh_error")}e===this._operation&&s===this.sessionId&&this.dispatchEvent(new CustomEvent("asset-created",{detail:n,bubbles:!0,composed:!0}))}catch(r){if(e!==this._operation||s!==this.sessionId)return;let o=v(r,this.t("add.create_error"));this._error=o.code==="conflict"?this.t("add.create_error"):o.message}finally{e===this._operation&&s===this.sessionId&&(this._saving=!1)}}render(){let t=Je(this.t,this.presets,this._search);return a`<div class="page">
    ...
    `]);_("bindhome-add-view",at);var ot=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.floors=[],this.query=""}render(){let e=qe(this.t,this.assets,this.areas,this.floors,this.query).map(s=>s.asset?s:{asset:s,area:this.areas.find(r=>r.area_id===s.area_id),type:w(this.t,s.asset_type)});return a`<div class="page">
    ...
    </div>`}};p(ot,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},floors:{attribute:!1},query:{type:String}}),p(ot,"styles",[I,g`
      .search {
        position: relative;
        max-width: 720px;
        margin-top: 22px;
    ...
    `]);_("bindhome-search-view",ot);function de(i,t){return(i?.name??"").localeCompare(t?.name??"",void 0,{sensitivity:"base",numeric:!0})}function le(i){return[...i].sort(de)}function ce(i,t,e){let s=new Map((i??[]).map(h=>[h.floor_id,h])),r=new Map((t??[]).map(h=>[h.area_id,h])),o=new Map;for(let h of e??[]){if(!h.area_id||!r.has(h.area_id))continue;let y=o.get(h.area_id)??[];y.push(h),o.set(h.area_id,y)}let n=(t??[]).map(h=>({area:h,assets:le(o.get(h.area_id)??[])})).sort((h,y)=>de(h.area,y.area)),l=(i??[]).map(h=>({floor:h,areas:n.filter(({area:y})=>y.floor_id===h.floor_id)})).sort((h,y)=>{let x=h.floor.level,$=y.floor.level;return typeof x=="number"&&typeof $=="number"&&x!==$?x-$:de(h.floor,y.floor)}),d=n.filter(({area:h})=>!h.floor_id||!s.has(h.floor_id)),u=le((e??[]).filter(h=>!h.area_id)),b=le((e??[]).filter(h=>h.area_id&&!r.has(h.area_id)));return{floors:l,noFloorAreas:d,noAreaAssets:u,unknownAreaAssets:b}}function nt(i){return{asset_id:i.id,name:i.name,asset_type:i.asset_type,code:i.code??"",area_id:i.area_id??"",capabilities:[...i.capabilities??[]]}}function hs(i){return i==null?null:String(i).trim()||null}function Ws(i,t){return i.length!==t.length?!1:i.every((e,s)=>e===t[s])}function he(i,t){if(t.asset_id!==i.id)throw new Error("Asset edit draft identity does not match the persisted Asset");let e={name:t.name,asset_type:t.asset_type,code:hs(t.code),area_id:hs(t.area_id),capabilities:[...t.capabilities??[]]},s={asset_id:i.id};e.name!==i.name&&(s.name=e.name),e.asset_type!==i.asset_type&&(s.asset_type=e.asset_type),e.code!==(i.code??null)&&(s.code=e.code),e.area_id!==(i.area_id??null)&&(s.area_id=e.area_id);let r=[...i.capabilities??[]];return Ws(e.capabilities,r)||(s.capabilities=e.capabilities),s}function ps(i,t){return Object.keys(he(i,t)).length>1}var lt="__bindhome_no_area_assets__",dt="__bindhome_unknown_area_assets__";function us(i,t,e){if(!i)return null;if(i===lt)return t.noAreaAssets.length?{kind:"no-area",title:e("browser.no_area"),description:e("browser.no_area_intro"),assets:t.noAreaAssets}:null;if(i===dt)return t.unknownAreaAssets.length?{kind:"unknown-area",title:e("browser.unknown_area"),description:e("browser.unknown_area_intro"),assets:t.unknownAreaAssets}:null;let r=[...t.floors.flatMap(o=>o.areas),...t.noFloorAreas].find(({area:o})=>o.area_id===i);return r?{kind:"area",title:r.area.name,description:"",area:r.area,assets:r.assets}:null}function ms(i,t){return i.area_id?t.some(e=>e.area_id===i.area_id)?i.area_id:dt:lt}function gs(i,t){return i.map(e=>e.id===t.id?t:e)}function Gs(i,t,e="primary"){return`${i}:${t}:${e}`}function _s(i){let t=i?.records??[];return new Map(t.map(e=>[Gs(e.asset_id,e.capability,e.role),e]))}function pe(i,t=[]){return t.find(e=>e.area_id===i?.area_id)?.name??null}function Hs(i,t=[]){return{asset:i,id:i.id,name:i.name,code:i.code??"",assetType:i.asset_type,areaId:i.area_id??null,areaName:pe(i,t)}}function Dt(i,t="",e=null,s=[]){let r=String(t).trim().toLocaleLowerCase(),o=i.map(l=>Hs(l,s));return(r?o.filter(l=>[l.name,l.code,l.assetType,l.areaName??""].join(" ").toLocaleLowerCase().includes(r)):o).sort((l,d)=>+!!(e&&d.areaId===e)-+!!(e&&l.areaId===e)||l.name.localeCompare(d.name)||l.id.localeCompare(d.id))}var ct=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.onRefresh=null,this.onDone=null,this.onSyncWarning=null,this._direction="outgoing",this._type="",this._other="",this._search="",this._saving=!1,this._error=null,this._identity="",this._token=0}connectedCallback(){super.connectedCallback(),this._resetIdentity()}willUpdate(t){if(!t.has("asset"))return;let e=this.asset?.id??"";this._identity&&e!==this._identity&&this._resetIdentity(),this._identity=e}_resetIdentity(){this._token+=1,this._direction="outgoing",this._type="",this._other="",this._search="",this._error=null,this._saving=!1,this._identity=this.asset?.id??""}_isCurrent(t,e){return t===this._token&&this.asset?.id===e}_candidates(){let t=Dt(this.assets.filter(s=>s.id!==this.asset?.id),this._search,this.asset?.area_id,this.areas),e=this._search.trim()?20:8;return{all:t,shown:t.slice(0,e)}}async _save(){if(this._saving||!this._other||!se(this._type))return;let t=++this._token,e=this.asset?.id,s=this._direction==="outgoing"?e:this._other,r=this._direction==="outgoing"?this._other:e;this._saving=!0,this._error=null;try{if(await f(this.hass).createRelation({sourceAssetId:s,relationType:this._type.trim(),targetAssetId:r}),!this._isCurrent(t,e))return;this._saving=!1,this.onDone?.();try{await this.onRefresh?.()}catch{if(!this._isCurrent(t,e))return;this.onSyncWarning?.(this.t("topology.sync_warning"))}}catch(o){if(!this._isCurrent(t,e))return;let n=v(o,this.t("topology.save_error"));this._error=n.code==="conflict"?this.t("topology.duplicate_relation"):n.message,this._saving=!1}}_cancel(){this.onDone?.()}render(){let{all:t,shown:e}=this._candidates();return a`
      <form
        class="editor"
      ...
      >
        ...
        <label>
          ...
          <datalist id="relation-types">
            ${Ge(this.registry?.relations).map(s=>a`
        ...
        <div class="actions">
          ...
          <button
            type="submit"
            ?disabled=${this._saving||!this._other||!se(this._type)}
          >
            ${this.t("editor.save")}
          </button>
        </div>
      </form>
    `}};p(ct,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onDone:{attribute:!1},onSyncWarning:{attribute:!1},_direction:{state:!0},_type:{state:!0},_other:{state:!0},_search:{state:!0},_saving:{state:!0},_error:{state:!0}}),p(ct,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-relation-editor",ct);var ht=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.onRefresh=null,this.onNavigate=null,this._editing=!1,this._deleting=null,this._error=null,this._sync=null,this._confirm=null,this._identity="",this._token=0}willUpdate(t){t.has("asset")&&this.asset&&this._identity&&this.asset.id!==this._identity&&(this._token+=1,this._deleting=null,this._confirm=null,this._error=null,this._sync=null),this.asset&&(this._identity=this.asset.id)}_asset(t){return this.assets.find(e=>e.id===t)??null}_area(t){return t?.area_id?this.areas.find(e=>e.area_id===t.area_id)?.name??null:null}async _delete(t){if(this._deleting)return;let e=++this._token,s=this.asset?.id;this._deleting=t.id,this._error=null;try{if(await f(this.hass).deleteRelation(t.id),e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._confirm=null;try{await this.onRefresh?.()}catch{if(e!==this._token||this.asset?.id!==s)return;this._sync=this.t("topology.sync_warning")}}catch(r){if(e!==this._token||this.asset?.id!==s)return;this._deleting=null,this._error=v(r,this.t("topology.delete_error")).message}}_navigate(t){this._asset(t)&&(this.onNavigate?.(t),this.dispatchEvent(new CustomEvent("navigate-asset",{detail:t,bubbles:!0,composed:!0})))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
    ...
    `}render(){let{outgoing:t,incoming:e}=O(this.registry?.relations??[],this.asset?.id);return a`
    ...
    `}};p(ht,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},onRefresh:{attribute:!1},onNavigate:{attribute:!1},_editing:{state:!0},_deleting:{state:!0},_error:{state:!0},_sync:{state:!0},_confirm:{state:!0}}),p(ht,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-asset-topology",ht);var pt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null}_bindings(){return this.asset?(this.registry?.bindings??[]).filter(t=>t.asset_id===this.asset.id):[]}_primaryStatus(t){if(!this.asset)return null;let e=_s(this.bindingStatuses).get(`${this.asset.id}:${t}:primary`);if(e)return e;let s=this._bindings().find(r=>r.capability===t&&r.role==="primary");return s?{asset_id:this.asset.id,capability:t,role:"primary",status:"resolved",config_valid:!0,runtime_available:!0,entity_id:s.entity_id,binding:s}:null}_representation(){return this.asset?(this.registry?.representations??[]).find(t=>t.asset_id===this.asset.id):null}_forwardTopologyWarning(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("topology-sync-warning",{detail:t.detail,bubbles:!0,composed:!0}))}render(){if(!this.asset)return c;let t=this._representation();return a`
    ...
    `}};p(pt,"properties",{hass:{attribute:!1},t:{attribute:!1},asset:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1}}),p(pt,"styles",g`
    :host { display: block; }
  ...
  `);_("bindhome-asset-connections",pt);function zt(i){return{...i,capabilities:[...i.capabilities??[]]}}var ut=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.asset=null,this.assets=[],this.areas=[],this.floors=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this._editing=!1,this._draft=null,this._snapshot=null,this._saving=!1,this._error=null,this._saved=!1,this._newCapability=""}willUpdate(t){t.has("asset")&&this.asset&&!this._editing&&(this._snapshot=zt(this.asset),this._draft=nt(this.asset))}get _dirty(){return!this._editing||!this._snapshot||!this._draft?!1:ps(this._snapshot,this._draft)}_emitEditing(t){this.dispatchEvent(new CustomEvent("editing-changed",{detail:t,bubbles:!0,composed:!0}))}_startEdit(){this._snapshot=zt(this.asset),this._draft=nt(this.asset),this._editing=!0,this._error=null,this._saved=!1,this._newCapability="",this._emitEditing(!0)}_cancel(){this._draft=nt(this.asset),this._snapshot=zt(this.asset),this._editing=!1,this._error=null,this._newCapability="",this._emitEditing(!1)}_close(){this._editing||this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_updateField(t,e){!this._draft||this._saving||(this._draft={...this._draft,[t]:e},this._error=null,this._saved=!1)}_removeCapability(t){this._updateField("capabilities",this._draft.capabilities.filter(e=>e!==t))}_addCapability(){let t=this._newCapability.trim();if(!t||this._draft.capabilities.includes(t)){this._newCapability="";return}this._updateField("capabilities",[...this._draft.capabilities,t]),this._newCapability=""}async _save(t=null){if(t?.preventDefault(),this._saving||!this._snapshot||!this._draft)return;let e=he(this._snapshot,this._draft);if(Object.keys(e).length===1){this._editing=!1,this._emitEditing(!1);return}let{asset_id:s,...r}=e;this._saving=!0,this._error=null,this._saved=!1;try{let n=await f(this.hass).updateAsset(s,r);this.asset=n,this._snapshot=zt(n),this._draft=nt(n),this._editing=!1,this._saved=!0,this._emitEditing(!1),this.dispatchEvent(new CustomEvent("asset-updated",{detail:n,bubbles:!0,composed:!0}))}catch(o){let n=v(o,this.t("editor.save_error"));this._error=n.message??this.t("editor.save_error")}finally{this._saving=!1}}_areaName(t){return t?this.areas.find(e=>e.area_id===t)?.name??this.t("infrastructure.unknown_area"):this.t("browser.no_area")}_renderAreaOptions(){let t=new Set(this.floors.map(o=>o.floor_id)),e=new Set(this.areas.map(o=>o.area_id)),s=this._draft?.area_id&&!e.has(this._draft.area_id)?this._draft.area_id:null,r=this.areas.filter(o=>!o.floor_id||!t.has(o.floor_id));return a`
      <option
        value=""
  ...
  `);_("bindhome-asset-detail-editor",ut);var mt=class extends m{constructor(){super(),this.hass=null,this.floors=[],this.areas=[],this.assets=[],this.presets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this.t=t=>t,this._selectedKey="",this._selectedAssetId=null,this._editorLocked=!1}get _hierarchy(){return ce(this.floors,this.areas,this.assets)}_countAssets(t){return this.t(It("counts.asset",t),{count:t})}_targetForKey(t,e=this._hierarchy){return us(t,e,this.t)}willUpdate(t){if(t.has("selectedAssetId")&&this.selectedAssetId){let e=this.assets.find(s=>s.id===this.selectedAssetId);e&&(this._selectedKey=this._locationKeyForAsset(e),this._selectedAssetId=e.id)}if(this._selectedKey&&(t.has("floors")||t.has("areas")||t.has("assets"))){let e=ce(this.floors,this.areas,this.assets);this._targetForKey(this._selectedKey,e)||(this._selectedKey=""),this._selectedAssetId&&!this.assets.some(s=>s.id===this._selectedAssetId)&&(this._selectedAssetId=null,this._editorLocked=!1)}}_select(t){this._editorLocked||(this._selectedAssetId=null,this._selectedKey=t)}_openAsset(t){this._selectedAssetId=t}_closeAsset(){this._editorLocked||(this._selectedAssetId=null)}_locationKeyForAsset(t){return ms(t,this.areas)}_handleEditingChanged(t){this._editorLocked=!!t.detail}_handleAssetUpdated(t){t.stopPropagation();let e=t.detail,s=gs(this.assets,e);this.assets=s,this._selectedKey=this._locationKeyForAsset(e),this._selectedAssetId=e.id,this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:s,bubbles:!0,composed:!0}))}_assetTypeLabel(t){let e=this.presets.find(s=>s.asset_type===t.asset_type);return e?E(this.t,e):t.asset_type}_renderAreaButton(t){let e=this._selectedKey===t.area.area_id;return a`
      <button
    ...
    `}};p(mt,"properties",{hass:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},presets:{attribute:!1},registry:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},selectedAssetId:{attribute:!1},t:{attribute:!1},_selectedKey:{state:!0},_selectedAssetId:{state:!0},_editorLocked:{state:!0}}),p(mt,"styles",g`
    :host {
      display: block;
      min-height: 100%;
      color: var(--primary-text-color);
  ...
  `);_("bindhome-inventory-browser",mt);var gt=class extends m{constructor(){super(),this.t=t=>t,this.assets=[],this.areas=[],this.registry={},this.focalAssetId=null,this.onNavigate=null,this._search=""}_asset(t){return this.assets.find(e=>e.id===t)??null}_focal(){return this._asset(this.focalAssetId)??this.assets[0]??null}_neighbors(){let t=this._focal();return t?O(this.registry?.relations??[],t.id):{incoming:[],outgoing:[]}}_focus(t){let e=this._asset(t);e&&(this.focalAssetId=e.id,this._search="",this.onNavigate?.(e.id))}_renderNeighbor(t,e){let s=e?t.target_asset_id:t.source_asset_id,r=this._asset(s);if(!r)return a`
        <div class="neighbor missing">
          <strong>${this.t("topology.missing_asset")}</strong>
          <span>${t.relation_type}</span>
        </div>
      `;let o=pe(r,this.areas);return a`
      <button
        class="neighbor"
        type="button"
    ...
    `}};p(gt,"properties",{t:{attribute:!1},assets:{attribute:!1},areas:{attribute:!1},registry:{attribute:!1},focalAssetId:{attribute:!1},onNavigate:{attribute:!1},_search:{state:!0}}),p(gt,"styles",g`
    :host {
      display: block;
    }
  ...
  `);_("bindhome-topology-explorer",gt);var _t=class extends m{constructor(){super(),this.hass=null,this.registry={},this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._active="browse"}_show(t){this._active=t}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._active="browse")}_forwardAssetsRefreshed(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("assets-refreshed",{detail:t.detail,bubbles:!0,composed:!0}))}_showBrowseFromWorkflow(t){t.stopPropagation(),this._active="browse"}render(){return a`
      <nav
        class="subnav"
    ...
    `}};p(_t,"properties",{hass:{attribute:!1},registry:{attribute:!1},t:{attribute:!1},presets:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},assets:{attribute:!1},bindingStatuses:{attribute:!1},entityRegistry:{attribute:!1},deviceRegistry:{attribute:!1},refreshBindingData:{attribute:!1},refreshTopologyData:{attribute:!1},selectedAssetId:{attribute:!1},_active:{state:!0}}),p(_t,"styles",g`
    :host {
      display: block;
      min-height: 100%;
    }
  ...
  `);_("bindhome-infrastructure-inspector",ft);var bt=class extends m{constructor(){super(),this.hass=null,this.t=t=>t,this.presets=[],this.floors=[],this.areas=[],this.assets=[],this.registry={},this.bindingStatuses={records:[],summary:{}},this.entityRegistry=[],this.deviceRegistry=[],this.refreshBindingData=null,this.refreshTopologyData=null,this.selectedAssetId=null,this._tab="inventory"}willUpdate(t){t.has("selectedAssetId")&&this.selectedAssetId&&(this._tab="inventory")}render(){return a`<div class="content-head">
    ...
    </div>`}};p(yt,"properties",{t:{attribute:!1},floors:{attribute:!1},areas:{attribute:!1},_step:{state:!0}}),p(yt,"styles",g`
    :host { display: block; }
    * { box-sizing: border-box; }
